...
class TestRunTracking(TestEnvVarsCase):
    ...
    def test_event_logger_from_non_managed_run(self):
        ...
        with patch("traceml.tracking.run.ResourceFileWriter") as mock_call:
...
class TestRunLogging(TestEnvVarsCase):
    ...
    def test_log_image_from_path(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_image:
    ...
    def test_log_image_with_boxes(self):
        ...
        image_file = tempfile.mkdtemp() + "/file.png"
        self.touch(image_file)
        with patch("traceml.tracking.run.Run._log_has_events") as log_image_with_boxes:
    ...
    def test_log_video_from_path(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_video:
    ...
    def test_log_audio_from_path(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_audio:
    ...
    def test_log_text(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_text:
    ...
    def test_log_html(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_html:
    ...
    def test_log_histogram(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_histogram:
    ...
    def test_log_np_histogram(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_np_histogram:
    ...
    def test_log_versioned_model_file(self):
        ...
        model_file = tempfile.mkdtemp() + "/model.pkl"
        self.touch(model_file)
        with patch("traceml.tracking.run.Run._log_has_model") as log_model:
            self.run.log_model(
    ...
    def test_log_dataframe_ref(self):
        ...
        self.touch(model_file)
        with patch("traceml.tracking.run.Run.log_artifact_ref") as log_artifact_ref:
    ...
    def test_log_dataframe(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_dataframe:
    ...
    def test_log_artifact(self):
        ...
        self.touch(tsv_file)
        with patch("traceml.tracking.run.Run.log_artifact_ref") as log_artifact:
            self.run.log_artifact(
                name="file",
                path=tsv_file,
    ...
    def test_versioned_log_artifact(self):
        ...
        tsv_file = tempfile.mkdtemp() + "/file.tsv"
        self.touch(tsv_file)
        with patch("traceml.tracking.run.Run._log_has_events") as log_artifact:
            self.run.log_artifact(
    ...
    def test_log_charts(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_charts:
    ...
    def test_log_curves(self):
        ...
        with patch("traceml.tracking.run.Run._log_has_events") as log_curves:
