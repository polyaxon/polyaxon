...
from actions.registry.webhooks.webhook import WEBHOOK_ACTION_EXECUTED, WebHookAction
...
class TestWebHookAction(BaseTest):
    ...
    def test_execute_empty_payload(self):
        with patch('actions.registry.webhooks.webhook.safe_request') as mock_execute:
