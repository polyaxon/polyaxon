...
class TestSubgraph(tf.test.TestCase):
    ...
    def test_modules_get_scopes_outside_subgraph(self):
        ...
        subgraph = SubGraph(mode=plx.ModeKeys.TRAIN, name='test', modules=[m1, m2, m3])
        subgraph.build()
    ...
    def test_mulitple_inputs(self):
        ...
        # subgraph1 = SubGraph(
        #     mode=plx.ModeKeys.TRAIN, name=subgraph1_config.name,
        ...
        # subgraph2 = SubGraph(
        #     mode=plx.ModeKeys.TRAIN, name=subgraph2_config.name,
        #     modules=SubGraph.build_subgraph_modules(mode=plx.ModeKeys.TRAIN,
        ...
        # graph = SubGraph(mode=plx.ModeKeys.TRAIN, name=graph_config.name, )
