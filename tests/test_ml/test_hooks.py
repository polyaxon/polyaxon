...
from polyaxon_schemas.ml.hooks import (
...
class TestHookConfigs(TestCase):
    def test_global_step_wait_hook_config(self):
        config_dict = {"wait_until_step": 10}
    ...
    def test_final_ops_hook_config(self):
        config_dict = {"final_ops": ["loss", "precision"]}
    ...
    def test_episode_logging_tensor_hook(self):
        config_dict = {"tensors": ["conv2d_1", "relu_1"], "every_n_episodes": 2}
