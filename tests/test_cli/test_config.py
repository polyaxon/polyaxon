...
class TestConfigManager(BaseCommandTestCase):
    @patch("polyaxon.managers.config.GlobalConfigManager.is_initialized")
    ...
    @patch("polyaxon.managers.config.GlobalConfigManager.is_initialized")
    @patch("polyaxon.managers.config.GlobalConfigManager.CONFIG")
    ...
    @patch("polyaxon.managers.config.GlobalConfigManager.is_initialized")
    @patch("polyaxon.managers.config.GlobalConfigManager.get_config")
