...
GCS_MODULE = "polyaxon.stores.clients.gc_client.{}"
...
class TestGCSStore(TestCase):
    ...
    def test_upload(self, client, _):
        ...
        (
            client.return_value.get_bucket.return_value.blob.return_value.upload_from_filename.side_effect
        ) = os.path.isfile
        ...
        (
            client.return_value.get_bucket.return_value.blob.return_value.upload_from_filename.assert_called_with(
                fpath
            )
        )
    ...
    def test_download(self, client, _):
        ...
        (
            client.return_value.get_bucket.return_value.get_blob.return_value.download_to_filename.side_effect
        ) = mkfile
    ...
    def test_upload_dir(self, client, _):
        ...
        (
            client.return_value.get_bucket.return_value.blob.return_value.upload_from_filename.assert_has_calls(
    ...
    def test_download_dir(self, client, _):
        ...
        (
            client.return_value.get_bucket.return_value.get_blob.return_value.download_to_filename.assert_has_calls(
                [
