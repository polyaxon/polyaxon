...
from polyaxon.automl.search_managers.bayesian_optimization.manager import (
    BOConfig,
    BOSearchManager,
)
...
class TestBOSearchManager(TestCase):
    DISABLE_RUNNER = True
    ...
    def setUp(self):
        ...
        self.manager1 = BOSearchManager(config=config)
        ...
        self.manager2 = BOSearchManager(config=config)

    def test_bo_search_config(self):
        assert BOSearchManager.CONFIG == BOConfig
