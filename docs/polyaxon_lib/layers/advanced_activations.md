...
```python
polyaxon_schemas.layers.advanced_activations.PReLUConfig(alpha_initializer=<polyaxon_schemas.initializations.ZerosInitializerConfig object at 0x101f40ac8>, alpha_regularizer=None, alpha_constraint=None, shared_axes=None)
```
