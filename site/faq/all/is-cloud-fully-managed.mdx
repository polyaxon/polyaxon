...
description: "Understand which parts of Polyaxon Cloud are managed by Polyaxon and which workloads and data remain in your clusters."
tags: [billing]
---
...
We have an abstraction called Polyaxon Agent (compute cluster) that runs on any Kubernetes cluster, and communicates securely with our control plane.
