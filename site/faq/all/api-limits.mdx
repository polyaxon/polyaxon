...
description: "Review Polyaxon API payload, request, trace deletion, and rate limits for Platform, Teams, and Enterprise organizations."
tags: [platform]
---
...
| Resource                                                                                                | Platform           | Teams              | Enterprise          |
| ------------------------------------------------------------------------------------------------------- | ------------------ | ------------------ | ------------------- |
...
| **Metrics**. GET APIs used to fetch analytics data, e.g. [metrics api](/docs/tracking/visualizations/overview).    | 100&nbsp;req/day   | 200&nbsp;req/day   | 2000&nbsp;req/day   |
| **Datasets**. APIs used to work with [datasets and experiments](/docs/registry/artifacts-versioning/overview).                        | 100&nbsp;req/min   | 200&nbsp;req/min   | 1,000&nbsp;req/min  |
