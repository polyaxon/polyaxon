...
description: "Learn how to move between Polyaxon Cloud and self-hosted deployments while retaining control of your data, models, code, and artifacts."
tags: [billing]
---
...
The difference between Polyaxon Cloud and Polyaxon EE is the control plane. In both cases, the workload, data, logs, metrics, models, artifacts, and all sensitive secrets and config-maps are managed by a Polyaxon Agent (compute cluster) running on a different cluster/namespace.
