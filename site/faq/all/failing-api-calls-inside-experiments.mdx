...
description: "Troubleshoot API authentication failures inside long-running Polyaxon jobs when ephemeral experiment tokens expire."
tags: [api]
---

# I’m getting requests failing on the API from inside experiments/jobs (Authentication credentials were not provided.)
