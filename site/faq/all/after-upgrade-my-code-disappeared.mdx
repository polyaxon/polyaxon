...
description: "Troubleshoot failed Polyaxon builds after an upgrade by choosing persistent storage for logs, outputs, and other experiment artifacts."
tags: [logging]
---

# After upgrading Polyaxon I was not able to start experiments because of failed builds.

Polyaxon provides several ways for storing the [logs](/docs/setup/connections/overview/#artifactsstore), the default method uses a local path on the host node.
