...
All these configurations follow similar [specification](/setup/connections/specification/).
...
For more details please check the [artifacts store section](/setup/connections/artifacts/).
...
[data volumes as well as cloud storages](/setup/connections/artifacts/),
[git repos](/setup/connections/git/),
[docker containers](/setup/connections/registry/), database accesses, ...
...
For more details please check the [connection specification](/setup/connections/specification/).
