...
description: "Polyaxon allows to define and pull images from private Container Registries."
---
...
you can use the [imagePullSecret](/docs/scheduling/specification/environment/#imagepullsecrets)
