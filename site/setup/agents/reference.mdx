...
description: "Polyaxon Agent (compute cluster) chart is a Helm chart for creating reproducible and maintainable deployments of Polyaxon with Kubernetes."
---

Polyaxon Agent (compute cluster) chart is a Helm chart for deploying Polyaxon Agent on Kubernetes.
...
You need to configure the connections to authorize for the agent. Please check [connections section](/docs/setup/connections/overview/).
