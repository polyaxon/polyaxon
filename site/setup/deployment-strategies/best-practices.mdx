 ...
 * The [node and deployment manipulation](/setup/platform/common-reference/#node-and-deployment-manipulation/) section to configure its core services.
 * The [node scheduling](/docs/scheduling/scheduling-strategies/node-scheduling/) section to configure scheduling for the data scientist's workload.
 * The [presets](/docs/scheduling/scheduling-presets/) section to create common configuration for your experiments, jobs, builds, scheduling, resources requesting, and other use-cases you need to solve.
...
and use a custom scheduling per experiment/job when needed. Please refer to this section for a full reference of the [node scheduling behavior](/setup/platform/common-reference/#node-and-deployment-manipulation).
...
We provide a reference document on how to achieve High Available Database on Polyaxon in this [guide](/setup/platform/postgresql-ha/).
...
In order to enable durable, i.e. available after a node failure, we recommend that you read the following guides: [artifacts store](/setup/connections/artifacts/).
...
Please read this [SSL reference](/setup/platform/common-reference/#ssl),
...
Please check this [section](/setup/platform/#port-forward) for more details.
...
Please check this [section](/setup/platform/common-reference/#security-context) for more details.
