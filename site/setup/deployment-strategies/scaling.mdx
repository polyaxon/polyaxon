...
description: "This is a guide to assist you through the process of scaling a Polyaxon Deployment."
---
...
> Please check the services replication [guide](/setup/platform/replication-concurrency/#services-replication) for more details.
...
> Please check [Celery integration guide](/integrations/services/celery) for more details.
...
> Please check [Polyaxon Agent setup](/setup/agents/overview) for more details.
