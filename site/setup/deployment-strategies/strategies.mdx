...
graph TB
    subgraph Cluster["Kubernetes Cluster"]
        subgraph Node["Single Node"]
            ...
            Agent["Polyaxon Agent (compute cluster)"]
 ...
 * The control plane can easily scale horizontally using replicas for the API and the scheduler, and you can deploy Celery with Redis as the broker.
 ...
 * You can scale and automate your workflows using [distributed jobs](/docs/references/polyaxonfile/runtimes/distributed/overview/), [parallel executions, dags and workflows, and hyperparameter tuning](/docs/references/polyaxonfile/orchestration/overview/).
 * You can gain unparalleled collaboration, agility, and speed using the [runtime references](/docs/references/polyaxonfile/runtimes/overview/) and [administration](/docs/administration/) tools
