---
title: "Redis HA"
description: "Polyaxon offers a couple of ways to set a high available redis instances."
---
...
please follow this [integration guide](/integrations/setup/memorystore-redis-on-gcp).

## Using Redis as broker

You can also use Redis for as async worker broker, please check this section on how to alter the [default broker behavior](/setup/platform/broker/).

## Scheduling

If you decided to deploy Redis in-cluster make sure to set proper [node scheduling](/setup/platform/common-reference/#node-and-deployment-manipulation)
