...
description: "Polyaxon Enterprise Edition Control Plane Setup."
---
...
In order to deploy Polyaxon Enterprise Control Plane to manage agent (compute cluster) deployments, you need to set some extra configuration.
