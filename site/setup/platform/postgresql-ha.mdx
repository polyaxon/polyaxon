---
title: "PostgreSQL HA"
description: "Keeping database records of your users, projects, experiments, and jobs is very important. Polyaxon offers a couple of ways to set a high available database."
---
...
For cloud specific instructions on how to setup a PostgreSQL, please check the integration guides for [GCP](/integrations/setup/postgres-ha-on-gcp), [Azure](/integrations/setup/postgres-ha-on-azure), or [Redshift](/integrations/setup/postgres-ha-on-redshift).


## Scheduling

If you decided to deploy Polyaxon in-cluster make sure to set proper [node scheduling](/setup/platform/common-reference/#node-and-deployment-manipulation)
