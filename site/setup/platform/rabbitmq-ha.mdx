---
title: "RabbitMQ HA"
description: "Polyaxon offers a couple of ways to set a high available RabbitMQ."
---
...
If you decide not to use RabbitMQ, and use Redis for handling events, please check this section on how to alter the [default broker behavior](/setup/platform/broker/).

## Scheduling

If you decided to deploy RabbitMQ in-cluster make sure to set proper [node scheduling](/setup/platform/common-reference/#node-and-deployment-manipulation)
