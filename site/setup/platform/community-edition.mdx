...
> **Note**: You can have more control about the broker, please check this [guide](/setup/platform/broker/).
...
You need to configure the connections to authorize for the platform. Please check [connections section](/setup/connections/).
