...
description: "Polyaxon Community Edition Setup based on Polyaxon open-source."
---
...
The deployment comes with an in-cluster agent (compute cluster) deployment for managing workload.
...
You need to configure the connections to authorize for the platform. Please check [connections section](/docs/setup/connections/overview/).
