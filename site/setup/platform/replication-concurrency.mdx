...
- External [PostgreSQL](/setup/platform/postgresql-ha) with persistence
- External [Redis](/setup/platform/redis-ha)
...
- Compiler: 2+ replicas
- Worker: 2+ replicas
- External [PostgreSQL](/setup/platform/postgresql-ha) (high-availability)
- External [Redis](/setup/platform/redis-ha)
- Dedicated node pools for control plane components
- Consider [multi-namespace](/setup/deployment-strategies/strategies) or [multi-cluster](/setup/deployment-strategies/strategies) deployment strategies
