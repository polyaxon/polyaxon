...
description: "This is a guide to assist you through the process of setting up a Polyaxon deployment using Kubernetes."
---
 ...
 * Polyaxon [Community Edition](/setup/platform/community-edition/).
 * Polyaxon [Enterprise Edition Control Plane](/setup/platform/enterprise-control-plane/).

Both deployments share some [common Helm options](/setup/platform/common-reference/).
...
If you are deploying Polyaxon in production mode, you should take some time to read about some [best practices](/setup/deployment-strategies/best-practices/) when deploying Polyaxon.
...
Polyaxon ships with [default values](/setup/platform/common-reference/), however and depending on your use case
