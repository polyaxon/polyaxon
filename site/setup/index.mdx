...
shortTitle: Overview
description: "Deploy Polyaxon on your infrastructure. Compare local and Docker deployments with production Kubernetes setups, architecture, and configuration options."
---
