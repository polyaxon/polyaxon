...
Please check the [Polyaxon platform upgrade section](/setup/platform/#upgrade-polyaxon)
...
Please check the [Polyaxon Agent upgrade section](/setup/agent/#upgrade-polyaxon-agent)
