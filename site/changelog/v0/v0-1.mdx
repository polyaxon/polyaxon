...
description: "Polyaxon release notes, migrations, and deprecation notes for v0.1.x."
author: Polyaxon
---
## v0.1.9
...
## v0.1.7
  ...
  * Add notification via email, slack, pagerduty, mattermost, discord, hipchat, webhooks ...
