...
description: "Polyaxon release notes, migrations, and deprecation notes for v0.5.x."
author: Polyaxon
---
## v0.5.6
 ...
 * Update notebook spawner to allow downloading artifacts/code: set allow_origin to "*".
 ...
 * Add note about using pgbouncer for scaling connections to DB.
 ...
 * Expose `maxConnAge` configuration option for both in-cluster and external postgresql connection.
