...
description: "Polyaxon release notes, migrations, and deprecation notes for v1.1.x."
author: Polyaxon
---
## v1.1.9.post1
...
* **New**: Add (`-t`, `--deployment-type`) flag to expose a simple deployment experience on Minikube and MicroK8s.
