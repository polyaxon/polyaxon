...
description: "Polyaxon release notes, migrations, and deprecation notes for v1.11.x."
author: Polyaxon
---
## v1.11.3
 ...
 * **Fix**: Datetime columns not adjusting correctly to text density in the comparison table.
