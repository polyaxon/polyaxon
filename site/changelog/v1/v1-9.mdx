...
description: "Polyaxon release notes, migrations, and deprecation notes for v1.9.x."
author: Polyaxon
---
## v1.9.6
 ...
 * **New**: Add read-only table to the agent view to show connections defined by each agent.
