...
description: "Serving REST APIs with FastAPI - Become familiar with the ecosystem of Polyaxon tools with a top-level overview and useful links to get you started."
---
...
This is an example of creating a REST API that you can host using Polyaxon. These APIs are useful for internal use, testing, and production serving workloads.
...
![serving-api-fullscreen](/images/dashboard/runs/serving-api-fullscreen.png)
...
Please note that if you are using Polyaxon Cloud or Polyaxon EE you will need to add a header with a [valid auth token](/docs/administration/organizations/user-profile/#token-management):
