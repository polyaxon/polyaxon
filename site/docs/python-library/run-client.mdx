...
- __Args__:
  - __status__: str, a valid [Statuses](/docs/polyaxonfile/specification/lifecycle/) value.
...
- __Args__:
  - __last_status__: str, a valid [Statuses](/docs/polyaxonfile/specification/lifecycle/) value.
