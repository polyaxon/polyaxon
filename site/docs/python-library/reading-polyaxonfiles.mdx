...
[specification](/docs/polyaxonfile/specification/overview/) to describe how experiments, jobs, services should be scheduled and executed.
...
Please check the [specification docs](/docs/polyaxonfile/specification/overview/)
