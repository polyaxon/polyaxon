...
[specification](/docs/scheduling/specification/) to describe how experiments, jobs, services should be scheduled and executed.
...
Please check the [specification docs](/docs/scheduling/specification/)
