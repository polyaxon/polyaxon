...
- __Args__:
  ...
  - __environment__: [V1Environment](/docs/scheduling/specification/environment/), optional
  - __connections__: List[str], optional
  - __volumes__: List[[Kubernetes Volume](https://kubernetes.io/docs/concepts/storage/volumes/)],
    optional
  - __init__: List[[V1Init](/docs/scheduling/specification/init/)], optional
  - __sidecars__: List[[sidecar containers](/docs/scheduling/specification/sidecars/)], optional
