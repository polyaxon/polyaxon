...
- __Args__:
  ...
  - __volumes__: List[[Kubernetes Volume](https://kubernetes.io/docs/concepts/storage/volumes/)],
    optional
  - __init__: List[[V1Init](/docs/polyaxonfile/specification/init/)], optional
  - __sidecars__: List[[sidecar containers](/docs/polyaxonfile/specification/sidecars/)], optional
