...
it uses an initializer [dockerfile](/docs/scheduling/specification/init/) which generates simple dockerfile.
...
We are also passing a parameter `destination` which is of type [image](/docs/scheduling/specification/types/),
