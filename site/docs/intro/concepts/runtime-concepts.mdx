...
it's called the [context](/docs/scheduling/context/), even if it does not receive any explicit data inputs,
...
<blockquote className="light">Please refer to [scheduling/specification/component](/docs/scheduling/specification/component/)
...
Each component can have one runtime that it's specified in the [run section of a component](/docs/scheduling/specification/component/#run).
...
<blockquote className="light">
Please refer to [scheduling/specification/operation](/docs/scheduling/specification/operation/) and [tracking/runs-dashboard](/docs/tracking/runs-dashboard/overview/) to learn about the operation specification.
</blockquote>
