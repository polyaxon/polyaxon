...
it's called the [context](/docs/polyaxonfile/context/overview/), even if it does not receive any explicit data inputs,
...
<blockquote className="light">Please refer to the [component specification](/docs/polyaxonfile/specification/component/)
...
Each component can have one runtime that it's specified in the [run section of a component](/docs/polyaxonfile/specification/component/#run).
...
<blockquote className="light">
Please refer to the [operation specification](/docs/polyaxonfile/specification/operation/) and [runs dashboard](/docs/tracking/runs-dashboard/overview/) to learn about operation metadata.
</blockquote>
