...
description: "Preparing the model - Become familiar with the ecosystem of Polyaxon tools with a top-level overview and useful links to get you started."
---
...
This command will both create a new project on Polyaxon and initialize the local folder so that we can run the command without providing the project name every time we want to schedule a new operation.
...
![Explore the dataset](/images/dashboard/runs/notebook-explore-dataset.png)
...
![explore-models](/images/dashboard/runs/notebook-explore-models.png)
...
Instead of running the model by manually changing the values in the notebook, we will create a script and run the model using Polyaxon. We will also log the resulting metrics and model using [Polyaxon's tracking module](https://polyaxon.com/docs/tracking/tracking/).
...
![notebook-pipeline-progress](/images/dashboard/runs/notebook-pipeline-progress.png)

### Analyzing the experiments

Sorting the experiments based on their accuracy metric

![sorting-experiments](/images/dashboard/runs/notebook-sorting-experiments.png)

Experiments `accuracy`

![visualizing-accuracy](/images/dashboard/runs/notebook-visualizing-accuracy.png)

Comparing `accuracy` against `n_neighbors`

![visualizing-accuracy-n_neighbors](/images/dashboard/runs/notebook-visualizing-accuracy-n_neighbors.png)
