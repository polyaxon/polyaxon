---
title: "Quick Start: Iterate With Presets"
sub_link: "quick-start/iterate-with-presets"
meta_title: "Using presets to improve the process of using git and code upload - Polyaxon quick start tutorial - Core Concepts"
 ...
 * [local code](/docs/intro/quick-start/iterate-with-cli-local-code/)
 * [git repo](/docs/intro/quick-start/iterate-with-cli-git-code/)
...
In this case we will use both the [git-preset integration](/docs/intro/quick-start/iterate-with-cli-git-code/) 
