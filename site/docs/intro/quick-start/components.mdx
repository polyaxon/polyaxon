...
Every Polyaxonfile must have a kind [component](/docs/scheduling/specification/component/) or [operation](/docs/scheduling/specification/operation/).
...
> Please check this section to learn more about [initializers](/docs/scheduling/specification/init/)
...
we can use the [inputs and outputs](/docs/scheduling/specification/io/) sections to parametrize our program.
