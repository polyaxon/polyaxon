...
Polyaxon provides a [Python Library](/docs/python-library/polyaxon-client/) that exposes several methods to fetch information about a run or the currently running operation.
...
Let's look at a simple program that just prints some information based on an input using the basic [Runclient](/docs/python-library/run-client/):
