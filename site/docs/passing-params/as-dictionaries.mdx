...
The quick-start repository also contains an [argument-based dictionary example](https://github.com/polyaxon/polyaxon-quick-start/blob/master/passing-params/dictionary.yaml).
