...
We can adjust our previous polyaxonfile to run this python program, in order to avoid [uploading code](/docs/iterative-process/iterate-in-notebooks/) or [cloning a repo](/docs/iterative-process/iterate-with-cli-git-code/),
...
> **Note**: For more information about params, please check the [specification section](/docs/references/polyaxonfile/specification/params/)
...
> **Note**: You can learn more about how to iterate with upload, git, and inline scripts in the [iterative process introduction section](/docs/iterative-process/iterate-in-notebooks/).
