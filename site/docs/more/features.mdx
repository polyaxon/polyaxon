---
title: "Features"
description: "Polyaxon comes with powerful features built directly into the core software which are customizable and extensible to suit your needs."
---

![polyaxonfile architecture](/images/references/specification/features.png)
