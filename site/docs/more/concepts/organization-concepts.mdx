...
description: "Polyaxon relies on a set of concepts to manage your organization, teams, and members."
---
...
Please refer to [administration/users](/docs/administration/organizations/user-profile/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [administration/organizations](/docs/administration/organizations/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [administration/teams](/docs/administration/organizations/teams/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [administration/projects](/docs/administration/projects/general/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [model-registry](/docs/registry/model-registry/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [component-hub](/docs/registry/component-hub/overview/) for more details.
</blockquote>
