...
description: "Polyaxon can trigger execution manually or automatically using schedules, data, and events driven strategies."
---
...
Please refer to [orchestration/schedules](/docs/references/polyaxonfile/orchestration/schedules/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to the [operation specification](/docs/references/polyaxonfile/specification/operation/) for more details.
</blockquote>

### Agents (compute clusters) and queues
...
<blockquote className="light">
Please refer to [Scheduling strategies](/docs/scheduling/scheduling-strategies/overview/) for more details.
</blockquote>
...
<blockquote className="light">
Please refer to [scheduling-presets](/docs/scheduling/scheduling-presets/overview/) and [administration/presets](/docs/administration/organizations/presets/) for more details.
</blockquote>
