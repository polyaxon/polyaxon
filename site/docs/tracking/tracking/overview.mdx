...
the tracking module is an extension of the [Python client](/docs/python-library/run-client/)
...
you can look at the [Python Library reference to learn more](/docs/python-library/#authentication).
