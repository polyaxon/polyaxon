...
please check the [service account specification](/docs/polyaxonfile/specification/environment/#serviceaccountname) in the environment section.
...
> we suggest that you read the minimum RBAC rules used in the default [service account](/docs/polyaxonfile/specification/environment/#serviceaccountname).
