...
please check the [service account specification](/docs/scheduling/specification/environment/#serviceaccountname) in the environment section.
...
> we suggest that you read the minimum RBAC rules used in the default [service account](/docs/scheduling/specification/environment/#serviceaccountname). 
