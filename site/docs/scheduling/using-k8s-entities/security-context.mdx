...
description: "By default, Polyaxon operations run without a security context, and pods run as root."
---
...
If you to define a security context globally, we suggest creating a [preset](/docs/scheduling/scheduling-presets/overview/).
