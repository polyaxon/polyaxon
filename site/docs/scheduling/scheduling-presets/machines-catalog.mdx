...
We first need to create a queue on the agent where we would like to expose the GPU instances. please see the [queues](/docs/administration/organizations/queues/) management section.
