...
[environment section](/docs/scheduling/specification/environment/), a [queue](/docs/scheduling/specification/operation/#queue), a [container resources requirements](https://kubernetes.io/docs/concepts/containers/),
a [termination](/docs/scheduling/specification/termination/). But oftentimes, you might want to reuse some or all of these options
...
Presets use all sections that the [operation specification](/docs/scheduling/specification/operation/) offers, except for sections that define the component runtime, i.e.:
 * hubRef
 * dagRef
 * urlRef
 * pathRef
...
Users can just reference the presets in their [operations specification](/docs/scheduling/specification/operation/#presets) or using the CLI/Client `polyaxon run ... --presets=preset1,preset2`
