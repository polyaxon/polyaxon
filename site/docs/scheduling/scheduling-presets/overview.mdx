...
[environment section](/docs/polyaxonfile/specification/environment/), a [queue](/docs/polyaxonfile/specification/operation/#queue), a [container resources requirements](https://kubernetes.io/docs/concepts/containers/),
a [termination](/docs/polyaxonfile/specification/termination/). But oftentimes, you might want to reuse some or all of these options
...
Presets use all sections that the [operation specification](/docs/polyaxonfile/specification/operation/) offers, except for sections that define the component runtime, i.e.:
 * hubRef
 * dagRef
 * urlRef
 * pathRef
...
Users can just reference the presets in their [operations specification](/docs/polyaxonfile/specification/operation/#presets) or using the CLI/Client `polyaxon run ... --presets=preset1,preset2`
