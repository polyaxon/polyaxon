...
description: "Cleaning Jupyter notebooks and Tensorboard session automatically with a timeout preset."
---
...
By [saving this preset](/docs/administration/organizations/presets/) as `services-timeout-24`,
