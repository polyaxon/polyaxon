...
The information provided in the params is injected after the [globals context information](/docs/scheduling/context/globals/), which can be accessed without prefix or using the `params.*` prefix.   
