...
> **Note**: Please check the [context globals section](/docs/scheduling/context/globals/) for more details.
...
In general all values resolved in the joins params are lists, unless the values are defined using the [ArtifactsType](/docs/scheduling/specification/types/#v1artifactstype), 
in which case the value is just a merged [ArtifactsType](/docs/scheduling/specification/types/#v1artifactstype).
...
> **Note**: Please check the [context params section](/docs/scheduling/context/params/) for more details.
...
> **Note**: Please check the [context connections section](/docs/scheduling/context/connections/) for more details.
