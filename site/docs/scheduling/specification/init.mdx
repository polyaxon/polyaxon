...
- __Args__:
  ...
  - __artifacts__: [V1ArtifactsType](/docs/scheduling/specification/types/#v1artifactstype), optional
  - __git__: [V1GitType](/docs/scheduling/specification/types/#v1gittype), optional
  - __dockerfile__: [V1DockerfileType](/docs/scheduling/specification/types/#v1dockerfiletype), optional
  - __file__: [V1FileType](/docs/scheduling/specification/types/#v1Filetype), optional
  - __tensorboard__: [V1TensorboardType](/docs/scheduling/specification/types/#v1Tensorboardtype), optional
