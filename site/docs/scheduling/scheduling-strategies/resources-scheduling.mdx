...
description: "Polyaxon schedules workload on Kubernetes, which means you can enable GPU, TPU, or any other resource supported in your cluster for running your operations."
---
...
If you have not seen this article about [node scheduling](/docs/scheduling/scheduling-strategies/node-scheduling/),
...
you can specify the GPU type by using a node selector in the [environment section](/docs/references/polyaxonfile/specification/environment/), e.g. GKE:
...
additionally you need to set the required annotations on the [environment section](/docs/references/polyaxonfile/specification/environment/).
