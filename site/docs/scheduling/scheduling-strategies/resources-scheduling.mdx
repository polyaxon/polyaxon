...
you can specify the GPU type by using a node selector in the [environment section](/docs/scheduling/specification/environment/), e.g. GKE:
...
additionally you need to set the required annotations on the [environment section](/docs/scheduling/specification/environment/).
