...
To set Kubernetes priority on an operation, you need to set the fields [priority](/docs/scheduling/specification/environment/#priority) and/or [priority_class_name](/docs/scheduling/specification/environment/#priorityclassname).
