...
To set Kubernetes priority on an operation, you need to set the fields [priority](/docs/polyaxonfile/specification/environment/#priority) and/or [priority_class_name](/docs/polyaxonfile/specification/environment/#priorityclassname).
