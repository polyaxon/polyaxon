 ...
 * As default configuration on the [component level](/docs/polyaxonfile/specification/component/#isapproved).
 * On [per operation basis](/docs/polyaxonfile/specification/operation/#isapproved).
