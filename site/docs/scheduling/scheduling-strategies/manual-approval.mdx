...
description: "A feature to pause and suspend operations and pipelines and wait for human approval to resume the work."
---
 ...
 * As default configuration on the [component level](/docs/references/polyaxonfile/specification/component/#isapproved).
 * On [per operation basis](/docs/references/polyaxonfile/specification/operation/#isapproved).
 * Via a [preset](/docs/scheduling/scheduling-presets/overview/).
