 ...
 * As default configuration on the [component level](/docs/scheduling/specification/component/#isapproved).
 * On [per operation basis](/docs/scheduling/specification/operation/#isapproved).
