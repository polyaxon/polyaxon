...
Every component in Polyaxon can set an [environment section](/docs/scheduling/specification/environment/)
which exposes many pod level options.

Component's environment section can be [patched](/docs/scheduling/specification/operation/#runPatch)
