...
Every component in Polyaxon can set an [environment section](/docs/polyaxonfile/specification/environment/)
which exposes many pod level options.

Component's environment section can be [patched](/docs/polyaxonfile/specification/operation/#runPatch)
