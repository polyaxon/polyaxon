...
description: "A feature to start operations on nodes or queues based on inputs data or to completely skip scheduling."
---

## Overview

Polyaxon resolves a [context](/docs/references/polyaxonfile/context/overview/) based on the inputs provided by the users, such information can be used to parametrize and template section responsible for scheduling and queueing.
