...
Polyaxon resolves a [context](/docs/polyaxonfile/context/overview/) based on the inputs provided by the users, such information can be used to parametrize and template section responsible for scheduling and queueing.
