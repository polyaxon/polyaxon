...
description: "Define cost per operation or environment."
---
 ...
 * The cost can be set directly on the component or the operation level, but it can also be set directly on the presets, especially when defining a [catalog of environments](/docs/scheduling/scheduling-presets/machines-catalog/).

When you define a cost estimation, Polyaxon will allow you to:
