...
Polyaxon exposes a section for handling failure and managing [termination](/docs/polyaxonfile/specification/termination/).
...
Polyaxon provides a concept called [max_retries](/docs/polyaxonfile/specification/termination/#maxretries).


## Enforcing SLAs with timeout

It's also important to enforce SLAs (Service Level Agreements) for your operations.
Polyaxon provides the [timeout](/docs/polyaxonfile/specification/termination/#maxretries) section that
...
The third key in the termination section is [ttl](/docs/polyaxonfile/specification/termination/#ttl).
