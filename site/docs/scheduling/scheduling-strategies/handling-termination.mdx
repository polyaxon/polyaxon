...
Polyaxon exposes a section for handling failure and managing [termination](/docs/scheduling/specification/termination/).
...
Polyaxon provides a concept called [max_retries](/docs/scheduling/specification/termination/#maxretries).


## Enforcing SLAs with timeout

It's also important to enforce SLAs (Service Level Agreements) for your operations.
Polyaxon provides the [timeout](/docs/scheduling/specification/termination/#maxretries) section that
...
The third key in the termination section is [ttl](/docs/scheduling/specification/termination/#ttl).
