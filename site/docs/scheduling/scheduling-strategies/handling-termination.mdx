...
description: "Handling failures and termination and ensuring robust scheduling."
---

It's important to ensure that jobs and services are robust and that they respect SLAs.

Polyaxon exposes a section for handling failure and managing [termination](/docs/references/polyaxonfile/specification/termination/).
...
You can also use the [scheduling presets](/docs/scheduling/scheduling-presets/overview/)
...
Polyaxon provides a concept called [max_retries](/docs/references/polyaxonfile/specification/termination/#maxretries).


## Enforcing SLAs with timeout

It's also important to enforce SLAs (Service Level Agreements) for your operations.
Polyaxon provides the [timeout](/docs/references/polyaxonfile/specification/termination/#maxretries) section that
...
The third key in the termination section is [ttl](/docs/references/polyaxonfile/specification/termination/#ttl).
...
See the [services timeout preset documentation](/docs/scheduling/scheduling-presets/services-timeout/) for more examples and preset configurations.
