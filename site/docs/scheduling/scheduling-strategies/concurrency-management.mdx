...
description: "A feature managing concurrency and controlling parallelism."
---
...
Every agent (compute cluster) created has a default queue, we configure that default queue with unlimited concurrency to allow users to maximize their plan's usage.
...
> for more details, please check the [Queues section](/docs/scheduling/scheduling-strategies/queues/).
...
> for more details, please check the [automation concurrency section](/docs/references/polyaxonfile/helpers/concurrency/)
