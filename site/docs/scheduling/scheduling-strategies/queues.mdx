...
> To define a queue on the [component](/docs/polyaxonfile/specification/component/#queue),
> on the [operation](/docs/polyaxonfile/specification/operation/#queue),
> using the [CLI's](/docs/cli/run/) `--queue` flag, or using the [client's create methods](/docs/python-library/run-client/#create)
