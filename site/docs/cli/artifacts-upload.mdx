...
> **Note**: Please make sure to check the [ignore behavior](/docs/cli/ignore/) to understand how to ignore partterns under the directory you are uploading.
...
> For more details about this command please run `polyaxon ops upload --help`, or check the [command reference](/docs/cli/ops/#ops-upload)
