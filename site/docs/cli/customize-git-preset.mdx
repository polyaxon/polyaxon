...
The `polyaxongit.yaml` contains a [V1Init](/docs/scheduling/specification/init/) schema definition, users can create the file or customize it manually using an IDE, as long as the content of the file respects the schema.
