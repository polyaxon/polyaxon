...
We briefly went through one aspect of the programmatic experience in the guide [iterate-in-notebooks](/docs/guides/iterative-process/iterate-in-notebooks/).
