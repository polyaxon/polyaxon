 ...
 * [local code](/docs/guides/iterative-process/iterate-with-cli-local-code/)
 * [git repo](/docs/guides/iterative-process/iterate-with-cli-git-code/)
...
In this case we will use both the [git-preset integration](/docs/guides/iterative-process/iterate-with-cli-git-code/)
...
> For mode details about using presets please check the [scheduling presets guide](/docs/scheduling/scheduling-presets/)
