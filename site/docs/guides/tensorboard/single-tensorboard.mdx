...
description: "Starting Single Run Tensorboard - Become familiar with the ecosystem of Polyaxon tools with a top-level overview and useful links to get you started."
---
...
![ui-tensorboard](/images/dashboard/runs/start-ui-tensorboard.png)

Running the Tensorboard:

![ui-running-tensorboard](/images/dashboard/runs/single-run-tensorboard.png)

Shortcut to the Tensorboard:

![ui-shortcut-tensorboard](/images/dashboard/runs/shortcut-ui-tensorboard.png)
