...
Polyaxon provides a feature for running parallel executions based on a list of configurations called [mapping](/docs/orchestration/mapping/)
...
> For more details check the [mapping reference](/docs/orchestration/mapping/)

## Learn More

You can also learn about tools to [control the cache](/docs/orchestration/helpers/cache/) of executions with similar configurations,
