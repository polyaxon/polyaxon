...
Every Polyaxonfile must have a kind [component](/docs/polyaxonfile/specification/component/) or [operation](/docs/polyaxonfile/specification/operation/).
...
> Please check this section to learn more about [initializers](/docs/polyaxonfile/specification/init/)
...
we can use the [inputs and outputs](/docs/polyaxonfile/specification/io/) sections to parametrize our program.
