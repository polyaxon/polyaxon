---
title: "Quick Start"
description: "Become familiar with the ecosystem of Polyaxon tools with a top-level overview and useful links to get you started."
---
...
This example assumes a functional [Polyaxon Deployment](/setup/).
If you have Polyaxon already deployed and running, you can skip this section and proceed to [create a project](/docs/guides/quick-start/#create-a-project).
...
> **Tip**: You can learn more about how to customize your Polyaxon Deployment in the [setup section](/setup/).


## Create a new project

You can create a project using [Polyaxon UI](/docs/administration/projects/general/) or with [Polyaxon CLI](/docs/cli/project/#project-create)
...
> For more details about this command please run `polyaxon run --help`, or check the [command reference](/docs/cli/run/)
...
> For more details about this command please run `polyaxon dashboard --help`, or check the [command reference](/docs/cli/dashboard/)
...
please check the next section of [this tutorial](/docs/guides/quick-start/components/)
