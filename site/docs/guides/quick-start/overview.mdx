...
You can create a project using [Polyaxon UI](/docs/administration/projects/general/) or with [Polyaxon CLI](/docs/references/cli/project/#project-create)
...
> For more details about this command please run `polyaxon dashboard --help`, or check the [command reference](/docs/references/cli/dashboard/)
