 ...
 * To learn more about how you can customize your deployment or how you can connect Polyaxon to external systems, you can find more information in the [setup section](/setup/).
 * Some other guides are published in other sections, for example:
   ...
   * [the deployment strategies](/setup/deployment-strategies/).
