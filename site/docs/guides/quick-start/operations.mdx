...
Operations are how you execute components. To learn more about operations, please check the [specification section](/docs/polyaxonfile/specification/operation/)
