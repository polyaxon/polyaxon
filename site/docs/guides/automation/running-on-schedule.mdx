...
Polyaxon provides an abstraction to put operations on a [schedule](/docs/orchestration/schedules/).
...
It's also possible to put the complete [DAG](/docs/guides/automation/automation-dag/) that we created in the previous guide on schedule, similarly to this operation,
...
You can check the [schedules section](/docs/orchestration/schedules/) for more details about all the possible schedules and their specifications.
