---
title: "Component Hub"
description: "Polyaxon Component Hub is a product for managing versioned and reusable components, each component: Can have multiple versions, Can be published publicly or privately within your organization, Can define team level permissions."
---
...
![overview](/images/dashboard/hub/overview.png)
...
Each component version uses a definition which is the same [specification](/docs/references/polyaxonfile/specification/component/) that is used for running inline components.
...
As soon as a component is registered in your organization's hub, you can use it in your [operations](/docs/references/polyaxonfile/specification/operation/).
