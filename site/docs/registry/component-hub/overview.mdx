...
Each component version uses a definition which is the same [specification](/docs/scheduling/specification/component/) that is used for running inline components.
...
As soon as a component is registered in your organization's hub, you can use it in your [operations](/docs/scheduling/specification/operation/).
