...
description: "Components is the entity that defines the runtime in Polyaxon, each component: Can have multiple versions, Can be published publicly or privately within your organization, Can define team level permissions."
---
...
![component-create](/images/dashboard/hub/component-create.png)
...
![component-features](/images/dashboard/hub/component-features.png)
...
![component-overview](/images/dashboard/hub/component-overview.png)
...
![component-versions](/images/dashboard/hub/component-versions.png)
...
![component-admin](/images/dashboard/hub/component-admin.png)
