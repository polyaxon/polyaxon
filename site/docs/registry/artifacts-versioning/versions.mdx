...
You can check the complete [artifacts CLI reference here](/docs/cli/artifacts/) or by using `polyaxon artifacts --help`.

### Client Reference

Polyaxon's [ProjectClient](/docs/python-library/project-client/) library exposes all methods to:
 * [list_artifact_versions](/docs/python-library/project-client/#list_artifact_versions)
 * [get_artifact_version](/docs/python-library/project-client/#get_artifact_version)
 * [create_artifact_version](/docs/python-library/project-client/#create_artifact_version)
 * [patch_artifact_version](/docs/python-library/project-client/#patch_artifact_version)
 * [register_artifact_version](/docs/python-library/project-client/#register_artifact_version)
 * [copy_artifact_version](/docs/python-library/project-client/#copy_artifact_version)
 * [transfer_artifact_version](/docs/python-library/project-client/#transfer_artifact_version)
 * [delete_artifact_version](/docs/python-library/project-client/#delete_artifact_version)
 * [stage_artifact_version](/docs/python-library/project-client/#stage_artifact_version)
 * [pull_artifact_version](/docs/python-library/project-client/#pull_artifact_version)

Since `v1.18`, Polyaxon's [RunClient](/docs/python-library/run-client/) library exposes a method to automatically promote the run to an artifact version:
 * [promote_to_artifact_version](/docs/python-library/run-client/#promote_to_artifact_version)
