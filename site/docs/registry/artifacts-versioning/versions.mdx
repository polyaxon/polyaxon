...
description: "Artifact versions, each artifact: Can have multiple versions, Can be published publicly or privately within your organization, can define team and project level permissions."
---
...
You can check the complete [artifacts CLI reference here](/docs/references/cli/artifacts/) or by using `polyaxon artifacts --help`.

### Client Reference

Polyaxon's [ProjectClient](/docs/references/python-library/project-client/) library exposes all methods to:
 * [list_artifact_versions](/docs/references/python-library/project-client/#list_artifact_versions)
 * [get_artifact_version](/docs/references/python-library/project-client/#get_artifact_version)
 * [create_artifact_version](/docs/references/python-library/project-client/#create_artifact_version)
 * [patch_artifact_version](/docs/references/python-library/project-client/#patch_artifact_version)
 * [register_artifact_version](/docs/references/python-library/project-client/#register_artifact_version)
 * [copy_artifact_version](/docs/references/python-library/project-client/#copy_artifact_version)
 * [transfer_artifact_version](/docs/references/python-library/project-client/#transfer_artifact_version)
 * [delete_artifact_version](/docs/references/python-library/project-client/#delete_artifact_version)
 * [stage_artifact_version](/docs/references/python-library/project-client/#stage_artifact_version)
 * [pull_artifact_version](/docs/references/python-library/project-client/#pull_artifact_version)

Since `v1.18`, Polyaxon's [RunClient](/docs/references/python-library/run-client/) library exposes a method to automatically promote the run to an artifact version:
 * [promote_to_artifact_version](/docs/references/python-library/run-client/#promote_to_artifact_version)
...
![version-create](/images/dashboard/artifacts-versioning/version-create.png)
...
![version-promote](/images/dashboard/artifacts-versioning/version-promote.png)

Once an artifact version is registered, the run will be marked as promoted:

![version-promoted](/images/dashboard/artifacts-versioning/version-promoted.png)
...
![version-overview](/images/dashboard/artifacts-versioning/version-overview.png)
...
![version-stage](/images/dashboard/artifacts-versioning/version-stage.png)
...
![version-admin](/images/dashboard/artifacts-versioning/version-admin.png)
