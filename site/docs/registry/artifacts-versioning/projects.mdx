---
title: "Projects"
description: "Each project(Artifact) is the entity that manages runs promoted as artifacts versions created in Polyaxon or other system, each artifact: Can have multiple versions, Can be published publicly or privately within your organization, Can define team and project level permissions."
---
...
![artifacts-create](/images/dashboard/artifacts-versioning/artifacts-create.png)
...
![artifacts-features](/images/dashboard/artifacts-versioning/artifacts-features.png)
...
![artifacts-overview](/images/dashboard/artifacts-versioning/artifacts-overview.png)
...
![artifacts-versions](/images/dashboard/artifacts-versioning/artifacts-versions.png)
...
![artifacts-admin](/images/dashboard/artifacts-versioning/artifacts-admin.png)
