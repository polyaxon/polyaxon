...
description: "Model versions, each model: Can have multiple versions, Can be published publicly or privately within your organization, Can define team and project level permissions."
---
...
You can check the complete [models CLI reference here](/docs/references/cli/models/) or by using `polyaxon models --help`.

### Client Reference

Polyaxon's [ProjectClient](/docs/references/python-library/project-client/) library exposes all methods to:
 * [list_model_versions](/docs/references/python-library/project-client/#list_model_versions)
 * [get_model_version](/docs/references/python-library/project-client/#get_model_version)
 * [create_model_version](/docs/references/python-library/project-client/#create_model_version)
 * [patch_model_version](/docs/references/python-library/project-client/#patch_model_version)
 * [register_model_version](/docs/references/python-library/project-client/#register_model_version)
 * [copy_model_version](/docs/references/python-library/project-client/#copy_model_version)
 * [transfer_model_version](/docs/references/python-library/project-client/#transfer_model_version)
 * [delete_model_version](/docs/references/python-library/project-client/#delete_model_version)
 * [stage_model_version](/docs/references/python-library/project-client/#stage_model_version)
 * [pull_model_version](/docs/references/python-library/project-client/#pull_model_version)

Since `v1.18`, Polyaxon's [RunClient](/docs/references/python-library/run-client/) library exposes a method to automatically promote the run to a model version:
 * [promote_to_model_version](/docs/references/python-library/run-client/#promote_to_model_version)
...
![version-create](/images/dashboard/registry/version-create.png)
...
![version-promote](/images/dashboard/registry/version-promote.png)

Once a model version is registered, the run will be marked as promoted:

![version-promoted](/images/dashboard/registry/version-promoted.png)
...
![version-overview](/images/dashboard/registry/version-overview.png)
...
![version-stage](/images/dashboard/registry/version-stage.png)
...
![version-admin](/images/dashboard/registry/version-admin.png)
