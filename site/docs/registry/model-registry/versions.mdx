...
You can check the complete [models CLI reference here](/docs/cli/models/) or by using `polyaxon models --help`.

### Client Reference

Polyaxon's [ProjectClient](/docs/python-library/project-client/) library exposes all methods to:
 * [list_model_versions](/docs/python-library/project-client/#list_model_versions)
 * [get_model_version](/docs/python-library/project-client/#get_model_version)
 * [create_model_version](/docs/python-library/project-client/#create_model_version)
 * [patch_model_version](/docs/python-library/project-client/#patch_model_version)
 * [register_model_version](/docs/python-library/project-client/#register_model_version)
 * [copy_model_version](/docs/python-library/project-client/#copy_model_version)
 * [transfer_model_version](/docs/python-library/project-client/#transfer_model_version)
 * [delete_model_version](/docs/python-library/project-client/#delete_model_version)
 * [stage_model_version](/docs/python-library/project-client/#stage_model_version)
 * [pull_model_version](/docs/python-library/project-client/#pull_model_version)

Since `v1.18`, Polyaxon's [RunClient](/docs/python-library/run-client/) library exposes a method to automatically promote the run to a model version:
 * [promote_to_model_version](/docs/python-library/run-client/#promote_to_model_version)
