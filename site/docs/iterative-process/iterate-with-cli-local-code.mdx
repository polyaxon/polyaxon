...
Clone the [quick-start](https://github.com/polyaxon/polyaxon-quick-start) repo, then enter the repository root:
...
<Frame fullWidth>
  ![Run lineage showing the uploaded local directory as an input](/images/docs/iterative-process/local-run-lineage-upload.png)
</Frame>
