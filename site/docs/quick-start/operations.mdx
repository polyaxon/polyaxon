...
description: "Operations - Become familiar with the ecosystem of Polyaxon tools with a top-level overview and useful links to get you started."
---
...
```bash
polyaxon run -p quick-start --url=https://raw.githubusercontent.com/polyaxon/polyaxon-quick-start/master/scheduling/experimentation/operation.yaml
```
...
Operations are how you execute components. To learn more about operations, please check the [specification section](/docs/references/polyaxonfile/specification/operation/)
