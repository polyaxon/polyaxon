...
- __Args__:
  ...
  - __params__: Dict[str, [V1Param](/docs/polyaxonfile/specification/params/)], optional
  ...
  - __component__: [V1Component](/docs/polyaxonfile/specification/component/), optional
