...
- __Args__:
  ...
  - __inputs__: [V1IO](/docs/reference/polyaxonfile/specification/io/), optional
  - __outputs__: [V1IO](/docs/reference/polyaxonfile/specification/io/), optional
...
The default component [termination](/docs/reference/polyaxonfile/specification/termination/).
...
The default component [plugins](/docs/reference/polyaxonfile/specification/plugins/).
...
The [inputs](/docs/reference/polyaxonfile/specification/io/) definition for this component.
...
The [outputs](/docs/reference/polyaxonfile/specification/io/) definition for this component.
