...
from [params](/docs/reference/polyaxonfile/specification/params/), or from other values in
the [context](/docs/reference/polyaxonfile/context/overview/).
...
please check the [param section](/docs/reference/polyaxonfile/specification/params/).
...
- __Args__:
  ...
  - __validation__: [V1Validation](/docs/reference/polyaxonfile/specification/validation/), optional
...
please check the [types section](/docs/reference/polyaxonfile/specification/types/),
