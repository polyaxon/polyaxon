...
> **Note**: Please check the [context globals section](/docs/polyaxonfile/context/globals/) for more details.
...
In general all values resolved in the joins params are lists, unless the values are defined using the [ArtifactsType](/docs/polyaxonfile/specification/types/#v1artifactstype),
in which case the value is just a merged [ArtifactsType](/docs/polyaxonfile/specification/types/#v1artifactstype).
...
> **Note**: Please check the [context params section](/docs/polyaxonfile/context/params/) for more details.
...
> **Note**: Please check the [context connections section](/docs/polyaxonfile/context/connections/) for more details.
