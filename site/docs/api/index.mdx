...
> The pages in this section are generated from `static/polyaxon_sdk.swagger.json` and grouped by API area.
...
- [Instance Management API](/setup/administration/instance-management-api): administer organizations on self-hosted installations
...
The Polyaxon [Python library](/docs/python-library/overview) and [JS/TS SDK](https://js.reference.polyaxon.com) provide typed wrappers around the REST API.
...
- [UI](/docs/cli/export-data) — Batch exports from the Polyaxon UI
- [CLI](/docs/cli/overview) — Full CLI for managing Polyaxon resources from the terminal
