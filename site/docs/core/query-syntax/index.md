 ...
 * [Runs](/docs/core/query-syntax/runs/)
 * [Projects](/docs/core/query-syntax/projects/)
...
You can save searches to access and apply same filters to several projects, saved searched can be accessed other team members to avoid reconstructing similar filters. 
Please check [management - searches](/management/ui/searches/).
