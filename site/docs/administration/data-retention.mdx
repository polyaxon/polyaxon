...
<Frame className="my-10" fullWidth>
  ![Configure data retention in Polyaxon](/images/docs/data-retention.png)
</Frame>

Retention can also be configured via the [API](/docs/cli-and-api-refs).
...
- **S3**: Grant `s3:DeleteObject` to the Polyaxon IAM role on the configured buckets (see [artifacts connections](/setup/connections/artifacts)).
