...
If you self-host Polyaxon, you can use the [Instance Management API](/setup/administration/instance-management-api) to administer organizations across an instance.
...
See the [API Reference](https://api.reference.polyaxon.com) for full details on request/response formats.
