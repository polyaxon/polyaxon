...
<AvailabilityBanner
  availability={{
    cloudPlatform: "not-available",
    cloudTeams: "not-available",
    cloudEnterprise: "full",
    selfHostedCommunity: "not-available",
    selfHostedBusiness: "full",
    selfHostedEnterprise: "full",
  }}
/>
