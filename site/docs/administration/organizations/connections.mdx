...
Connections are defined and managed on your clusters on-premise or your cloud clusters, and are managed by the team that manages your Kubernetes cluster and Polyaxon Agent (compute cluster) deployments.
