---
title: "Flow Engine"
description: "Running pipelines is often important to optimize and build strong models."
---
 ...
 * They can run and orchestrate [jobs](/docs/workload/jobs/), [distributed jobs](/docs/workload/distributed/), and [services](/docs/workload/services/).
 * They can leverage all [pipeline helpers](/docs/orchestration/helpers/).
 * They can run in parallel and can be used with [mapping](/docs/orchestration/mapping/) or other [optimization algorithms](/docs/orchestration/optimization-engine/).
...
Please check the [DAG specification](/docs/orchestration/flow-engine/specification/) guide to learn about all details for DAGs in Polyaxon.
