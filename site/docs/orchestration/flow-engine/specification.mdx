...
- __Args__:
  ...
  - __operations__: List[[V1Operation](/docs/scheduling/specification/operation/)]
  - __components__: List[[V1Component](/docs/scheduling/specification/component/)], optional
