...
description: "Managing dependencies between operation in a DAG."
---
...
> **Note**: For more details, please check the [events section](/docs/orchestration/events/specification/)
