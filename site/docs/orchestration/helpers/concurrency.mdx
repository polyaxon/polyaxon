...
description: "Polyaxon manages concurrency on pipeline level and on queue level."
---
 ...
 * Globally using a [queue](/docs/scheduling/scheduling-strategies/queues/).
 * Both.
...
Please check this guide for more details about [scheduling with queues](/docs/scheduling/scheduling-strategies/queues/)
