...
description: "An Experiment Group is an automatic and practical way to run a version of your model and data with different hyper parameters."
---
...
> For more details about this command please run `polyaxon check --help`, or check the [command reference](/docs/references/cli/check/)
...
> Check how you can [get the experiment params](/docs/tracking/tracking/in-cluster/#hyperparams) to use them with your models.
...
> For more details about this command please run `polyaxon group --help`, or check the [command reference](/docs/references/cli/run/)
