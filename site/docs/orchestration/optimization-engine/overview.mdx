 ...
 * [Grid search](/docs/orchestration/optimization-engine/grid-search/)
 * [Random search](/docs/orchestration/optimization-engine/random-search/)
 * [Hyperband](/docs/orchestration/optimization-engine/hyperband/)
 * [Bayesian Optimization](/docs/orchestration/optimization-engine/bayesian-optimization/)
 * [Hyperopt](/docs/orchestration/optimization-engine/bayesian-optimization/)
 * [Custom iterative Optimization](/docs/orchestration/optimization-engine/iterative/)

## Pipeline helpers

All optimization algorithms can leverage the [pipeline helpers](/docs/orchestration/helpers/) for managing concurrency, early stopping, caching, ...
...
You can check all the options available in the [params section reference](/docs/orchestration/optimization-engine/params/).
