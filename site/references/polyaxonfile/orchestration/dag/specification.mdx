...
- __Args__:
  ...
  - __operations__: List[[V1Operation](/docs/references/polyaxonfile/specification/operation/)]
  - __components__: List[[V1Component](/docs/references/polyaxonfile/specification/component/)], optional
...
A list of [connection names](/docs/setup/connections/overview/) to resolve for the dag.
