...
description: "Finding good hyperparameters can be very challenging, and requires to efficiently search the space of possible hyperparameters as well as how to manage, schedule, and monitor a large set of experiments for hyperparameter tuning, Polyaxon Optimization Engine tries to simplify this by exposing a set of search algorithms."
---
 ...
 * Easy-to-use: Polyaxon's search algorithms are built-in and can be used by adding a `matrix` section to your operations. You can run hyperparameter tuning using the CLI, client, and dashboard.
 ...
 * Visualization and Dashboards: Polyaxon's Optimization Engine reuses the same logic and core features for jobs, tracking, checkpoint management, and integration with TensorBoard.
 ...
 * [Grid search](/docs/references/polyaxonfile/orchestration/matrix/grid-search/)
 * [Random search](/docs/references/polyaxonfile/orchestration/matrix/random-search/)
 * [Hyperband](/docs/references/polyaxonfile/orchestration/matrix/hyperband/)
 * [Bayesian Optimization](/docs/references/polyaxonfile/orchestration/matrix/bayesian-optimization/)
 * [TPE](/docs/references/polyaxonfile/orchestration/matrix/tpe/)
 * [Custom iterative Optimization](/docs/references/polyaxonfile/orchestration/matrix/iterative/)

## Pipeline helpers

All optimization algorithms can leverage the [pipeline helpers](/docs/references/polyaxonfile/helpers/overview/) for managing concurrency, early stopping, caching, ...
...
You can check all the options available in the [params section reference](/docs/references/polyaxonfile/orchestration/matrix/params/).
