...
The value could be coming from the [context](/docs/references/polyaxonfile/context/overview/), for example:
...
[ArtifactsType](/docs/references/polyaxonfile/specification/types/#v1artifactstype)
...
[init section](/docs/references/polyaxonfile/specification/init/), you can use `toInit` to turn an artifacts value
