...
- __Args__:
  ...
  - __artifacts__: [V1ArtifactsType](/docs/references/polyaxonfile/specification/types/#v1artifactstype), optional
  - __git__: [V1GitType](/docs/references/polyaxonfile/specification/types/#v1gittype), optional
  - __dockerfile__: [V1DockerfileType](/docs/references/polyaxonfile/specification/types/#v1dockerfiletype), optional
  - __file__: [V1FileType](/docs/references/polyaxonfile/specification/types/#v1Filetype), optional
  - __tensorboard__: [V1TensorboardType](/docs/references/polyaxonfile/specification/types/#v1Tensorboardtype), optional
