...
After finishing the params section, the next section is the params defined in [joins](/docs/orchestration/joins/).
...
([Optimization](/docs/orchestration/optimization-engine/) or [Mapping](/docs/orchestration/mapping/)).
