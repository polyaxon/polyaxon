...
The Polyaxon [Python library](/docs/references/python-library/overview/) and [JS/TS SDK](/docs/references/ts-library/overview/) provide typed wrappers around the REST API.
...
- **Agents (compute clusters) & Queues** — Configure agents, queues, and presets
- **Searches & Dashboards** — Manage saved searches and custom dashboards

See the full [API Reference](/docs/references/api) for details.
