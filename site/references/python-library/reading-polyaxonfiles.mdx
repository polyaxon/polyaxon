...
description: "Polyaxon's Python library allows to turn off all API calls and silently pass through all function calls."
---

## Overview

Polyaxon users have to create and execute Polyaxonfiles, these files use a
[specification](/docs/references/polyaxonfile/specification/overview/) to describe how experiments, jobs, services should be scheduled and executed.
...
Please check the [specification docs](/docs/references/polyaxonfile/specification/overview/)
