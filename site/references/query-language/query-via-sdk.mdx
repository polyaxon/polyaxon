...
You can query all Polyaxon data programmatically via the [SDKs](#sdks) and the [API](/docs/references/api). For export and pull functionality, see [Export Options](/docs/references/cli/export-data).
...
- `query` — filter using [Polyaxon Query Language](/docs/references/query-language/overview/) (e.g. `"status:running"`, `"tags:experiment"`, `"metrics.loss:<0.5"`)
