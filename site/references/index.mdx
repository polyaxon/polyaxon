...
<Cards num={3}>
  <Card
    title="Polyaxonfile"
    href="/docs/references/polyaxonfile/overview"
    icon={<FileCode2 />}
  ...
  <Card
    title="CLI"
    href="/docs/references/cli/overview"
    icon={<Terminal />}
  ...
  <Card
    ...
    href="/docs/references/query-language/overview"
    icon={<Braces />}
  ...
  <Card
    title="Sandbox API"
    href="/docs/references/sandbox/client"
    icon={<KeyRound />}
  ...
  <Card
    ...
    href="/docs/references/cli/export-data"
    icon={<Download />}
