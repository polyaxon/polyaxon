...
sidebarTitle: "Git Preset"
description: "Polyaxon allows to iterate with Polyaxon CLI and a remote git repo, this guide shows how users can extend or create their own polyaxongit.yaml file."
---
...
When executing one of the above commands, Polyaxon will create a file `polyaxongit.yaml` that contains a [preset](/docs/scheduling/scheduling-presets/overview/).
...
The `polyaxongit.yaml` contains a [V1Init](/docs/references/polyaxonfile/specification/init/) schema definition, users can create the file or customize it manually using an IDE, as long as the content of the file respects the schema.
