...
sidebarTitle: "Upload Artifacts"
description: "Polyaxon run and ops allow to upload artifacts in a completely versioned way."
---
...
> **Note**: Please make sure to check the [ignore behavior](/docs/references/cli/ignore/) to understand how to ignore partterns under the directory you are uploading.
...
> For more details about this command please run `polyaxon ops upload --help`, or check the [command reference](/docs/references/cli/ops/#ops-upload)
