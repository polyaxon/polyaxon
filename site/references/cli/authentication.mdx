...
description: "Polyaxon login command allows to authenticate your CLI and creates a context for future interactions with the API."
---
...
It's also possible to disable this default behavior by setting the [auth plugin](/docs/references/polyaxonfile/specification/plugins/#auth):
