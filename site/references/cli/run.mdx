...
Previously, file symlinks were archived as links and directory symlinks were omitted
silently. See [directory upload symlinks](/docs/references/cli/ops/#directory-upload-symlinks)
for mode details and compatibility notes.
