---
title: Google GCR
description: "Google Container Registry is is a fully-managed Docker container registry to store, manage, and secure your Docker container images."
ogImage: /images/integrations/gcr.png
---
...
## Create a service account on GCS with storage admin role
 ...
 3. Click the top-left menu (three horizontal bars) -> IAM & Admin -> Service Accounts menu option
