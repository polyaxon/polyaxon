...
ogImage: /images/integrations/gcs.png
---
...
You can [deploy/upgrade](/docs/setup/) your Polyaxon CE or Polyaxon Agent (compute cluster) deployment with access to data on GCS.
