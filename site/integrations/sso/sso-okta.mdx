---
title: SSO with Okta
description: "Okta is an identity and access management software system. It provides cloud software that helps companies manage and secure user authentication into applications, and for developers to build identity controls into applications, website web services and devices."
ogImage: /images/integrations/okta.png
---
...
![okta-admin-settings](/images/integrations/saml/okta-admin-1.png)

Next, click the Create App Integration button on the Applications page:

![okta-create-app](/images/integrations/saml/okta-admin-2.png)

Choose SAML 2.0 as the sign-in method:

![okta-saml-config](/images/integrations/saml/okta-admin-3.png)

Choose Polyaxon as the app name and optional upload Polyaxon's logo for the application:

![okta-app-name](/images/integrations/saml/okta-admin-4.png)
...
![okta-hostname-urls](/images/integrations/saml/okta-admin-5.png)
...
![okta-setting-attributes](/images/integrations/saml/okta-admin-6.png)
...
![okta-update-deployment-config](/images/integrations/saml/okta-admin-7.png)
