---
title: Hugging Face
description: "Hugging Face - Transformers: State-of-the-art Machine Learning for PyTorch, TensorFlow, and JAX."
...
If you have a run that is already instantiated, you can pass it directly to the callback:
