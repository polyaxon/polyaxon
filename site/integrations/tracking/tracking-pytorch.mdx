...
description: PyTorch is an open source deep learning framework commonly used for building neural network models. Polyaxon helps with keeping track of model training metadata.
