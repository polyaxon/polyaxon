...
description: "LightGBM, short for Light Gradient Boosting Machine, is a free and open source distributed gradient boosting framework for machine learning originally developed by Microsoft. It is based on decision tree algorithms and used for ranking, classification and other machine learning tasks."
ogImage: /images/integrations/lightgbm.png
---
...
Polyaxon provides a [tracking API](/docs/tracking/tracking/) to track experiment and report metrics, artifacts, logs, and results to the Polyaxon dashboard.
