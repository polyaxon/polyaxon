...
![gitlab-integration1](/images/integrations/gitlab/img1.png)
...
![gitlab-integration2](/images/integrations/gitlab/img2.png)

Or If you only want to allow Polyaxon read access please select:

![gitlab-integration3](/images/integrations/gitlab/img3.png)
