...
Polyaxon provides an interface for authoring reusable [components](/docs/references/polyaxonfile/specification/overview/),
...
Polyaxon provides a [Json API](/docs/references/api/) and a set of language [SDKs](/docs/references/#client-libraries)
...
and deliver outgoing [webhooks](/docs/references/webhooks) based on particular events.
