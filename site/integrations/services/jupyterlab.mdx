---
title: JupyterLab
description: "JupyterLab is an extensible environment for interactive and reproducible computing, based on the Jupyter Notebook and Architecture."
ogImage: /images/integrations/jupyter-lab.png
---
...
![jupyter-lab](/images/dashboard/runs/notebook-explore-models.png)
