...
ogImage: /images/integrations/flask.png
---
...
For a complete example from training to serving, please check [the serving tutorial](/docs/guides/serving/serving-flask-rest-apis/)
