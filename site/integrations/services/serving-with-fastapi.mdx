...
ogImage: /images/integrations/fastapi.png
---
 ...
 * Add the auth header with a [valid auth token](/docs/administration/organizations/user-profile/#token-management): `--header "Authorization: token AUTH_TOKEN"`.  

## Complete example

For a complete example from training to serving, please check [the serving tutorial](/docs/guides/serving/serving-fastapi-rest-apis/)
