---
title: Elastic Stack
description: "Elastic Stack lets you reliably and securely take data from any source, in any format, and search, analyze, and visualize it in real-time."
ogImage: /images/integrations/elastic-stack.png
---
...
Please check the [Logs storage configuration](/setup/connections/artifacts/) for more details.
