---
title: RStudio
description: "RStudio is an integrated development environment (IDE) for R, a programming language for statistical computing and graphics."
ogImage: /images/integrations/rstudio.png
---
...
![rstudio-service-light](/images/integrations/rstudio/rstudio-light.png)

 * Dark theme (Polyaxon and RStudio)

![rstudio-service-dark](/images/integrations/rstudio/rstudio-dark.png)
