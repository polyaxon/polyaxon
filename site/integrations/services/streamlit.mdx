---
title: Streamlit
description: "Streamlit’s open-source app framework is the easiest way for data scientists and machine learning engineers to create beautiful, performant apps in only a few hours! All in pure Python."
ogImage: /images/integrations/streamlit.png
---
...
![spacy-streamlit-light-1](/images/integrations/streamlit/spacy-streamlit-light-1.png)

![spacy-streamlit-light-2](/images/integrations/streamlit/spacy-streamlit-light-2.png)

Using the dark theme:

![spacy-streamlit-dark-1](/images/integrations/streamlit/spacy-streamlit-dark-1.png)

![spacy-streamlit-dark-2](/images/integrations/streamlit/spacy-streamlit-dark-2.png)
