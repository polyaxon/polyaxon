...
class V1S3Type(BaseTypeConfig, polyaxon_sdk.V1S3Type):
    ...
    >>> from polyaxon_schemas.defs.types import V1S3Type
    >>> params = {
    >>>     "test1": V1Param(value=V1S3Type(bucket="s3://bucket1")),
    >>>     "test2": V1Param(value=V1S3Type(bucket="s3://bucket1", key="keyName")),
    >>> }
    ```
    """
