# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-12-04 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('status', models.CharField(blank=True, choices=[('Created', 'Created'), ('Scheduled', 'Scheduled'), ('Starting', 'Starting'), ('Running', 'Running'), ('Succeeded', 'Succeeded'), ('Failed', 'Failed'), ('Deleted', 'Deleted'), ('UNKNOWN', 'UNKNOWN')], default='Created', max_length=64, null=True)),
