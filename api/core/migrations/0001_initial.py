# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-07 12:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', models.CharField(choices=[('Agent', 'Agent'), ('PGAgent', 'PGAgent'), ('TRPOAgent', 'TRPOAgent')], max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('module', models.CharField(choices=[('Memory', 'Memory'), ('BatchMemory', 'BatchMemory')], max_length=256)),
                ('params', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default={}, null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('module', models.CharField(blank=True, choices=[('TFRecordSequencePipeline', 'TFRecordSequencePipeline'), ('TFRecordSourceSequencePipeline', 'TFRecordSourceSequencePipeline'), ('ParallelTextPipeline', 'ParallelTextPipeline'), ('ImageCaptioningPipeline', 'ImageCaptioningPipeline'), ('TFRecordImagePipeline', 'TFRecordImagePipeline')], max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('module', models.CharField(choices=[('Classifier', 'Classifier'), ('Regressor', 'Regressor'), ('Generator', 'Generator'), ('DQNModel', 'DQNModel'), ('DDQNModel', 'DDQNModel'), ('NAFModel', 'NAFModel'), ('TRPOModel', 'TRPOModel'), ('VPGModel', 'VPGModel')], max_length=256)),
