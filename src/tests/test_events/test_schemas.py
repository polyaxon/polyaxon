...
class TestEventsV1(TestCase):
    ...
    def test_histograms_read_yaml(self):
        ...
        events = V1Events.read(
            ...
            data=os.path.abspath(
                "tests/fixtures/histogram/histogram_events.plx"
            ),
        )
        assert events.name == "foo"
        assert len(events.df.values) == 3
    ...
    def test_confusion_read_yaml(self):
        ...
        events = V1Events.read(
            ...
            kind="confusion",
            data=os.path.abspath(
                "tests/fixtures/confusion/confusion_events.plx"
            ),
        )
        assert events.name == "foo"
        assert len(events.df.values) == 3
    ...
    def test_artifacts_read_yaml(self):
        ...
        events = V1Events.read(
            ...
            kind="artifact",
            data=os.path.abspath(
                "tests/fixtures/artifact/artifact_events.plx"
            ),
        )
        assert events.name == "foo"
        assert len(events.df.values) == 3
    ...
    def test_models_read_yaml(self):
        ...
        events = V1Events.read(
            ...
            kind="model",
            data=os.path.abspath(
                "tests/fixtures/model/model_events_without_step.plx"
            ),
        )
        assert events.name == "foo"
    ...
    def test_dataframes_read_yaml(self):
        ...
        events = V1Events.read(
            ...
            kind="dataframe",
            data=os.path.abspath(
                "tests/fixtures/dataframe/dataframe_events.plx"
            ),
        )
        assert events.name == "foo"
        assert len(events.df.values) == 3
