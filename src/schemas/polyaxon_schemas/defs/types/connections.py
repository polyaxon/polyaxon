...
from polyaxon_schemas.defs.k8s_resources import K8sResourceSchema
...
from polyaxon_schemas.defs.types.k8s_resources import V1K8sResourceType
...
class V1ConnectionType(BaseConfig, polyaxon_sdk.V1ConnectionType):
    ...
    def store_path(self) -> str:
        ...
        if self.is_bucket:
            ...
            if self.is_wasb:
                from polyaxon_schemas.parser import parse_wasbs_path
