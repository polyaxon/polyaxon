...
from polyaxon_schemas.defs.types import V1K8sResourceType
from polyaxon_schemas.utils.tests_utils import assert_equal_dict


@pytest.mark.schemas_mark
class TestV1K8sResourceType(TestCase):
    def setUp(self):
