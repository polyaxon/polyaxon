...
class V1AuthType(BaseTypeConfig, polyaxon_sdk.V1AuthType):
    ...
    >>> from polyaxon_schemas.defs.types import V1AuthType
    >>> params = {
    >>>     "test1": V1Param(value=V1AuthType(user="username1", password="password1")),
    >>>     "test2": V1Param(value=V1AuthType(user="username2", password="password2")),
    >>> }
    ```
