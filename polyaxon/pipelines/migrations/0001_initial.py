    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('n_retries', models.PositiveSmallIntegerField(blank=True, help_text='the number of retries that performed so far by the operations.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('retried_at', models.DateTimeField(blank=True, help_text='When the instance last retried.', null=True)),
                ...
                ('celery_task_id', models.UUIDField(blank=True)),
        ...
        migrations.AddField(
            model_name='operationrun',
            name='upstream_runs',
            field=models.ManyToManyField(blank=True, related_name='_operationrun_upstream_runs_+', to='pipelines.OperationRun'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='_operation_upstream_operations_+', to='pipelines.Operation'),
        ),
        migrations.AddField(
            model_name='operation',
            name='user',
