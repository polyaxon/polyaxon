...
from polypod.templates.env_vars import get_kv_env_vars, get_pod_env_from, get_resources_env_vars
from polypod.templates.gpu_volumes import get_gpu_volumes_def
from polypod.templates.resources import get_resources
from polypod.templates.security_context import get_security_context
from polypod.templates.sidecars import get_sidecar_args, get_sidecar_container
from polypod.templates.tpu import get_tpu_annotations, requests_tpu
...
class BaseResourceManager(object):
    ...
    def get_deployment(self,
        ...
        deployment_spec = client.V1DeploymentSpec(replicas=replicas,
