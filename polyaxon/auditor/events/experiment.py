...
auditor.subscribe(experiment.ExperimentTriggeredDeletedEvent)
auditor.subscribe(experiment.ExperimentTriggeredStoppedEvent)
auditor.subscribe(experiment.ExperimentTriggeredResumedEvent)
auditor.subscribe(experiment.ExperimentTriggeredRestartedEvent)
auditor.subscribe(experiment.ExperimentTriggeredCopiedEvent)
