...
class UserApi(BaseApiHandler):
    ...
    def activate_user(self, username):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while activating user."
            )
            return None
    ...
    def delete_user(self, username):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while deleting user."
            )
            return None
    ...
    def grant_superuser(self, username):
        ...
        request_url = self.build_url(
            self._get_http_url(self.ENDPOINT_SUPERUSERS), "grant", username
        )
    ...
    def revoke_superuser(self, username):
        """Activate a user account."""
        request_url = self.build_url(
            self._get_http_url(self.ENDPOINT_SUPERUSERS), "revoke", username
        )
