...
PROJECT_NOTEBOOKS_VIEWED = '{}.{}'.format(event_subjects.PROJECT,
                                          event_actions.NOTEBOOKS_VIEWED)
...
EVENTS = {
    ...
    PROJECT_SET_PUBLIC,
    PROJECT_SET_PRIVATE,
    PROJECT_EXPERIMENTS_VIEWED,
    PROJECT_JOBS_VIEWED,
    PROJECT_BUILDS_VIEWED,
    PROJECT_TENSORBOARDS_VIEWED,
    PROJECT_NOTEBOOKS_VIEWED,
    PROJECT_EXPERIMENT_GROUPS_VIEWED,
}
...
class ProjectNotebooksViewedEvent(Event):
    event_type = PROJECT_NOTEBOOKS_VIEWED
    actor = True
    attributes = (
        Attribute('id'),
        Attribute('user.id'),
