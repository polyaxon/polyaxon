...
class TRPOModel(BasePGModel):
    ...
    def _build_loss(self, results, features, labels):
        ...
        kl_divergence = kl(self._graph_results.distribution, old_distribution)
        self._kl_loss = tf.reduce_mean(kl_divergence, name='kl_loss')
        ...
        kl_divergence_1_fixed = kl(distribution_1_fixed, self._graph_results.distribution),
