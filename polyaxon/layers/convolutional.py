...
try:
    from tensorflow.python.keras._impl.keras.layers import convolutional
except ImportError:
...
class Conv2DTranspose(BaseObject, convolutional.Conv2DTranspose):
    ...
    __doc__ = Conv2DTransposeConfig.__doc__
...
class Conv3DTranspose(BaseObject, convolutional.Conv3DTranspose):
    ...
    __doc__ = Conv3DTransposeConfig.__doc__
...
class SeparableConv2D(BaseObject, convolutional.SeparableConv2D):
    ...
    __doc__ = SeparableConv2DConfig.__doc__
