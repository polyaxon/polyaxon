...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_EXPERIMENT_GROUP, ignore_result=True)
...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_EXPERIMENT, ignore_result=True)
...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_JOB, ignore_result=True)
...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_BUILD_JOB, ignore_result=True)
...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_NOTEBOOK_JOB, ignore_result=True)
...
@workers.app.task(name=SchedulerCeleryTasks.DELETE_ARCHIVED_TENSORBOARD_JOB, ignore_result=True)
