...
class OAUTH_PROVIDERS(object):  # noqa
    ...
    class AZURE(object):
        ...
        TENANT_ID = config.get_string('POLYAXON_AUTH_AZURE_TENANT_ID',
                                      is_optional=True,
                                      is_secret=True)
        CLIENT_ID = config.get_string('POLYAXON_AUTH_AZURE_CLIENT_ID',
                                      is_optional=True,
                                      is_secret=True)
        CLIENT_SECRET = config.get_string('POLYAXON_AUTH_AZURE_CLIENT_SECRET',
                                          is_optional=True,
                                          is_secret=True)
        ENABLED = config.get_boolean('POLYAXON_AUTH_AZURE',
                                     is_optional=True,
                                     default=False)

    SSO_ENABLED = any([GITHUB.ENABLED, BITBUCKET.ENABLED, GITLAB.ENABLED, AZURE.ENABLED])