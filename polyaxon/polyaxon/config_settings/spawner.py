...
JOB_CONTAINER_NAME = config.get_string('POLYAXON_CONTAINER_NAME_JOB')
JOB_SIDECAR_CONTAINER_NAME = config.get_string('POLYAXON_SIDECAR_CONTAINER_NAME')
JOB_PLUGIN_CONTAINER_NAME = config.get_string('POLYAXON_CONTAINER_NAME_JOB')
