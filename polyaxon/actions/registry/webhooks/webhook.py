...
from actions.action import Action, ConfigType, logger
from actions.action_event import ActionExecutedEvent
...
from options.registry.integrations import INTEGRATIONS_WEBHOOKS_GENERIC
...
class WebHookAction(Action):
    ...
    def _get_config(cls) -> ConfigType:
        ...
        """
        return conf.get(INTEGRATIONS_WEBHOOKS_GENERIC)
