...
import {
    ...
    V1NotificationTriggerFromJSON,
    V1NotificationTriggerFromJSONTyped,
    V1NotificationTriggerToJSON,
} from './';
...
export function V1NotificationFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Notification {
    ...
    return {
        ...
        'trigger': !exists(json, 'trigger') ? undefined : V1NotificationTriggerFromJSON(json['trigger']),
    };
}
...
export function V1NotificationToJSON(value?: V1Notification | null): any {
    ...
    return {
        ...
        'trigger': V1NotificationTriggerToJSON(value.trigger),
    };
}
