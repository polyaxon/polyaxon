...
import {
    ...
    V1Parallel,
    V1ParallelFromJSON,
    V1ParallelFromJSONTyped,
    V1ParallelToJSON,
    V1ParallelKind,
    V1ParallelKindFromJSON,
    V1ParallelKindFromJSONTyped,
    V1ParallelKindToJSON,
...
export function V1SchemasFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Schemas {
    ...
    return {
        ...
        'parallel_kind': !exists(json, 'parallel_kind') ? undefined : V1ParallelKindFromJSON(json['parallel_kind']),
    };
}
...
export function V1SchemasToJSON(value?: V1Schemas | null): any {
    ...
    return {
        ...
        'parallel_kind': V1ParallelKindToJSON(value.parallel_kind),
    };
}
