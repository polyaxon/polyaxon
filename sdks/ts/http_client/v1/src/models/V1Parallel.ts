...
export function V1ParallelFromJSON(json: any): V1Parallel {
    return V1ParallelFromJSONTyped(json, false);
}

export function V1ParallelFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1Parallel {
...
export function V1ParallelToJSON(value?: V1Parallel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
