...
export class ComponentHubV1Api extends runtime.BaseAPI {
     ...
     */
    async deleteComponentHubRaw(requestParameters: DeleteComponentHubRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete hub component
     */
    async deleteComponentHub(requestParameters: DeleteComponentHubRequest): Promise<object> {
        const response = await this.deleteComponentHubRaw(requestParameters);
        return await response.value();
    }
