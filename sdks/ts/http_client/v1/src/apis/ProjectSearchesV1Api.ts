...
export class ProjectSearchesV1Api extends runtime.BaseAPI {
     ...
     */
    async deleteProjectSearchRaw(requestParameters: DeleteProjectSearchRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling deleteProjectSearch.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/searches/{uuid}`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Delete project search
     */
    async deleteProjectSearch(requestParameters: DeleteProjectSearchRequest): Promise<object> {
        const response = await this.deleteProjectSearchRaw(requestParameters);
        return await response.value();
    }
    ...
    async getProjectSearchRaw(requestParameters: GetProjectSearchRequest): Promise<runtime.ApiResponse<V1Search>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling getProjectSearch.');
        }
    ...
    async listProjectSearchNamesRaw(requestParameters: ListProjectSearchNamesRequest): Promise<runtime.ApiResponse<V1ListSearchesResponse>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listProjectSearchNames.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/searches/names`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async listProjectSearchesRaw(requestParameters: ListProjectSearchesRequest): Promise<runtime.ApiResponse<V1ListSearchesResponse>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listProjectSearches.');
        }
     ...
     */
    async promoteProjectSearchRaw(requestParameters: PromoteProjectSearchRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling promoteProjectSearch.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/searches/{uuid}/promote`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Promote project search
     */
    async promoteProjectSearch(requestParameters: PromoteProjectSearchRequest): Promise<object> {
        const response = await this.promoteProjectSearchRaw(requestParameters);
        return await response.value();
    }
