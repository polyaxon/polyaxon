...
export class OrganizationsV1Api extends runtime.BaseAPI {
     ...
     */
    async deleteOrganizationInvitationRaw(requestParameters: DeleteOrganizationInvitationRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete organization invitation details
     */
    async deleteOrganizationInvitation(requestParameters: DeleteOrganizationInvitationRequest): Promise<object> {
        const response = await this.deleteOrganizationInvitationRaw(requestParameters);
        return await response.value();
    }
