...
export class ProjectDashboardsV1Api extends runtime.BaseAPI {
     ...
     */
    async deleteProjectDashboardRaw(requestParameters: DeleteProjectDashboardRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling deleteProjectDashboard.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/dashboards/{uuid}`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Delete project dashboard
     */
    async deleteProjectDashboard(requestParameters: DeleteProjectDashboardRequest): Promise<object> {
        const response = await this.deleteProjectDashboardRaw(requestParameters);
        return await response.value();
    }
    ...
    async getProjectDashboardRaw(requestParameters: GetProjectDashboardRequest): Promise<runtime.ApiResponse<V1Dashboard>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling getProjectDashboard.');
        }
    ...
    async listProjectDashboardNamesRaw(requestParameters: ListProjectDashboardNamesRequest): Promise<runtime.ApiResponse<V1ListDashboardsResponse>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listProjectDashboardNames.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/dashboards/names`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async listProjectDashboardsRaw(requestParameters: ListProjectDashboardsRequest): Promise<runtime.ApiResponse<V1ListDashboardsResponse>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listProjectDashboards.');
        }
     ...
     */
    async promoteProjectDashboardRaw(requestParameters: PromoteProjectDashboardRequest): Promise<runtime.ApiResponse<V1Dashboard>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling promoteProjectDashboard.');
        }

        if (requestParameters.dashboardUuid === null || requestParameters.dashboardUuid === undefined) {
            throw new runtime.RequiredError('dashboardUuid','Required parameter requestParameters.dashboardUuid was null or undefined when calling promoteProjectDashboard.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/dashboards/{dashboard.uuid}/promote`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"dashboard.uuid"}}`, encodeURIComponent(String(requestParameters.dashboardUuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Promote project dashboard
     */
    async promoteProjectDashboard(requestParameters: PromoteProjectDashboardRequest): Promise<V1Dashboard> {
        const response = await this.promoteProjectDashboardRaw(requestParameters);
        return await response.value();
    }
