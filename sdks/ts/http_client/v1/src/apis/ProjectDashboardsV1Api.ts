...
export class ProjectDashboardsV1Api extends runtime.BaseAPI {
     ...
     */
    async promoteProjectDashboardRaw(requestParameters: PromoteProjectDashboardRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/dashboards/{uuid}/promote`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * Promote project dashboard
     */
    async promoteProjectDashboard(requestParameters: PromoteProjectDashboardRequest): Promise<object> {
