...
export class AuthV1Api extends runtime.BaseAPI {
     ...
     * Reset password
     */
    async resetPasswordRaw(requestParameters: ResetPasswordRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * Reset password
     */
    async resetPassword(requestParameters: ResetPasswordRequest): Promise<object> {
