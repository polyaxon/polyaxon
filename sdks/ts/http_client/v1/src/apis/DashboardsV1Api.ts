...
export class DashboardsV1Api extends runtime.BaseAPI {
     ...
     * Delete dashboard
     */
    async deleteDashboardRaw(requestParameters: DeleteDashboardRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete dashboard
     */
    async deleteDashboard(requestParameters: DeleteDashboardRequest): Promise<object> {
        const response = await this.deleteDashboardRaw(requestParameters);
        return await response.value();
    }
