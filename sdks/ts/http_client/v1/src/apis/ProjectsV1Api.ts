...
export class ProjectsV1Api extends runtime.BaseAPI {
     ...
     * Archive project
     */
    async archiveProjectRaw(requestParameters: ArchiveProjectRequest): Promise<runtime.ApiResponse<object>> {
     ...
     * Archive project
     */
    async archiveProject(requestParameters: ArchiveProjectRequest): Promise<object> {
     ...
     * Bookmark project
     */
    async bookmarkProjectRaw(requestParameters: BookmarkProjectRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Bookmark project
     */
    async bookmarkProject(requestParameters: BookmarkProjectRequest): Promise<object> {
        const response = await this.bookmarkProjectRaw(requestParameters);
        return await response.value();
    }
     ...
     * Delete project
     */
    async deleteProjectRaw(requestParameters: DeleteProjectRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete project
     */
    async deleteProject(requestParameters: DeleteProjectRequest): Promise<object> {
     ...
     * Disbale project CI
     */
    async disableProjectCIRaw(requestParameters: DisableProjectCIRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Disbale project CI
     */
    async disableProjectCI(requestParameters: DisableProjectCIRequest): Promise<object> {
        const response = await this.disableProjectCIRaw(requestParameters);
        return await response.value();
    }
     ...
     * Enable project CI
     */
    async enableProjectCIRaw(requestParameters: EnableProjectCIRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Enable project CI
     */
    async enableProjectCI(requestParameters: EnableProjectCIRequest): Promise<object> {
        const response = await this.enableProjectCIRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async listBookmarkedProjectsRaw(requestParameters: ListBookmarkedProjectsRequest): Promise<runtime.ApiResponse<V1ListProjectsResponse>> {
        if (requestParameters.user === null || requestParameters.user === undefined) {
     ...
     * List bookmarked projects for user
     */
    async listBookmarkedProjects(requestParameters: ListBookmarkedProjectsRequest): Promise<V1ListProjectsResponse> {
     ...
     * Restore project
     */
    async restoreProjectRaw(requestParameters: RestoreProjectRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Restore project
     */
    async restoreProject(requestParameters: RestoreProjectRequest): Promise<object> {
        const response = await this.restoreProjectRaw(requestParameters);
        return await response.value();
    }
     ...
     * Unbookmark project
     */
    async unbookmarkProjectRaw(requestParameters: UnbookmarkProjectRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Unbookmark project
     */
    async unbookmarkProject(requestParameters: UnbookmarkProjectRequest): Promise<object> {
        const response = await this.unbookmarkProjectRaw(requestParameters);
        return await response.value();
    }
