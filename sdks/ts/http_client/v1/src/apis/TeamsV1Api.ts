...
export class TeamsV1Api extends runtime.BaseAPI {
     ...
     * Delete team
     */
    async deleteTeamRaw(requestParameters: DeleteTeamRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     */
    async deleteTeamMemberRaw(requestParameters: DeleteTeamMemberRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete team member details
     */
    async deleteTeamMember(requestParameters: DeleteTeamMemberRequest): Promise<object> {
        const response = await this.deleteTeamMemberRaw(requestParameters);
        return await response.value();
    }
