...
export class PresetsV1Api extends runtime.BaseAPI {
     ...
     */
    async deletePresetRaw(requestParameters: DeletePresetRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete scheduling preset
     */
    async deletePreset(requestParameters: DeletePresetRequest): Promise<object> {
        const response = await this.deletePresetRaw(requestParameters);
        return await response.value();
    }
