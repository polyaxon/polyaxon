...
export class ConnectionsV1Api extends runtime.BaseAPI {
     ...
     * Delete connection
     */
    async deleteConnectionRaw(requestParameters: DeleteConnectionRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete connection
     */
    async deleteConnection(requestParameters: DeleteConnectionRequest): Promise<object> {
