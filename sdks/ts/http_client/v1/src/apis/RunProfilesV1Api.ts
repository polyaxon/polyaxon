...
export class RunProfilesV1Api extends runtime.BaseAPI {
     ...
     */
    async deleteRunProfileRaw(requestParameters: DeleteRunProfileRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete hub component
     */
    async deleteRunProfile(requestParameters: DeleteRunProfileRequest): Promise<object> {
        const response = await this.deleteRunProfileRaw(requestParameters);
        return await response.value();
    }
