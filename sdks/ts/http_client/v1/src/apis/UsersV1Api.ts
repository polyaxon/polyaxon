...
export class UsersV1Api extends runtime.BaseAPI {
     ...
     * Delete token
     */
    async deleteTokenRaw(requestParameters: DeleteTokenRequest): Promise<runtime.ApiResponse<object>> {
     ...
     * Delete token
     */
    async deleteToken(requestParameters: DeleteTokenRequest): Promise<object> {
