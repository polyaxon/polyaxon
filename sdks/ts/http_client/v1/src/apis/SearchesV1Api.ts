...
export class SearchesV1Api extends runtime.BaseAPI {
     ...
     * Delete search
     */
    async deleteSearchRaw(requestParameters: DeleteSearchRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete search
     */
    async deleteSearch(requestParameters: DeleteSearchRequest): Promise<object> {
        const response = await this.deleteSearchRaw(requestParameters);
        return await response.value();
    }
