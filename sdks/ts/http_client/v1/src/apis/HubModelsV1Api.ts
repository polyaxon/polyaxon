...
export class HubModelsV1Api extends runtime.BaseAPI {
     ...
     * Delete dashboard
     */
    async deleteHubModelRaw(requestParameters: DeleteHubModelRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete dashboard
     */
    async deleteHubModel(requestParameters: DeleteHubModelRequest): Promise<object> {
        const response = await this.deleteHubModelRaw(requestParameters);
        return await response.value();
    }
