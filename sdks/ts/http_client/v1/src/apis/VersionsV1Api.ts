...
export class VersionsV1Api extends runtime.BaseAPI {
     ...
     */
    async getInstallationRaw(): Promise<runtime.ApiResponse<V1Installation>> {
        const queryParameters: runtime.HTTPQuery = {};
     ...
     * Get installation versions
     */
    async getInstallation(): Promise<V1Installation> {
        const response = await this.getInstallationRaw();
        return await response.value();
    }
