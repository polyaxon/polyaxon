...
export class RunsV1Api extends runtime.BaseAPI {
    ...
    async approveRunRaw(requestParameters: ApproveRunRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling approveRun.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/runs/{uuid}/approve`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'POST',
