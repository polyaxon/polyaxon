...
export class RunsV1Api extends runtime.BaseAPI {
     ...
     * Delete run artifact
     */
    async deleteRunArtifactRaw(requestParameters: DeleteRunArtifactRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * Delete run artifact
     */
    async deleteRunArtifact(requestParameters: DeleteRunArtifactRequest): Promise<object> {
        const response = await this.deleteRunArtifactRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async deleteRunArtifactsRaw(requestParameters: DeleteRunArtifactsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * Delete run artifacts
     */
    async deleteRunArtifacts(requestParameters: DeleteRunArtifactsRequest): Promise<object> {
        const response = await this.deleteRunArtifactsRaw(requestParameters);
        return await response.value();
    }
