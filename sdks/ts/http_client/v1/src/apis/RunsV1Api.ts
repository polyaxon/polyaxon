...
export class RunsV1Api extends runtime.BaseAPI {
    ...
    async copyRunRaw(requestParameters: CopyRunRequest): Promise<runtime.ApiResponse<V1Run>> {
        ...
        if (requestParameters.entityEntity === null || requestParameters.entityEntity === undefined) {
            throw new runtime.RequiredError('entityEntity','Required parameter requestParameters.entityEntity was null or undefined when calling copyRun.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{entity.owner}/{entity.entity}/runs/{entity.uuid}/copy`.replace(`{${"entity.owner"}}`, encodeURIComponent(String(requestParameters.entityOwner))).replace(`{${"entity.entity"}}`, encodeURIComponent(String(requestParameters.entityEntity))).replace(`{${"entity.uuid"}}`, encodeURIComponent(String(requestParameters.entityUuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async restartRunRaw(requestParameters: RestartRunRequest): Promise<runtime.ApiResponse<V1Run>> {
        ...
        if (requestParameters.entityEntity === null || requestParameters.entityEntity === undefined) {
            throw new runtime.RequiredError('entityEntity','Required parameter requestParameters.entityEntity was null or undefined when calling restartRun.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{entity.owner}/{entity.entity}/runs/{entity.uuid}/restart`.replace(`{${"entity.owner"}}`, encodeURIComponent(String(requestParameters.entityOwner))).replace(`{${"entity.entity"}}`, encodeURIComponent(String(requestParameters.entityEntity))).replace(`{${"entity.uuid"}}`, encodeURIComponent(String(requestParameters.entityUuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: V1RunToJSON(requestParameters.body),
    ...
    async resumeRunRaw(requestParameters: ResumeRunRequest): Promise<runtime.ApiResponse<V1Run>> {
        ...
        if (requestParameters.entityEntity === null || requestParameters.entityEntity === undefined) {
            throw new runtime.RequiredError('entityEntity','Required parameter requestParameters.entityEntity was null or undefined when calling resumeRun.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{entity.owner}/{entity.entity}/runs/{entity.uuid}/resume`.replace(`{${"entity.owner"}}`, encodeURIComponent(String(requestParameters.entityOwner))).replace(`{${"entity.entity"}}`, encodeURIComponent(String(requestParameters.entityEntity))).replace(`{${"entity.uuid"}}`, encodeURIComponent(String(requestParameters.entityUuid))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: V1RunToJSON(requestParameters.body),
