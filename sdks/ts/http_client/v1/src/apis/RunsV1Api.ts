...
export class RunsV1Api extends runtime.BaseAPI {
    ...
    async getRunArtifactsLineageRaw(requestParameters: GetRunArtifactsLineageRequest): Promise<runtime.ApiResponse<V1ListRunArtifactsResponse>> {
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{entity}/runs/{uuid}/artifacts_lineage`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"entity"}}`, encodeURIComponent(String(requestParameters.entity))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async getRunArtifactsLineageNamesRaw(requestParameters: GetRunArtifactsLineageNamesRequest): Promise<runtime.ApiResponse<V1ListRunArtifactsResponse>> {
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{entity}/runs/{uuid}/artifacts_lineage/names`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"entity"}}`, encodeURIComponent(String(requestParameters.entity))).replace(`{${"uuid"}}`, encodeURIComponent(String(requestParameters.uuid))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async getRunsArtifactsLineageRaw(requestParameters: GetRunsArtifactsLineageRequest): Promise<runtime.ApiResponse<V1ListRunArtifactsResponse>> {
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{name}/runs/artifacts_lineage`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"name"}}`, encodeURIComponent(String(requestParameters.name))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
