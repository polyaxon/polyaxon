...
export interface ListRunsIoRequest {
    owner: string;
    project: string;
    offset?: number;
    limit?: number;
...
export class RunsV1Api extends runtime.BaseAPI {
     ...
     * Archive run
     */
    async archiveRunRaw(requestParameters: ArchiveRunRequest): Promise<runtime.ApiResponse<object>> {
     ...
     * Archive run
     */
    async archiveRun(requestParameters: ArchiveRunRequest): Promise<object> {
        const response = await this.archiveRunRaw(requestParameters);
     ...
     * Bookmark run
     */
    async bookmarkRunRaw(requestParameters: BookmarkRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Bookmark run
     */
    async bookmarkRun(requestParameters: BookmarkRunRequest): Promise<object> {
        const response = await this.bookmarkRunRaw(requestParameters);
        return await response.value();
    }
     ...
     * Bookmark runs
     */
    async bookmarkRunsRaw(requestParameters: BookmarkRunsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Bookmark runs
     */
    async bookmarkRuns(requestParameters: BookmarkRunsRequest): Promise<object> {
        const response = await this.bookmarkRunsRaw(requestParameters);
        return await response.value();
    }
     ...
     * Collect run logs
     */
    async collectRunLogsRaw(requestParameters: CollectRunLogsRequest): Promise<runtime.ApiResponse<object>> {
     ...
     * Collect run logs
     */
    async collectRunLogs(requestParameters: CollectRunLogsRequest): Promise<object> {
        const response = await this.collectRunLogsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async createRunArtifactsLineageRaw(requestParameters: CreateRunArtifactsLineageRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Create bulk run run artifacts lineage
     */
    async createRunArtifactsLineage(requestParameters: CreateRunArtifactsLineageRequest): Promise<object> {
        const response = await this.createRunArtifactsLineageRaw(requestParameters);
        return await response.value();
    }
     ...
     * Delete run
     */
    async deleteRunRaw(requestParameters: DeleteRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete run
     */
    async deleteRun(requestParameters: DeleteRunRequest): Promise<object> {
        const response = await this.deleteRunRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async deleteRunArtifactLineageRaw(requestParameters: DeleteRunArtifactLineageRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete run artifact lineage
     */
    async deleteRunArtifactLineage(requestParameters: DeleteRunArtifactLineageRequest): Promise<object> {
        const response = await this.deleteRunArtifactLineageRaw(requestParameters);
        return await response.value();
    }
     ...
     * Delete runs
     */
    async deleteRunsRaw(requestParameters: DeleteRunsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Delete runs
     */
    async deleteRuns(requestParameters: DeleteRunsRequest): Promise<object> {
        const response = await this.deleteRunsRaw(requestParameters);
        return await response.value();
    }
     ...
     * Invalidate run
     */
    async invalidateRunRaw(requestParameters: InvalidateRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Invalidate run
     */
    async invalidateRun(requestParameters: InvalidateRunRequest): Promise<object> {
        const response = await this.invalidateRunRaw(requestParameters);
        return await response.value();
    }
     ...
     * Invalidate runs
     */
    async invalidateRunsRaw(requestParameters: InvalidateRunsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Invalidate runs
     */
    async invalidateRuns(requestParameters: InvalidateRunsRequest): Promise<object> {
        const response = await this.invalidateRunsRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async listBookmarkedRunsRaw(requestParameters: ListBookmarkedRunsRequest): Promise<runtime.ApiResponse<V1ListRunsResponse>> {
        if (requestParameters.user === null || requestParameters.user === undefined) {
     ...
     * List bookmarked runs for user
     */
    async listBookmarkedRuns(requestParameters: ListBookmarkedRunsRequest): Promise<V1ListRunsResponse> {
     ...
     * List runs io
     */
    async listRunsIoRaw(requestParameters: ListRunsIoRequest): Promise<runtime.ApiResponse<V1ListRunsResponse>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
            throw new runtime.RequiredError('owner','Required parameter requestParameters.owner was null or undefined when calling listRunsIo.');
        }

        if (requestParameters.project === null || requestParameters.project === undefined) {
            throw new runtime.RequiredError('project','Required parameter requestParameters.project was null or undefined when calling listRunsIo.');
        }
        ...
        const response = await this.request({
            path: `/api/v1/{owner}/{project}/runs/io`.replace(`{${"owner"}}`, encodeURIComponent(String(requestParameters.owner))).replace(`{${"project"}}`, encodeURIComponent(String(requestParameters.project))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
     ...
     * List runs io
     */
    async listRunsIo(requestParameters: ListRunsIoRequest): Promise<V1ListRunsResponse> {
        const response = await this.listRunsIoRaw(requestParameters);
        return await response.value();
    }
     ...
     * Notify run status
     */
    async notifyRunStatusRaw(requestParameters: NotifyRunStatusRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.namespace === null || requestParameters.namespace === undefined) {
     ...
     * Notify run status
     */
    async notifyRunStatus(requestParameters: NotifyRunStatusRequest): Promise<object> {
        const response = await this.notifyRunStatusRaw(requestParameters);
        return await response.value();
    }
     ...
     * Restore run
     */
    async restoreRunRaw(requestParameters: RestoreRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Restore run
     */
    async restoreRun(requestParameters: RestoreRunRequest): Promise<object> {
        const response = await this.restoreRunRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async startRunTensorboardRaw(requestParameters: StartRunTensorboardRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Start run tensorboard
     */
    async startRunTensorboard(requestParameters: StartRunTensorboardRequest): Promise<object> {
        const response = await this.startRunTensorboardRaw(requestParameters);
        return await response.value();
    }
     ...
     * Stop run
     */
    async stopRunRaw(requestParameters: StopRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Stop run
     */
    async stopRun(requestParameters: StopRunRequest): Promise<object> {
        const response = await this.stopRunRaw(requestParameters);
        return await response.value();
    }
     ...
     */
    async stopRunTensorboardRaw(requestParameters: StopRunTensorboardRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Stop run tensorboard
     */
    async stopRunTensorboard(requestParameters: StopRunTensorboardRequest): Promise<object> {
        const response = await this.stopRunTensorboardRaw(requestParameters);
        return await response.value();
    }
     ...
     * Stop runs
     */
    async stopRunsRaw(requestParameters: StopRunsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Stop runs
     */
    async stopRuns(requestParameters: StopRunsRequest): Promise<object> {
        const response = await this.stopRunsRaw(requestParameters);
        return await response.value();
    }
     ...
     * Tag runs
     */
    async tagRunsRaw(requestParameters: TagRunsRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Tag runs
     */
    async tagRuns(requestParameters: TagRunsRequest): Promise<object> {
        const response = await this.tagRunsRaw(requestParameters);
        return await response.value();
    }
     ...
     * Unbookmark run
     */
    async unbookmarkRunRaw(requestParameters: UnbookmarkRunRequest): Promise<runtime.ApiResponse<object>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Unbookmark run
     */
    async unbookmarkRun(requestParameters: UnbookmarkRunRequest): Promise<object> {
        const response = await this.unbookmarkRunRaw(requestParameters);
        return await response.value();
    }
