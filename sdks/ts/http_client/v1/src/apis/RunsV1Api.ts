...
export class RunsV1Api extends runtime.BaseAPI {
     ...
     * Transfer run
     */
    async transferRunRaw(requestParameters: TransferRunRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Transfer run
     */
    async transferRun(requestParameters: TransferRunRequest): Promise<void> {
        await this.transferRunRaw(requestParameters);
    }

    /**
     * Transfer runs
     */
    async transferRunsRaw(requestParameters: TransferRunsRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.owner === null || requestParameters.owner === undefined) {
     ...
     * Transfer runs
     */
    async transferRuns(requestParameters: TransferRunsRequest): Promise<void> {
        await this.transferRunsRaw(requestParameters);
    }
