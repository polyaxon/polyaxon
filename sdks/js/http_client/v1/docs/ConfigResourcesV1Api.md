# PolyaxonSdk.ConfigResourcesV1Api
...
var apiInstance = new PolyaxonSdk.ConfigResourcesV1Api();

var owner = "owner_example"; // String | Owner of the namespace

var body = new PolyaxonSdk.V1ConfigResource(); // V1ConfigResource | Artifact store body
...
apiInstance.createConfigResource(owner, body, callback);
```
...
apiInstance.deleteConfigResource(owner, uuid, callback);
```
...
apiInstance.getConfigResource(owner, uuid, callback);
```
...
> V1ListConfigResourcesResponse listConfigResourceNames(owner, opts)
...
apiInstance.listConfigResourceNames(owner, opts, callback);
```
...
# **listConfigResources**
> V1ListConfigResourcesResponse listConfigResources(owner, opts)
...
apiInstance.listConfigResources(owner, opts, callback);
```
...
# **patchConfigResource**
> V1ConfigResource patchConfigResource(owner, config_resource_uuid, body)
...
var config_resource_uuid = "config_resource_uuid_example"; // String | UUID
...
apiInstance.patchConfigResource(owner, config_resource_uuid, body, callback);
```
...
------------- | ------------- | ------------- | -------------
 **owner** | **String**| Owner of the namespace | 
 **config_resource_uuid** | **String**| UUID | 
 **body** | [**V1ConfigResource**](V1ConfigResource.md)| Artifact store body | 
...
> V1ConfigResource updateConfigResource(owner, config_resource_uuid, body)
...
apiInstance.updateConfigResource(owner, config_resource_uuid, body, callback);
```
