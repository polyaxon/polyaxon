...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ProjectsV1Api~restoreExperimentCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} owner Owner of the namespace
     * @param {String} project Project under namesapce
     * @param {module:api/ProjectsV1Api~restoreExperimentCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
