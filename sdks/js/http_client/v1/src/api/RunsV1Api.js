...
export default class RunsV1Api {
    ...
    */
     ...
     * @param {String} entity_entity Entity: project name, hub name, registry name, ...
     * @param {String} entity_uuid Uuid identifier of the sub-entity
     ...
     */
    copyRun(entity_owner, entity_entity, entity_uuid, body, callback) {
      let postBody = body;
      ...
      if (entity_entity === undefined || entity_entity === null) {
        throw new Error("Missing the required parameter 'entity_entity' when calling copyRun");
      }
     ...
     * data is of type: {@link module:model/V1Run}
     */
    restartRun(entity_owner, entity_entity, entity_uuid, body, callback) {
      let postBody = body;
      // verify the required parameter 'entity_owner' is set
      if (entity_owner === undefined || entity_owner === null) {
      ...
      // verify the required parameter 'entity_entity' is set
      if (entity_entity === undefined || entity_entity === null) {
        throw new Error("Missing the required parameter 'entity_entity' when calling restartRun");
      }
      // verify the required parameter 'entity_uuid' is set
      if (entity_uuid === undefined || entity_uuid === null) {
     ...
     * data is of type: {@link module:model/V1Run}
     */
    resumeRun(entity_owner, entity_entity, entity_uuid, body, callback) {
      let postBody = body;
      // verify the required parameter 'entity_owner' is set
      if (entity_owner === undefined || entity_owner === null) {
      ...
      // verify the required parameter 'entity_entity' is set
      if (entity_entity === undefined || entity_entity === null) {
        throw new Error("Missing the required parameter 'entity_entity' when calling resumeRun");
      }
      // verify the required parameter 'entity_uuid' is set
      if (entity_uuid === undefined || entity_uuid === null) {
