...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RuntimeError', 'model/V1ArtifactTree', 'model/V1Auth', 'model/V1Dashboard', 'model/V1EntityNotificationBody', 'model/V1EntityStatusBodyRequest', 'model/V1EventsResponse', 'model/V1ListDashboardsResponse', 'model/V1ListRunArtifactsResponse', 'model/V1ListRunsResponse', 'model/V1Logs', 'model/V1OperationBody', 'model/V1ProjectEntityResourceRequest', 'model/V1Run', 'model/V1RunArtifact', 'model/V1RunArtifacts', 'model/V1RunSettings', 'model/V1Status', 'model/V1Uuids'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RuntimeError'), require('../model/V1ArtifactTree'), require('../model/V1Auth'), require('../model/V1Dashboard'), require('../model/V1EntityNotificationBody'), require('../model/V1EntityStatusBodyRequest'), require('../model/V1EventsResponse'), require('../model/V1ListDashboardsResponse'), require('../model/V1ListRunArtifactsResponse'), require('../model/V1ListRunsResponse'), require('../model/V1Logs'), require('../model/V1OperationBody'), require('../model/V1ProjectEntityResourceRequest'), require('../model/V1Run'), require('../model/V1RunArtifact'), require('../model/V1RunArtifacts'), require('../model/V1RunSettings'), require('../model/V1Status'), require('../model/V1Uuids'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.RunsV1Api = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.RuntimeError, root.PolyaxonSdk.V1ArtifactTree, root.PolyaxonSdk.V1Auth, root.PolyaxonSdk.V1Dashboard, root.PolyaxonSdk.V1EntityNotificationBody, root.PolyaxonSdk.V1EntityStatusBodyRequest, root.PolyaxonSdk.V1EventsResponse, root.PolyaxonSdk.V1ListDashboardsResponse, root.PolyaxonSdk.V1ListRunArtifactsResponse, root.PolyaxonSdk.V1ListRunsResponse, root.PolyaxonSdk.V1Logs, root.PolyaxonSdk.V1OperationBody, root.PolyaxonSdk.V1ProjectEntityResourceRequest, root.PolyaxonSdk.V1Run, root.PolyaxonSdk.V1RunArtifact, root.PolyaxonSdk.V1RunArtifacts, root.PolyaxonSdk.V1RunSettings, root.PolyaxonSdk.V1Status, root.PolyaxonSdk.V1Uuids);
  }
}(this, function(ApiClient, RuntimeError, V1ArtifactTree, V1Auth, V1Dashboard, V1EntityNotificationBody, V1EntityStatusBodyRequest, V1EventsResponse, V1ListDashboardsResponse, V1ListRunArtifactsResponse, V1ListRunsResponse, V1Logs, V1OperationBody, V1ProjectEntityResourceRequest, V1Run, V1RunArtifact, V1RunArtifacts, V1RunSettings, V1Status, V1Uuids) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createRunDashboard operation.
     * @callback module:api/RunsV1Api~createRunDashboardCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} run Run under namesapce
     * @param {module:model/V1Dashboard} body Dashboard body
     * @param {module:api/RunsV1Api~createRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Dashboard}
     */
    this.createRunDashboard = function(owner, project, run, body, callback) {
      var postBody = body;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling createRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling createRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling createRunDashboard");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the deleteRunDashboard operation.
     * @callback module:api/RunsV1Api~deleteRunDashboardCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} uuid Uuid identifier of the entity
     * @param {module:api/RunsV1Api~deleteRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     */
    this.deleteRunDashboard = function(owner, project, run, uuid, callback) {
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling deleteRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling deleteRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling deleteRunDashboard");
      }

      // verify the required parameter 'uuid' is set
      if (uuid === undefined || uuid === null) {
        throw new Error("Missing the required parameter 'uuid' when calling deleteRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/{uuid}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the getRunDashboard operation.
     * @callback module:api/RunsV1Api~getRunDashboardCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Dashboard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} run Run
     * @param {String} uuid Uuid identifier of the entity
     * @param {module:api/RunsV1Api~getRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Dashboard}
     */
    this.getRunDashboard = function(owner, project, run, uuid, callback) {
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling getRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling getRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling getRunDashboard");
      }

      // verify the required parameter 'uuid' is set
      if (uuid === undefined || uuid === null) {
        throw new Error("Missing the required parameter 'uuid' when calling getRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/{uuid}', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listRunDashboardNames operation.
     * @callback module:api/RunsV1Api~listRunDashboardNamesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.sort Sort to order the search.
     * @param {String} opts.query Query filter the search search.
     * @param {module:api/RunsV1Api~listRunDashboardNamesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1ListDashboardsResponse}
     */
    this.listRunDashboardNames = function(owner, project, run, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling listRunDashboardNames");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling listRunDashboardNames");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling listRunDashboardNames");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/names', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listRunDashboards operation.
     * @callback module:api/RunsV1Api~listRunDashboardsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1ListDashboardsResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.sort Sort to order the search.
     * @param {String} opts.query Query filter the search search.
     * @param {module:api/RunsV1Api~listRunDashboardsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1ListDashboardsResponse}
     */
    this.listRunDashboards = function(owner, project, run, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling listRunDashboards");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling listRunDashboards");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling listRunDashboards");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards', 'GET',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the patchRunDashboard operation.
     * @callback module:api/RunsV1Api~patchRunDashboardCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Dashboard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/V1Dashboard} body Dashboard body
     * @param {module:api/RunsV1Api~patchRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Dashboard}
     */
    this.patchRunDashboard = function(owner, project, run, dashboard_uuid, body, callback) {
      var postBody = body;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling patchRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling patchRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling patchRunDashboard");
      }

      // verify the required parameter 'dashboard_uuid' is set
      if (dashboard_uuid === undefined || dashboard_uuid === null) {
        throw new Error("Missing the required parameter 'dashboard_uuid' when calling patchRunDashboard");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling patchRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}', 'PATCH',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the promoteRunDashboard operation.
     * @callback module:api/RunsV1Api~promoteRunDashboardCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Dashboard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} run Run under namesapce
     * @param {String} dashboard_uuid UUID
     * @param {module:api/RunsV1Api~promoteRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Dashboard}
     */
    this.promoteRunDashboard = function(owner, project, run, dashboard_uuid, callback) {
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling promoteRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling promoteRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling promoteRunDashboard");
      }

      // verify the required parameter 'dashboard_uuid' is set
      if (dashboard_uuid === undefined || dashboard_uuid === null) {
        throw new Error("Missing the required parameter 'dashboard_uuid' when calling promoteRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}/promote', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the updateRunDashboard operation.
     * @callback module:api/RunsV1Api~updateRunDashboardCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1Dashboard} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} dashboard_uuid UUID
     * @param {module:model/V1Dashboard} body Dashboard body
     * @param {module:api/RunsV1Api~updateRunDashboardCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1Dashboard}
     */
    this.updateRunDashboard = function(owner, project, run, dashboard_uuid, body, callback) {
      var postBody = body;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling updateRunDashboard");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling updateRunDashboard");
      }

      // verify the required parameter 'run' is set
      if (run === undefined || run === null) {
        throw new Error("Missing the required parameter 'run' when calling updateRunDashboard");
      }

      // verify the required parameter 'dashboard_uuid' is set
      if (dashboard_uuid === undefined || dashboard_uuid === null) {
        throw new Error("Missing the required parameter 'dashboard_uuid' when calling updateRunDashboard");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling updateRunDashboard");
      }
      ...
      return this.apiClient.callApi(
        '/api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}', 'PUT',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
