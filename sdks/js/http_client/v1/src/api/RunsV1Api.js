...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ArtifactTreeResponse', 'model/V1Auth', 'model/V1CodeReference', 'model/V1EntityStatusBodyRequest', 'model/V1ListCodeRefsResponse', 'model/V1ListRunsResponse', 'model/V1ProjectEntityResourceRequest', 'model/V1Run', 'model/V1Status', 'model/V1Uuids'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1ArtifactTreeResponse'), require('../model/V1Auth'), require('../model/V1CodeReference'), require('../model/V1EntityStatusBodyRequest'), require('../model/V1ListCodeRefsResponse'), require('../model/V1ListRunsResponse'), require('../model/V1ProjectEntityResourceRequest'), require('../model/V1Run'), require('../model/V1Status'), require('../model/V1Uuids'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.RunsV1Api = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1ArtifactTreeResponse, root.PolyaxonSdk.V1Auth, root.PolyaxonSdk.V1CodeReference, root.PolyaxonSdk.V1EntityStatusBodyRequest, root.PolyaxonSdk.V1ListCodeRefsResponse, root.PolyaxonSdk.V1ListRunsResponse, root.PolyaxonSdk.V1ProjectEntityResourceRequest, root.PolyaxonSdk.V1Run, root.PolyaxonSdk.V1Status, root.PolyaxonSdk.V1Uuids);
  }
}(this, function(ApiClient, V1ArtifactTreeResponse, V1Auth, V1CodeReference, V1EntityStatusBodyRequest, V1ListCodeRefsResponse, V1ListRunsResponse, V1ProjectEntityResourceRequest, V1Run, V1Status, V1Uuids) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getRunArtifactsTree = function(owner, project, uuid, opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getRunLogsFile operation.
     * @callback module:api/RunsV1Api~getRunLogsFileCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} opts.step Artifact logging step.
     * @param {String} opts.type Artifact type.
     * @param {module:api/RunsV1Api~getRunLogsFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link 'String'}
     */
    this.getRunLogsFile = function(owner, project, uuid, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling getRunLogsFile");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling getRunLogsFile");
      }

      // verify the required parameter 'uuid' is set
      if (uuid === undefined || uuid === null) {
        throw new Error("Missing the required parameter 'uuid' when calling getRunLogsFile");
      }
    ...
    /**
     * Callback function to receive the result of the getRunLogsTree operation.
     * @callback module:api/RunsV1Api~getRunLogsTreeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/V1ArtifactTreeResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/V1ArtifactTreeResponse}
     */
    this.getRunLogsTree = function(owner, project, uuid, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling getRunLogsTree");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling getRunLogsTree");
      }

      // verify the required parameter 'uuid' is set
      if (uuid === undefined || uuid === null) {
        throw new Error("Missing the required parameter 'uuid' when calling getRunLogsTree");
      }
