...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Auth', 'model/V1CodeReference', 'model/V1EntityStatusBodyRequest', 'model/V1ListCodeRefsResponse', 'model/V1ListRunsResponse', 'model/V1ProjectEntityResourceRequest', 'model/V1Run', 'model/V1Status', 'model/V1Uuids'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1Auth'), require('../model/V1CodeReference'), require('../model/V1EntityStatusBodyRequest'), require('../model/V1ListCodeRefsResponse'), require('../model/V1ListRunsResponse'), require('../model/V1ProjectEntityResourceRequest'), require('../model/V1Run'), require('../model/V1Status'), require('../model/V1Uuids'));
  } else {
...
}(this, function(ApiClient, V1Auth, V1CodeReference, V1EntityStatusBodyRequest, V1ListCodeRefsResponse, V1ListRunsResponse, V1ProjectEntityResourceRequest, V1Run, V1Status, V1Uuids) {
  'use strict';
