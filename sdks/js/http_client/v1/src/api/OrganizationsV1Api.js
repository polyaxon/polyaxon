...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ListOrganizationMembersResponse', 'model/V1ListOrganizationsResponse', 'model/V1Organization', 'model/V1OrganizationMember'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1ListOrganizationMembersResponse'), require('../model/V1ListOrganizationsResponse'), require('../model/V1Organization'), require('../model/V1OrganizationMember'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.OrganizationsV1Api = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1ListOrganizationMembersResponse, root.PolyaxonSdk.V1ListOrganizationsResponse, root.PolyaxonSdk.V1Organization, root.PolyaxonSdk.V1OrganizationMember);
  }
}(this, function(ApiClient, V1ListOrganizationMembersResponse, V1ListOrganizationsResponse, V1Organization, V1OrganizationMember) {
  'use strict';
