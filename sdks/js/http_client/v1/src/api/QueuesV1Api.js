...
export default class QueuesV1Api {
    ...
    */
     ...
     */
    deleteQueue(owner, agent, uuid, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/V1Queue}
     */
    getQueue(owner, agent, uuid, callback) {
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/V1ListQueuesResponse}
     */
    listQueueNames(owner, agent, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/V1ListQueuesResponse}
     */
    listQueues(owner, agent, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/V1Queue}
     */
    patchQueue(owner, queue_agent, queue_uuid, body, callback) {
      let postBody = body;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
     ...
     * data is of type: {@link module:model/V1Queue}
     */
    updateQueue(owner, queue_agent, queue_uuid, body, callback) {
      let postBody = body;
      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
