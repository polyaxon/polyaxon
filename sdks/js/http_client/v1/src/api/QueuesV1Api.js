...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Agent', 'model/V1ListQueuesResponse', 'model/V1Queue'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1Agent'), require('../model/V1ListQueuesResponse'), require('../model/V1Queue'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.QueuesV1Api = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1Agent, root.PolyaxonSdk.V1ListQueuesResponse, root.PolyaxonSdk.V1Queue);
  }
}(this, function(ApiClient, V1Agent, V1ListQueuesResponse, V1Queue) {
  'use strict';
