...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EventChartKind'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EventChartKind'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.V1EventChart = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.EventChartKind);
  }
}(this, function(ApiClient, EventChartKind) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('kind'))
        obj.kind = EventChartKind.constructFromObject(data['kind']);
  ...
  /**
   * @member {module:model/EventChartKind} kind
   */
