...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PolyaxonSdk.V1Connection = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1ConnectionKind);
  }
}(this, function(ApiClient, V1ConnectionKind) {
  'use strict';

  /**
   * The V1Connection model module.
   * @module model/V1Connection
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>V1Connection</code>.
   * @alias module:model/V1Connection
   * @class
   */
  ...
  /**
   * Constructs a <code>V1Connection</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V1Connection} obj Optional instance to populate.
   * @return {module:model/V1Connection} The populated <code>V1Connection</code> instance.
   */
