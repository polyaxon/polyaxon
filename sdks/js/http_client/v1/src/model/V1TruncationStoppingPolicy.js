...
class V1TruncationStoppingPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('include_succeeded')) {
                obj['include_succeeded'] = ApiClient.convertToType(data['include_succeeded'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 */
V1TruncationStoppingPolicy.prototype['evaluation_interval'] = undefined;

/**
 * @member {Number} min_interval
 */
V1TruncationStoppingPolicy.prototype['min_interval'] = undefined;

/**
 * @member {Number} min_samples
 */
V1TruncationStoppingPolicy.prototype['min_samples'] = undefined;

/**
 * @member {Boolean} include_succeeded
 */
V1TruncationStoppingPolicy.prototype['include_succeeded'] = undefined;
