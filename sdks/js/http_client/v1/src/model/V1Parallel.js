 ...
 */
V1Parallel.prototype['random'] = undefined;

/**
 * @member {module:model/V1GridSearch} grid
 */
V1Parallel.prototype['grid'] = undefined;

/**
 * @member {module:model/V1Hyperband} hyperband
 */
V1Parallel.prototype['hyperband'] = undefined;

/**
 * @member {module:model/V1Bayes} bayes
 */
V1Parallel.prototype['bayes'] = undefined;

/**
 * @member {module:model/V1Hyperopt} hyperopt
 */
V1Parallel.prototype['hyperopt'] = undefined;

/**
 * @member {module:model/V1Iterative} iterative
 */
V1Parallel.prototype['iterative'] = undefined;

/**
 * @member {module:model/V1Mapping} mapping
 */
V1Parallel.prototype['mapping'] = undefined;
