...
class V1CredsBodyRequest {
    ...
    constructor() { 
        ...
        V1CredsBodyRequest.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1CredsBodyRequest();
 ...
 */
V1CredsBodyRequest.prototype['username'] = undefined;

/**
 * @member {String} password
 */
V1CredsBodyRequest.prototype['password'] = undefined;
...
export default V1CredsBodyRequest;
