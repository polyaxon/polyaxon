...
import V1NotificationTrigger from './V1NotificationTrigger';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('trigger')) {
                obj['trigger'] = V1NotificationTrigger.constructFromObject(data['trigger']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/V1NotificationTrigger} trigger
 */
