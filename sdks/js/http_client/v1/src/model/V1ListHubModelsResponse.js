...
import V1HubModel from './V1HubModel';
...
class V1ListHubModelsResponse {
    ...
    constructor() { 
        ...
        V1ListHubModelsResponse.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1ListHubModelsResponse();
 ...
 * @member {Number} count
 */
V1ListHubModelsResponse.prototype['count'] = undefined;

/**
 * @member {Array.<module:model/V1HubModel>} results
 */
V1ListHubModelsResponse.prototype['results'] = undefined;

/**
 * @member {String} previous
 */
V1ListHubModelsResponse.prototype['previous'] = undefined;

/**
 * @member {String} next
 */
V1ListHubModelsResponse.prototype['next'] = undefined;
...
export default V1ListHubModelsResponse;
