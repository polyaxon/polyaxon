...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PolyaxonSdk.V1ArtifactsStore = factory(root.PolyaxonSdk.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The V1ArtifactsStore model module.
   * @module model/V1ArtifactsStore
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>V1ArtifactsStore</code>.
   * @alias module:model/V1ArtifactsStore
   * @class
   */
  ...
  /**
   * Constructs a <code>V1ArtifactsStore</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V1ArtifactsStore} obj Optional instance to populate.
   * @return {module:model/V1ArtifactsStore} The populated <code>V1ArtifactsStore</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('host_path'))
        obj.host_path = ApiClient.convertToType(data['host_path'], 'String');
   ...
   */
  exports.prototype.host_path = undefined;
