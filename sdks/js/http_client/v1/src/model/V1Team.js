    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hubs')) {
                obj['hubs'] = ApiClient.convertToType(data['hubs'], ['String']);
            }
            if (data.hasOwnProperty('registries')) {
                obj['registries'] = ApiClient.convertToType(data['registries'], ['String']);
            }
...
/**
 * @member {Array.<String>} hubs
 */
V1Team.prototype['hubs'] = undefined;

/**
 * @member {Array.<String>} registries
 */
V1Team.prototype['registries'] = undefined;
