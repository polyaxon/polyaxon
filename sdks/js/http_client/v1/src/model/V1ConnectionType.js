...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ConnectionKind', 'model/V1K8sResourceSchema'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1ConnectionKind'), require('./V1K8sResourceSchema'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.V1ConnectionType = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1ConnectionKind, root.PolyaxonSdk.V1K8sResourceSchema);
  }
}(this, function(ApiClient, V1ConnectionKind, V1K8sResourceSchema) {
  'use strict';
   ...
   */
  exports.prototype.config_map = undefined;
