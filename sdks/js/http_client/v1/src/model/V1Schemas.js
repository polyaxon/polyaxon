...
class V1Schemas {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('schedule_kind')) {
                obj['schedule_kind'] = V1ScheduleKind.constructFromObject(data['schedule_kind']);
            }
...
/**
 * @member {module:model/V1ScheduleKind} schedule_kind
 */
V1Schemas.prototype['schedule_kind'] = undefined;
