    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('parallel_kind')) {
                obj['parallel_kind'] = V1ParallelKind.constructFromObject(data['parallel_kind']);
            }
        }
        return obj;
    }
 ...
 */
V1Schemas.prototype['parallel'] = undefined;
...
/**
 * @member {module:model/V1ParallelKind} parallel_kind
 */
V1Schemas.prototype['parallel_kind'] = undefined;
