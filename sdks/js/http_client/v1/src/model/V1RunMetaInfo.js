...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('workflow_strategy'))
        obj.workflow_strategy = ApiClient.convertToType(data['workflow_strategy'], 'String');
      if (data.hasOwnProperty('workflow_concurrency'))
        obj.workflow_concurrency = ApiClient.convertToType(data['workflow_concurrency'], 'Number');
    }
    return obj;
  }
  ...
  /**
   * @member {String} workflow_strategy
   */
  exports.prototype.workflow_strategy = undefined;

  /**
   * @member {Number} workflow_concurrency
   */
  exports.prototype.workflow_concurrency = undefined;
