...
(function(root, factory) {
  ...
  /**
   * The V1ConfigResource model module.
   * @module model/V1ConfigResource
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>V1ConfigResource</code>.
   * @alias module:model/V1ConfigResource
   * @class
   */
  ...
  /**
   * Constructs a <code>V1ConfigResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V1ConfigResource} obj Optional instance to populate.
   * @return {module:model/V1ConfigResource} The populated <code>V1ConfigResource</code> instance.
   */
