...
class V1Versions {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('platform_dist')) {
                obj['platform_dist'] = ApiClient.convertToType(data['platform_dist'], 'String');
            }
...
/**
 * @member {String} platform_dist
 */
V1Versions.prototype['platform_dist'] = undefined;
