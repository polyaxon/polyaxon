...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1ConnectionResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1ConnectionResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.V1ListConnectionsResponse = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1ConnectionResponse);
  }
}(this, function(ApiClient, V1ConnectionResponse) {
  'use strict';
