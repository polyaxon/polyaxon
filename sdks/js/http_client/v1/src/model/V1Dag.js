...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Component', 'model/V1Op'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V1Component'), require('./V1Op'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.V1Dag = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1Component, root.PolyaxonSdk.V1Op);
  }
}(this, function(ApiClient, V1Component, V1Op) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ops'))
        obj.ops = ApiClient.convertToType(data['ops'], [V1Op]);
  ...
  /**
   * @member {Array.<module:model/V1Op>} ops
   */
