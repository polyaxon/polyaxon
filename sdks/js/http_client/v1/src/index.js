...
}(function(ApiClient, V1ArtifactsStore, V1Auth, V1CodeReference, V1CredsBodyRequest, V1EntityStatusBodyRequest, V1HostAccess, V1K8SResource, V1ListArtifactsStoresResponse, V1ListCodeRefsResponse, V1ListHostAccessesResponse, V1ListK8SResourcesResponse, V1ListProjectsResponse, V1ListRunsResponse, V1ListSearchesResponse, V1LogHandler, V1Project, V1ProjectEntityResourceRequest, V1Run, V1RunMetaInfo, V1Search, V1SearchDefinition, V1Status, V1StatusCondition, V1User, V1Uuids, V1Version, V1Versions, ArtifactsStoresV1Api, AuthV1Api, GitAccessesV1Api, K8SConfigMapsV1Api, K8SSecretsV1Api, ProjectsV1Api, RegsitryAccessesV1Api, RunsV1Api, SearchV1Api, UsersV1Api, VersionsV1Api) {
  'use strict';
