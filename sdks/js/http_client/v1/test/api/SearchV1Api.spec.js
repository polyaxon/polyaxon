...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.SearchV1Api();
  });
    ...
    describe('SearchV1Api', function() {
      ...
      describe('deleteSearch', function() {
        it('should call deleteSearch successfully', function(done) {
          ...
          instance.deleteSearch(owner, project, uuid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getSearch', function() {
        it('should call getSearch successfully', function(done) {
          ...
          instance.getSearch(owner, project, uuid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('listSearches', function() {
        it('should call listSearches successfully', function(done) {
          ...
          instance.listSearches(owner, project, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
