    ...
    describe('RunsV1Api', function() {
      ...
      describe('bookmarkRuns', function() {
        it('should call bookmarkRuns successfully', function(done) {
          // TODO: uncomment, update parameter values for bookmarkRuns call
          /*
          var owner = "owner_example";
          var project = "project_example";
          ...
          instance.bookmarkRuns(owner, project, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getRunsArtifactsLineage', function() {
        it('should call getRunsArtifactsLineage successfully', function(done) {
          // TODO: uncomment, update parameter values for getRunsArtifactsLineage call and complete the assertions
          /*
          var owner = "owner_example";
          var project = "project_example";
          var opts = {};
          ...
          instance.getRunsArtifactsLineage(owner, project, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('tagRuns', function() {
        it('should call tagRuns successfully', function(done) {
          // TODO: uncomment, update parameter values for tagRuns call
          /*
          var owner = "owner_example";
          var project = "project_example";
          var body = new PolyaxonSdk.V1EntitiesTags();
          body.uuids = [""];
          body.tags = [""];

          instance.tagRuns(owner, project, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
