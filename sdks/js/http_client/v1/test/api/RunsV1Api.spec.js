    ...
    describe('RunsV1Api', function() {
      ...
      describe('copyRun', function() {
        it('should call copyRun successfully', function(done) {
          ...
          body.meta_info.workflow_strategy = "";
          body.meta_info.workflow_concurrency = 0;
          body.readme = "";
          ...
          instance.copyRun(entity_owner, entity_project, entity_uuid, body, function(error, data, response) {
            ...
            expect(data.meta_info).to.be.a(PolyaxonSdk.V1RunMetaInfo);
              ...
              expect(data.meta_info.workflow_strategy).to.be.a('string');
              expect(data.meta_info.workflow_strategy).to.be("");
              expect(data.meta_info.workflow_concurrency).to.be.a('number');
              expect(data.meta_info.workflow_concurrency).to.be(0);
