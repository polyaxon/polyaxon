...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ArtifactFormat', function() {
      beforeEach(function() {
        instance = PolyaxonSdk.V1ArtifactFormat;
      });

      it('should create an instance of V1ArtifactFormat', function() {
        // TODO: update the code to test V1ArtifactFormat
