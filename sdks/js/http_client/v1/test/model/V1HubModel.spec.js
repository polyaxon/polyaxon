...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1HubModel();
  });
  ...
  describe('V1HubModel', function() {
    it('should create an instance of V1HubModel', function() {
      // uncomment below and update the code to test V1HubModel
      //var instane = new PolyaxonSdk.V1HubModel();
      //expect(instance).to.be.a(PolyaxonSdk.V1HubModel);
    });
