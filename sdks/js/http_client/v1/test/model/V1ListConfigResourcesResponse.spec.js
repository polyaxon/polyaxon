...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ListConfigResourcesResponse', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ListConfigResourcesResponse();
      });

      it('should create an instance of V1ListConfigResourcesResponse', function() {
        // TODO: update the code to test V1ListConfigResourcesResponse
        expect(instance).to.be.a(PolyaxonSdk.V1ListConfigResourcesResponse);
      });
