...
(function(root, factory) {
  ...
  describe('V1K8sResourceSchema', function() {
    it('should create an instance of V1K8sResourceSchema', function() {
      ...
      //var instane = new PolyaxonSdk.V1K8sResourceSchema();
    ...
    it('should have the property default_mode (base name: "default_mode")', function() {
      // uncomment below and update the code to test the property default_mode
      //var instane = new PolyaxonSdk.V1K8sResourceSchema();
      //expect(instance).to.be();
    });
