...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1HubComponent();
  });
  ...
  describe('V1HubComponent', function() {
    it('should create an instance of V1HubComponent', function() {
      // uncomment below and update the code to test V1HubComponent
      //var instane = new PolyaxonSdk.V1HubComponent();
      //expect(instance).to.be.a(PolyaxonSdk.V1HubComponent);
    });
