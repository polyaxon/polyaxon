...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ParallelAllSchemas', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ParallelAllSchemas();
      });

      it('should create an instance of V1ParallelAllSchemas', function() {
        // TODO: update the code to test V1ParallelAllSchemas
        expect(instance).to.be.a(PolyaxonSdk.V1ParallelAllSchemas);
      });
      ...
      it('should have the property bo (base name: "bo")', function() {
        // TODO: update the code to test the property bo
        expect(instance).to.have.property('bo');
        // expect(instance.bo).to.be(expectedValueLiteral);
      });
