...
(function(root, factory) {
  ...
  describe('V1RunSchema', function() {
    ...
    it('should have the property tf_job (base name: "tf_job")', function() {
      // uncomment below and update the code to test the property tf_job
      //var instane = new PolyaxonSdk.V1RunSchema();
      //expect(instance).to.be();
    });

    it('should have the property pytorch_job (base name: "pytorch_job")', function() {
      // uncomment below and update the code to test the property pytorch_job
      //var instane = new PolyaxonSdk.V1RunSchema();
      //expect(instance).to.be();
    });

    it('should have the property mpi_job (base name: "mpi_job")', function() {
      // uncomment below and update the code to test the property mpi_job
      //var instane = new PolyaxonSdk.V1RunSchema();
      //expect(instance).to.be();
    });
