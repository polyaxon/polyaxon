...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1HostAccess', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1HostAccess();
      });

      it('should create an instance of V1HostAccess', function() {
        // TODO: update the code to test V1HostAccess
        expect(instance).to.be.a(PolyaxonSdk.V1HostAccess);
      });
      ...
      it('should have the property insecure (base name: "insecure")', function() {
        // TODO: update the code to test the property insecure
        expect(instance).to.have.property('insecure');
        // expect(instance.insecure).to.be(expectedValueLiteral);
      });
