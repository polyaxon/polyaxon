...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ComponentRef', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ComponentRef();
      });

      it('should create an instance of V1ComponentRef', function() {
        // TODO: update the code to test V1ComponentRef
        expect(instance).to.be.a(PolyaxonSdk.V1ComponentRef);
      });
