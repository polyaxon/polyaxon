...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1EarlyStoppingAllSchemas', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1EarlyStoppingAllSchemas();
      });

      it('should create an instance of V1EarlyStoppingAllSchemas', function() {
        // TODO: update the code to test V1EarlyStoppingAllSchemas
        expect(instance).to.be.a(PolyaxonSdk.V1EarlyStoppingAllSchemas);
      });
