...
(function(root, factory) {
  ...
  describe('V1TruncationStoppingPolicy', function() {
    ...
    it('should have the property min_interval (base name: "min_interval")', function() {
      // uncomment below and update the code to test the property min_interval
      //var instane = new PolyaxonSdk.V1TruncationStoppingPolicy();
      //expect(instance).to.be();
    });

    it('should have the property min_samples (base name: "min_samples")', function() {
      // uncomment below and update the code to test the property min_samples
      //var instane = new PolyaxonSdk.V1TruncationStoppingPolicy();
      //expect(instance).to.be();
    });

    it('should have the property include_succeeded (base name: "include_succeeded")', function() {
      // uncomment below and update the code to test the property include_succeeded
      //var instane = new PolyaxonSdk.V1TruncationStoppingPolicy();
      //expect(instance).to.be();
    });
