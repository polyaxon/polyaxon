  ...
  describe('(package)', function() {
    describe('V1TruncationStoppingPolicy', function() {
      ...
      it('should create an instance of V1TruncationStoppingPolicy', function() {
        // TODO: update the code to test V1TruncationStoppingPolicy
      ...
      it('should have the property include_succeeded (base name: "include_succeeded")', function() {
        // TODO: update the code to test the property include_succeeded
        expect(instance).to.have.property('include_succeeded');
        // expect(instance.include_succeeded).to.be(expectedValueLiteral);
      });
