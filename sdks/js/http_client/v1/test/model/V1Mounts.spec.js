...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1Mounts', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1Mounts();
      });

      it('should create an instance of V1Mounts', function() {
        // TODO: update the code to test V1Mounts
        expect(instance).to.be.a(PolyaxonSdk.V1Mounts);
      });
      ...
      it('should have the property config_maps (base name: "config_maps")', function() {
        // TODO: update the code to test the property config_maps
        expect(instance).to.have.property('config_maps');
        // expect(instance.config_maps).to.be(expectedValueLiteral);
      });
