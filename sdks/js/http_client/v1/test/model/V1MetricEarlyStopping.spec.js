  ...
  describe('(package)', function() {
    describe('V1MetricEarlyStopping', function() {
      ...
      it('should create an instance of V1MetricEarlyStopping', function() {
        // TODO: update the code to test V1MetricEarlyStopping
      ...
      it('should have the property optimization (base name: "optimization")', function() {
        // TODO: update the code to test the property optimization
        expect(instance).to.have.property('optimization');
        // expect(instance.optimization).to.be(expectedValueLiteral);
      });
