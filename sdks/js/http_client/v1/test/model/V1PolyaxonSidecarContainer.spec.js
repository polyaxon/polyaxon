...
(function(root, factory) {
  ...
  describe('V1PolyaxonSidecarContainer', function() {
    ...
    it('should have the property sleep_interval (base name: "sleep_interval")', function() {
      // uncomment below and update the code to test the property sleep_interval
      //var instane = new PolyaxonSdk.V1PolyaxonSidecarContainer();
      //expect(instance).to.be();
    });

    it('should have the property sync_interval (base name: "sync_interval")', function() {
      // uncomment below and update the code to test the property sync_interval
      //var instane = new PolyaxonSdk.V1PolyaxonSidecarContainer();
      //expect(instance).to.be();
    });

    it('should have the property monitor_logs (base name: "monitor_logs")', function() {
      // uncomment below and update the code to test the property monitor_logs
      //var instane = new PolyaxonSdk.V1PolyaxonSidecarContainer();
      //expect(instance).to.be();
    });
