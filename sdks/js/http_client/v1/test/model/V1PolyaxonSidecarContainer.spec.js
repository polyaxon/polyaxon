  ...
  describe('(package)', function() {
    describe('V1PolyaxonSidecarContainer', function() {
      ...
      it('should create an instance of V1PolyaxonSidecarContainer', function() {
        // TODO: update the code to test V1PolyaxonSidecarContainer
      ...
      it('should have the property sync_interval (base name: "sync_interval")', function() {
        // TODO: update the code to test the property sync_interval
        expect(instance).to.have.property('sync_interval');
        // expect(instance.sync_interval).to.be(expectedValueLiteral);
      });
