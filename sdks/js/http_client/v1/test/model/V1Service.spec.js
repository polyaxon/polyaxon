  ...
  describe('(package)', function() {
    describe('V1Service', function() {
      ...
      it('should create an instance of V1Service', function() {
        // TODO: update the code to test V1Service
      ...
      it('should have the property rewritePath (base name: "rewritePath")', function() {
        // TODO: update the code to test the property rewritePath
        expect(instance).to.have.property('rewritePath');
        // expect(instance.rewritePath).to.be(expectedValueLiteral);
      });
