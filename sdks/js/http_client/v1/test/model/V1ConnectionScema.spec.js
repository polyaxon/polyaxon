...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ConnectionScema', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ConnectionScema();
      });

      it('should create an instance of V1ConnectionScema', function() {
        // TODO: update the code to test V1ConnectionScema
        expect(instance).to.be.a(PolyaxonSdk.V1ConnectionScema);
      });

      it('should have the property blob_connection (base name: "blob_connection")', function() {
        // TODO: update the code to test the property blob_connection
        expect(instance).to.have.property('blob_connection');
        // expect(instance.blob_connection).to.be(expectedValueLiteral);
      });
