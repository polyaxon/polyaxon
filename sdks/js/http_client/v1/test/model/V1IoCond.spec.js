...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1IoCond();
  });
  ...
  describe('V1IoCond', function() {
    it('should create an instance of V1IoCond', function() {
      // uncomment below and update the code to test V1IoCond
      //var instane = new PolyaxonSdk.V1IoCond();
      //expect(instance).to.be.a(PolyaxonSdk.V1IoCond);
    });
