  ...
  describe('(package)', function() {
    describe('V1IntervalSchedule', function() {
      ...
      it('should create an instance of V1IntervalSchedule', function() {
        // TODO: update the code to test V1IntervalSchedule
      ...
      it('should have the property end_at (base name: "end_at")', function() {
        // TODO: update the code to test the property end_at
        expect(instance).to.have.property('end_at');
        // expect(instance.end_at).to.be(expectedValueLiteral);
      });
