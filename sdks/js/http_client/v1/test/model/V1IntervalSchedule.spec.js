...
(function(root, factory) {
  ...
  describe('V1IntervalSchedule', function() {
    it('should create an instance of V1IntervalSchedule', function() {
      ...
      //var instane = new PolyaxonSdk.V1IntervalSchedule();
    ...
    it('should have the property start_at (base name: "start_at")', function() {
      // uncomment below and update the code to test the property start_at
      //var instane = new PolyaxonSdk.V1IntervalSchedule();
      //expect(instance).to.be();
    });

    it('should have the property end_at (base name: "end_at")', function() {
      // uncomment below and update the code to test the property end_at
      //var instane = new PolyaxonSdk.V1IntervalSchedule();
      //expect(instance).to.be();
    });

    it('should have the property max_runs (base name: "max_runs")', function() {
      // uncomment below and update the code to test the property max_runs
      //var instane = new PolyaxonSdk.V1IntervalSchedule();
      //expect(instance).to.be();
    });
    ...
    it('should have the property depends_on_past (base name: "depends_on_past")', function() {
      // uncomment below and update the code to test the property depends_on_past
      //var instane = new PolyaxonSdk.V1IntervalSchedule();
      //expect(instance).to.be();
    });
