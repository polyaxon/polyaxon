...
(function(root, factory) {
  ...
  describe('V1Operation', function() {
    ...
    it('should have the property patch_strategy (base name: "patch_strategy")', function() {
      // uncomment below and update the code to test the property patch_strategy
      //var instane = new PolyaxonSdk.V1Operation();
      //expect(instance).to.be();
    });

    it('should have the property is_preset (base name: "is_preset")', function() {
      // uncomment below and update the code to test the property is_preset
      //var instane = new PolyaxonSdk.V1Operation();
      //expect(instance).to.be();
    });
    ...
    it('should have the property dag_ref (base name: "dag_ref")', function() {
      // uncomment below and update the code to test the property dag_ref
      //var instane = new PolyaxonSdk.V1Operation();
      //expect(instance).to.be();
    });

    it('should have the property url_ref (base name: "url_ref")', function() {
      // uncomment below and update the code to test the property url_ref
      //var instane = new PolyaxonSdk.V1Operation();
      //expect(instance).to.be();
    });

    it('should have the property path_ref (base name: "path_ref")', function() {
      // uncomment below and update the code to test the property path_ref
      //var instane = new PolyaxonSdk.V1Operation();
      //expect(instance).to.be();
    });
