...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1RepoInit', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1RepoInit();
      });

      it('should create an instance of V1RepoInit', function() {
        // TODO: update the code to test V1RepoInit
        expect(instance).to.be.a(PolyaxonSdk.V1RepoInit);
      });
