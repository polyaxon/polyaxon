...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1SearchDefinition', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1SearchDefinition();
      });

      it('should create an instance of V1SearchDefinition', function() {
        // TODO: update the code to test V1SearchDefinition
        expect(instance).to.be.a(PolyaxonSdk.V1SearchDefinition);
      });
