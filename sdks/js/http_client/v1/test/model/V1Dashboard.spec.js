  ...
  describe('(package)', function() {
    describe('V1Dashboard', function() {
      ...
      it('should create an instance of V1Dashboard', function() {
        // TODO: update the code to test V1Dashboard
      ...
      it('should have the property run_view (base name: "run_view")', function() {
        // TODO: update the code to test the property run_view
        expect(instance).to.have.property('run_view');
