...
(function(root, factory) {
  ...
  describe('V1Versions', function() {
    it('should create an instance of V1Versions', function() {
      ...
      //var instane = new PolyaxonSdk.V1Versions();
    ...
    it('should have the property platform_version (base name: "platform_version")', function() {
      // uncomment below and update the code to test the property platform_version
      //var instane = new PolyaxonSdk.V1Versions();
      //expect(instance).to.be();
    });

    it('should have the property platform_dist (base name: "platform_dist")', function() {
      // uncomment below and update the code to test the property platform_dist
      //var instane = new PolyaxonSdk.V1Versions();
      //expect(instance).to.be();
    });
