  ...
  describe('(package)', function() {
    describe('V1Versions', function() {
      ...
      it('should create an instance of V1Versions', function() {
        // TODO: update the code to test V1Versions
      ...
      it('should have the property cli (base name: "cli")', function() {
        // TODO: update the code to test the property cli
        expect(instance).to.have.property('cli');
        // expect(instance.cli).to.be(expectedValueLiteral);
      });
