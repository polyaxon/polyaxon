...
(function(root, factory) {
  ...
  describe('V1Dask', function() {
    ...
    it('should have the property adapt_min (base name: "adapt_min")', function() {
      // uncomment below and update the code to test the property adapt_min
      //var instane = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });

    it('should have the property adapt_max (base name: "adapt_max")', function() {
      // uncomment below and update the code to test the property adapt_max
      //var instane = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });

    it('should have the property adapt_interval (base name: "adapt_interval")', function() {
      // uncomment below and update the code to test the property adapt_interval
      //var instane = new PolyaxonSdk.V1Dask();
      //expect(instance).to.be();
    });
