  ...
  describe('(package)', function() {
    describe('V1Dask', function() {
      ...
      it('should create an instance of V1Dask', function() {
        // TODO: update the code to test V1Dask
      ...
      it('should have the property adapt_min (base name: "adapt_min")', function() {
        // TODO: update the code to test the property adapt_min
        expect(instance).to.have.property('adapt_min');
        // expect(instance.adapt_min).to.be(expectedValueLiteral);
      });

      it('should have the property adapt_max (base name: "adapt_max")', function() {
        // TODO: update the code to test the property adapt_max
        expect(instance).to.have.property('adapt_max');
        // expect(instance.adapt_max).to.be(expectedValueLiteral);
      });

      it('should have the property adapt_interval (base name: "adapt_interval")', function() {
        // TODO: update the code to test the property adapt_interval
        expect(instance).to.have.property('adapt_interval');
        // expect(instance.adapt_interval).to.be(expectedValueLiteral);
      });
