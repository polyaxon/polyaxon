...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1K8sMount', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1K8sMount();
      });

      it('should create an instance of V1K8sMount', function() {
        // TODO: update the code to test V1K8sMount
        expect(instance).to.be.a(PolyaxonSdk.V1K8sMount);
      });
