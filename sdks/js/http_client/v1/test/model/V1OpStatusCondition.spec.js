...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1OpStatusCondition', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1OpStatusCondition();
      });

      it('should create an instance of V1OpStatusCondition', function() {
        // TODO: update the code to test V1OpStatusCondition
        expect(instance).to.be.a(PolyaxonSdk.V1OpStatusCondition);
      });
