...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ConnectionKind', function() {
      ...
      it('should have the property gcpcloudsql', function() {
        expect(instance).to.have.property('gcpcloudsql');
        expect(instance.gcpcloudsql).to.be("gcpcloudsql");
      });
      ...
      it('should have the property emr', function() {
        expect(instance).to.have.property('emr');
        expect(instance.emr).to.be("emr");
      });
      ...
      it('should have the property azure_data_lake', function() {
        expect(instance).to.have.property('azure_data_lake');
        expect(instance.azure_data_lake).to.be("azure_data_lake");
      });

      it('should have the property azure_cosmos', function() {
        expect(instance).to.have.property('azure_cosmos');
        expect(instance.azure_cosmos).to.be("azure_cosmos");
      });
