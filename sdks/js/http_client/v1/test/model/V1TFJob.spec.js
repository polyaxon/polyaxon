  ...
  describe('(package)', function() {
    describe('V1TFJob', function() {
      ...
      it('should create an instance of V1TFJob', function() {
        // TODO: update the code to test V1TFJob
      ...
      it('should have the property chief (base name: "chief")', function() {
        // TODO: update the code to test the property chief
        expect(instance).to.have.property('chief');
        // expect(instance.chief).to.be(expectedValueLiteral);
      });

      it('should have the property ps (base name: "ps")', function() {
        // TODO: update the code to test the property ps
        expect(instance).to.have.property('ps');
        // expect(instance.ps).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property evaluator (base name: "evaluator")', function() {
        // TODO: update the code to test the property evaluator
        expect(instance).to.have.property('evaluator');
        // expect(instance.evaluator).to.be(expectedValueLiteral);
      });
