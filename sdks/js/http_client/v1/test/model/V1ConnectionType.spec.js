  ...
  describe('(package)', function() {
    describe('V1ConnectionType', function() {
      ...
      it('should create an instance of V1ConnectionType', function() {
        // TODO: update the code to test V1ConnectionType
      ...
      it('should have the property config_map (base name: "config_map")', function() {
        // TODO: update the code to test the property config_map
        expect(instance).to.have.property('config_map');
        // expect(instance.config_map).to.be(expectedValueLiteral);
      });
