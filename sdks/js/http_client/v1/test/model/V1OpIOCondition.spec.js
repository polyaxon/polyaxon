...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1OpIOCondition', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1OpIOCondition();
      });

      it('should create an instance of V1OpIOCondition', function() {
        // TODO: update the code to test V1OpIOCondition
        expect(instance).to.be.a(PolyaxonSdk.V1OpIOCondition);
      });
