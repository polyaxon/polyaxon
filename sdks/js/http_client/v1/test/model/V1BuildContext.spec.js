...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1BuildContext', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1BuildContext();
      });

      it('should create an instance of V1BuildContext', function() {
        // TODO: update the code to test V1BuildContext
        expect(instance).to.be.a(PolyaxonSdk.V1BuildContext);
      });
