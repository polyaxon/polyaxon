...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1Connection', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1Connection();
      });

      it('should create an instance of V1Connection', function() {
        // TODO: update the code to test V1Connection
        expect(instance).to.be.a(PolyaxonSdk.V1Connection);
      });
