...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ConfigResourceSchema', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ConfigResourceSchema();
      });

      it('should create an instance of V1ConfigResourceSchema', function() {
        // TODO: update the code to test V1ConfigResourceSchema
        expect(instance).to.be.a(PolyaxonSdk.V1ConfigResourceSchema);
      });
