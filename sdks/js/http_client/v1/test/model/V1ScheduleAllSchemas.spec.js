...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ScheduleAllSchemas', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ScheduleAllSchemas();
      });

      it('should create an instance of V1ScheduleAllSchemas', function() {
        // TODO: update the code to test V1ScheduleAllSchemas
        expect(instance).to.be.a(PolyaxonSdk.V1ScheduleAllSchemas);
      });
