  ...
  describe('(package)', function() {
    describe('V1Bayes', function() {
      ...
      it('should create an instance of V1Bayes', function() {
        // TODO: update the code to test V1Bayes
      ...
      it('should have the property num_initial_runs (base name: "num_initial_runs")', function() {
        // TODO: update the code to test the property num_initial_runs
        expect(instance).to.have.property('num_initial_runs');
        // expect(instance.num_initial_runs).to.be(expectedValueLiteral);
      });

      it('should have the property num_iterations (base name: "num_iterations")', function() {
        // TODO: update the code to test the property num_iterations
        expect(instance).to.have.property('num_iterations');
        // expect(instance.num_iterations).to.be(expectedValueLiteral);
      });
