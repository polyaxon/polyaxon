...
(function(root, factory) {
  ...
  describe('V1Bayes', function() {
    it('should create an instance of V1Bayes', function() {
      ...
      //var instane = new PolyaxonSdk.V1Bayes();
    ...
    it('should have the property num_initial_runs (base name: "num_initial_runs")', function() {
      // uncomment below and update the code to test the property num_initial_runs
      //var instane = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be();
    });

    it('should have the property num_iterations (base name: "num_iterations")', function() {
      // uncomment below and update the code to test the property num_iterations
      //var instane = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be();
    });

    it('should have the property utility_function (base name: "utility_function")', function() {
      // uncomment below and update the code to test the property utility_function
      //var instane = new PolyaxonSdk.V1Bayes();
      //expect(instance).to.be();
    });
