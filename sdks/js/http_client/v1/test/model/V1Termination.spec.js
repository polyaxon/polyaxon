  ...
  describe('(package)', function() {
    describe('V1Termination', function() {
      ...
      it('should create an instance of V1Termination', function() {
        // TODO: update the code to test V1Termination
        expect(instance).to.be.a(PolyaxonSdk.V1Termination);
      });

      it('should have the property max_retries (base name: "max_retries")', function() {
        // TODO: update the code to test the property max_retries
        expect(instance).to.have.property('max_retries');
        // expect(instance.max_retries).to.be(expectedValueLiteral);
      });
