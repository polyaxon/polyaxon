...
(function(root, factory) {
  ...
  describe('V1JoinParam', function() {
    it('should create an instance of V1JoinParam', function() {
      ...
      //var instane = new PolyaxonSdk.V1JoinParam();
    ...
    it('should have the property context_only (base name: "context_only")', function() {
      // uncomment below and update the code to test the property context_only
      //var instane = new PolyaxonSdk.V1JoinParam();
      //expect(instance).to.be();
    });
