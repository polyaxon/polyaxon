  ...
  describe('(package)', function() {
    describe('V1StatusCondition', function() {
      ...
      it('should create an instance of V1StatusCondition', function() {
        // TODO: update the code to test V1StatusCondition
      ...
      it('should have the property last_update_time (base name: "last_update_time")', function() {
        // TODO: update the code to test the property last_update_time
        expect(instance).to.have.property('last_update_time');
        // expect(instance.last_update_time).to.be(expectedValueLiteral);
      });

      it('should have the property last_transition_time (base name: "last_transition_time")', function() {
        // TODO: update the code to test the property last_transition_time
        expect(instance).to.have.property('last_transition_time');
        // expect(instance.last_transition_time).to.be(expectedValueLiteral);
      });
