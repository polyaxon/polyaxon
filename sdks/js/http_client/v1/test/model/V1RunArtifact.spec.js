  ...
  describe('(package)', function() {
    describe('V1RunArtifact', function() {
      ...
      it('should create an instance of V1RunArtifact', function() {
        // TODO: update the code to test V1RunArtifact
      ...
      it('should have the property is_input (base name: "is_input")', function() {
        // TODO: update the code to test the property is_input
        expect(instance).to.have.property('is_input');
        // expect(instance.is_input).to.be(expectedValueLiteral);
      });
