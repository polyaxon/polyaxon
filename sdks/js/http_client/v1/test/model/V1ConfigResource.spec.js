...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1ConfigResource', function() {
      beforeEach(function() {
        instance = new PolyaxonSdk.V1ConfigResource();
      });

      it('should create an instance of V1ConfigResource', function() {
        // TODO: update the code to test V1ConfigResource
        expect(instance).to.be.a(PolyaxonSdk.V1ConfigResource);
      });
