...
```groovy
compile "org.openapitools:openapi-java-client:1.3.3"
```
...
* `target/openapi-java-client-1.3.3.jar`
* `target/lib/*.jar`
...
*RunsV1Api* | [**approveRun**](docs/RunsV1Api.md#approveRun) | **POST** /api/v1/{owner}/{project}/runs/{uuid}/approve | Approve run
