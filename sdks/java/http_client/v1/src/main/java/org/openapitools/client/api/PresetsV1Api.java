...
public class PresetsV1Api {
     ...
     */
    public okhttp3.Call deletePresetCall(String owner, String uuid, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deletePresetValidateBeforeCall(String owner, String uuid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deletePresetCall(owner, uuid, _callback);
        return localVarCall;
     ...
     */
    public Object deletePreset(String owner, String uuid) throws ApiException {
        ApiResponse<Object> localVarResp = deletePresetWithHttpInfo(owner, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deletePresetWithHttpInfo(String owner, String uuid) throws ApiException {
        okhttp3.Call localVarCall = deletePresetValidateBeforeCall(owner, uuid, null);
     ...
     */
    public okhttp3.Call deletePresetAsync(String owner, String uuid, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deletePresetValidateBeforeCall(owner, uuid, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getPresetCall(String owner, String uuid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPresetValidateBeforeCall(String owner, String uuid, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getPresetCall(owner, uuid, _callback);
        return localVarCall;
     ...
     */
    public V1Preset getPreset(String owner, String uuid) throws ApiException {
        ApiResponse<V1Preset> localVarResp = getPresetWithHttpInfo(owner, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1Preset> getPresetWithHttpInfo(String owner, String uuid) throws ApiException {
        okhttp3.Call localVarCall = getPresetValidateBeforeCall(owner, uuid, null);
        Type localVarReturnType = new TypeToken<V1Preset>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getPresetAsync(String owner, String uuid, final ApiCallback<V1Preset> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPresetValidateBeforeCall(owner, uuid, _callback);
        Type localVarReturnType = new TypeToken<V1Preset>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
