...
public class TeamsV1Api {
     ...
     */
    public okhttp3.Call listTeamMembersCall(String owner, String name, Integer offset, Integer limit, String sort, String query, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listTeamMembersValidateBeforeCall(String owner, String name, Integer offset, Integer limit, String sort, String query, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listTeamMembersCall(owner, name, offset, limit, sort, query, _callback);
        return localVarCall;
     ...
     */
    public V1ListTeamMembersResponse listTeamMembers(String owner, String name, Integer offset, Integer limit, String sort, String query) throws ApiException {
        ApiResponse<V1ListTeamMembersResponse> localVarResp = listTeamMembersWithHttpInfo(owner, name, offset, limit, sort, query);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1ListTeamMembersResponse> listTeamMembersWithHttpInfo(String owner, String name, Integer offset, Integer limit, String sort, String query) throws ApiException {
        okhttp3.Call localVarCall = listTeamMembersValidateBeforeCall(owner, name, offset, limit, sort, query, null);
     ...
     */
    public okhttp3.Call listTeamMembersAsync(String owner, String name, Integer offset, Integer limit, String sort, String query, final ApiCallback<V1ListTeamMembersResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTeamMembersValidateBeforeCall(owner, name, offset, limit, sort, query, _callback);
        Type localVarReturnType = new TypeToken<V1ListTeamMembersResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
