...
public class ProjectsV1Api {
    ...
    public V1ListProjectsResponse listBookmarkedProjects(String user, Integer offset, Integer limit, String sort, String query) throws ApiException {
        ApiResponse<V1ListProjectsResponse> localVarResp = listBookmarkedProjectsWithHttpInfo(user, offset, limit, sort, query);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call listBookmarkedProjectsAsync(String user, Integer offset, Integer limit, String sort, String query, final ApiCallback<V1ListProjectsResponse> _callback) throws ApiException {
