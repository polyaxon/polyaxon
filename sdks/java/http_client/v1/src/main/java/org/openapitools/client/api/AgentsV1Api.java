...
public class AgentsV1Api {
     ...
     */
    public Object deleteAgent(String owner, String uuid) throws ApiException {
        ApiResponse<Object> localVarResp = deleteAgentWithHttpInfo(owner, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteAgentWithHttpInfo(String owner, String uuid) throws ApiException {
     ...
     */
    public okhttp3.Call deleteAgentAsync(String owner, String uuid, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getAgentTokenCall(String owner, String agent, String uuid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAgentTokenValidateBeforeCall(String owner, String agent, String uuid, final ApiCallback _callback) throws ApiException {
        ...
        if (agent == null) {
            throw new ApiException("Missing the required parameter 'agent' when calling getAgentToken(Async)");
        }
        

        okhttp3.Call localVarCall = getAgentTokenCall(owner, agent, uuid, _callback);
        return localVarCall;
     ...
     */
    public V1Token getAgentToken(String owner, String agent, String uuid) throws ApiException {
        ApiResponse<V1Token> localVarResp = getAgentTokenWithHttpInfo(owner, agent, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1Token> getAgentTokenWithHttpInfo(String owner, String agent, String uuid) throws ApiException {
        okhttp3.Call localVarCall = getAgentTokenValidateBeforeCall(owner, agent, uuid, null);
     ...
     */
    public okhttp3.Call getAgentTokenAsync(String owner, String agent, String uuid, final ApiCallback<V1Token> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAgentTokenValidateBeforeCall(owner, agent, uuid, _callback);
        Type localVarReturnType = new TypeToken<V1Token>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public Object syncAgent(String owner, String agentUuid, V1Agent body) throws ApiException {
        ApiResponse<Object> localVarResp = syncAgentWithHttpInfo(owner, agentUuid, body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> syncAgentWithHttpInfo(String owner, String agentUuid, V1Agent body) throws ApiException {
     ...
     */
    public okhttp3.Call syncAgentAsync(String owner, String agentUuid, V1Agent body, final ApiCallback<Object> _callback) throws ApiException {
