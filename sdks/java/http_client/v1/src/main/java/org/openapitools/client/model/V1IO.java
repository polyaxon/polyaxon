...
public class V1IO {
  ...
  public static final String SERIALIZED_NAME_ARG_FORMAT = "arg_format";
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, iotype, value, isOptional, isList, isFlag, argFormat, delayValidation, options, connection, toInit);
  }
