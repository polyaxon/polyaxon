...
public class AuthV1Api {
     ...
     */
    public void signup(V1UserSingup body) throws ApiException {
        signupWithHttpInfo(body);
    }
     ...
     */
    public ApiResponse<Void> signupWithHttpInfo(V1UserSingup body) throws ApiException {
     ...
     */
    public okhttp3.Call signupAsync(V1UserSingup body, final ApiCallback<Void> _callback) throws ApiException {
