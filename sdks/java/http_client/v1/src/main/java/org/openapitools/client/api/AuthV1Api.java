...
public class AuthV1Api {
     ...
     */
    public Object changePassword(V1PasswordChange body) throws ApiException {
        ApiResponse<Object> localVarResp = changePasswordWithHttpInfo(body);
     ...
     */
    public ApiResponse<Object> changePasswordWithHttpInfo(V1PasswordChange body) throws ApiException {
     ...
     */
    public okhttp3.Call changePasswordAsync(V1PasswordChange body, final ApiCallback<Object> _callback) throws ApiException {
     ...
     */
    public Object resetPassword(V1UserEmail body) throws ApiException {
        ApiResponse<Object> localVarResp = resetPasswordWithHttpInfo(body);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> resetPasswordWithHttpInfo(V1UserEmail body) throws ApiException {
     ...
     */
    public okhttp3.Call resetPasswordAsync(V1UserEmail body, final ApiCallback<Object> _callback) throws ApiException {
