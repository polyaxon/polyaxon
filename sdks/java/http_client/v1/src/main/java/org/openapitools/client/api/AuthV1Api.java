...
import org.openapitools.client.model.V1CredsBodyRequest;
...
public class AuthV1Api {
     ...
     */
    public okhttp3.Call loginCall(V1CredsBodyRequest body, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call loginValidateBeforeCall(V1CredsBodyRequest body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call loginAsync(V1CredsBodyRequest body, final ApiCallback<V1Auth> _callback) throws ApiException {
