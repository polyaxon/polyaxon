...
public class AccessResourcesV1Api {
     ...
     */
    public Object deleteAccessResource(String owner, String uuid) throws ApiException {
        ApiResponse<Object> localVarResp = deleteAccessResourceWithHttpInfo(owner, uuid);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteAccessResourceWithHttpInfo(String owner, String uuid) throws ApiException {
     ...
     */
    public okhttp3.Call deleteAccessResourceAsync(String owner, String uuid, final ApiCallback<Object> _callback) throws ApiException {
