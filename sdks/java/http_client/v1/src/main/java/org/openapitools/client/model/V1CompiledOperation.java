...
public class V1CompiledOperation {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, kind, name, description, tags, presets, queue, cache, termination, plugins, schedule, events, actions, hooks, matrix, dependencies, trigger, conditions, skipOnUpstreamSkip, inputs, outputs, run);
  }
