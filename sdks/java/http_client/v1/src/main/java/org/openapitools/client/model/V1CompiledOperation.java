...
public class V1CompiledOperation {
  ...
  **/
  ...
  public V1CompiledOperation events(List<String> events) {
    
    this.events = events;
    return this;
  }

  public V1CompiledOperation addEventsItem(String eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public V1CompiledOperation actions(List<V1Action> actions) {
    
    this.actions = actions;
    return this;
  }

  public V1CompiledOperation addActionsItem(V1Action actionsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.version, v1CompiledOperation.version) &&
        ...
        Objects.equals(this.actions, v1CompiledOperation.actions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(version, kind, name, description, tags, presets, queue, cache, termination, plugins, schedule, events, actions, hooks, matrix, dependencies, trigger, conditions, skipOnUpstreamSkip, inputs, outputs, contexts, isApproved, run);
  }
