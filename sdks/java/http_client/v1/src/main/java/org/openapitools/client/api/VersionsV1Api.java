...
import org.openapitools.client.model.V1Versions;
...
public class VersionsV1Api {
    ...
    private okhttp3.Call getVersionsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getVersionsCall(_callback);
        return localVarCall;
    ...
    public V1Versions getVersions() throws ApiException {
        ApiResponse<V1Versions> localVarResp = getVersionsWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getVersionsAsync(final ApiCallback<V1Versions> _callback) throws ApiException {
