...
public class VersionsV1Api {
     ...
     */
    public okhttp3.Call getInstallationCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstallationValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getInstallationCall(_callback);
        return localVarCall;
     ...
     */
    public V1Installation getInstallation() throws ApiException {
        ApiResponse<V1Installation> localVarResp = getInstallationWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<V1Installation> getInstallationWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getInstallationValidateBeforeCall(null);
     ...
     */
    public okhttp3.Call getInstallationAsync(final ApiCallback<V1Installation> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInstallationValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<V1Installation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
