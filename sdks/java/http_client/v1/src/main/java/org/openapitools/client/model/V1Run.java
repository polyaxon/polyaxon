...
public class V1Run {
  ...
  **/
  ...
  public V1Run isApproved(String isApproved) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, tags, user, owner, project, scheduleAt, createdAt, updatedAt, startedAt, finishedAt, duration, isManaged, isApproved, content, rawContent, status, bookmarked, metaInfo, kind, runtime, hub, inputs, outputs, original, pipeline, statusConditions, settings, role);
  }
