...
public class V1Run {
  ...
  public static final String SERIALIZED_NAME_IS_HELPER = "is_helper";
  @SerializedName(SERIALIZED_NAME_IS_HELPER)
  ...
  public static final String SERIALIZED_NAME_META_KIND = "meta_kind";
  @SerializedName(SERIALIZED_NAME_META_KIND)
  private V1RunKind metaKind = V1RunKind.JOB;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(uuid, name, description, tags, deleted, user, owner, project, createdAt, updatedAt, startedAt, finishedAt, duration, isManaged, content, rawContent, status, bookmarked, metaInfo, isHelper, kind, metaKind, hub, inputs, outputs, original, pipeline, statusConditions, settings, role);
  }
