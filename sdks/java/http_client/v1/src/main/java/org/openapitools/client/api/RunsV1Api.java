...
public class RunsV1Api {
     ...
     */
    public okhttp3.Call approveRunCall(String owner, String project, String uuid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/v1/{owner}/{project}/runs/{uuid}/approve"
    ...
    private okhttp3.Call approveRunValidateBeforeCall(String owner, String project, String uuid, final ApiCallback _callback) throws ApiException {
        ...
        if (project == null) {
            throw new ApiException("Missing the required parameter 'project' when calling approveRun(Async)");
        }
        ...
        okhttp3.Call localVarCall = approveRunCall(owner, project, uuid, _callback);
        return localVarCall;
     ...
     */
    public void approveRun(String owner, String project, String uuid) throws ApiException {
        approveRunWithHttpInfo(owner, project, uuid);
    }
     ...
     */
    public ApiResponse<Void> approveRunWithHttpInfo(String owner, String project, String uuid) throws ApiException {
        okhttp3.Call localVarCall = approveRunValidateBeforeCall(owner, project, uuid, null);
     ...
     */
    public okhttp3.Call approveRunAsync(String owner, String project, String uuid, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = approveRunValidateBeforeCall(owner, project, uuid, _callback);
