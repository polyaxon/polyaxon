...
public class V1Schemas {
  public static final String SERIALIZED_NAME_OPERATION_COND = "operation_cond";
  @SerializedName(SERIALIZED_NAME_OPERATION_COND)
  private V1OperationCond operationCond;
  ...
  public static final String SERIALIZED_NAME_CONNECTION_SCHEMA = "connection_schema";
  ...
  public static final String SERIALIZED_NAME_POLYAXON_SIDECAR_CONTAINER = "polyaxon_sidecar_container";
  @SerializedName(SERIALIZED_NAME_POLYAXON_SIDECAR_CONTAINER)
  private V1PolyaxonSidecarContainer polyaxonSidecarContainer;

  public static final String SERIALIZED_NAME_POLYAXON_INIT_CONTAINER = "polyaxon_init_container";
  ...
  public static final String SERIALIZED_NAME_AUTG = "autg";
  @SerializedName(SERIALIZED_NAME_AUTG)
  private V1AuthType autg;
  ...
  public static final String SERIALIZED_NAME_K8S_RESOURCE = "k8s_resource";
  ...
  public static final String SERIALIZED_NAME_MATRIX_KIND = "matrix_kind";
  @SerializedName(SERIALIZED_NAME_MATRIX_KIND)
  private V1MatrixKind matrixKind = V1MatrixKind.RANDOM;

  public static final String SERIALIZED_NAME_SCHEDULE_KIND = "schedule_kind";
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(operationCond, earlyStopping, matrix, run, operation, compiledOperation, schedule, connectionSchema, hpParams, reference, artifactsMount, polyaxonSidecarContainer, polyaxonInitContainer, artifacs, wasb, gcs, s3, autg, dockerfile, git, uri, k8sResource, connection, eventType, matrixKind, scheduleKind, event);
  }
