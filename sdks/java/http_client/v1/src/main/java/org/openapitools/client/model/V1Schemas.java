...
public class V1Schemas {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(operationCond, earlyStopping, matrix, run, operation, compiledOperation, schedule, connectionSchema, hpParams, reference, artifactsMount, polyaxonSidecarContainer, polyaxonInitContainer, artifacs, wasb, gcs, s3, autg, dockerfile, git, uri, k8sResource, connection, image, eventType, event, matrixKind);
  }
