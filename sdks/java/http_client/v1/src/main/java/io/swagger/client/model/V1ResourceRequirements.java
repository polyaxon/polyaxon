...
public class V1ResourceRequirements {
   ...
   * @return limits
  **/
  @ApiModelProperty(value = "Limits describes the maximum amount of compute resources allowed.")
   ...
   * @return requests
  **/
  @ApiModelProperty(value = "Requests describes the minimum amount of compute resources required.")
