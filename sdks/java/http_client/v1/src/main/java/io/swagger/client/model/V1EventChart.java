...
import io.swagger.client.model.EventChartKind;
...
public class V1EventChart {
  @SerializedName("kind")
  private EventChartKind kind = null;

  @SerializedName("figure")
  private Object figure = null;

  public V1EventChart kind(EventChartKind kind) {
    this.kind = kind;
    return this;
  }
  ...
  **/
  ...
  public EventChartKind getKind() {
    return kind;
  }

  public void setKind(EventChartKind kind) {
    this.kind = kind;
  }
