...
public class K8SSecretsV1Api {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object deleteK8SSecret(String owner, String uuid) throws ApiException {
        ApiResponse<Object> resp = deleteK8SSecretWithHttpInfo(owner, uuid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> deleteK8SSecretWithHttpInfo(String owner, String uuid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteK8SSecretAsync(String owner, String uuid, final ApiCallback<Object> callback) throws ApiException {
