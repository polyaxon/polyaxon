...
public class V1ListConnectionsResponse {
  ...
  private List<V1Connection> results = null;
  ...
  **/
  ...
  public V1ListConnectionsResponse results(List<V1Connection> results) {
    this.results = results;
    return this;
  }

  public V1ListConnectionsResponse addResultsItem(V1Connection resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<V1Connection>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<V1Connection> getResults() {
    return results;
  }

  public void setResults(List<V1Connection> results) {
    this.results = results;
  }
