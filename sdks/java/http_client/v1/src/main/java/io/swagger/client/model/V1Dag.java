...
public class V1Dag {
  ...
  **/
  ...
  public V1Dag ops(List<V1Op> ops) {
    this.ops = ops;
    return this;
  }

  public V1Dag addOpsItem(V1Op opsItem) {
    if (this.ops == null) {
      this.ops = new ArrayList<V1Op>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public List<V1Op> getOps() {
    return ops;
  }

  public void setOps(List<V1Op> ops) {
    this.ops = ops;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.kind, v1Dag.kind) &&
        Objects.equals(this.ops, v1Dag.ops) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(kind, ops, components, concurrency, earlyStopping);
  }
