...
public class ArtifactsStoresV1Api {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Object deleteArtifactsStore(String owner, String uuid) throws ApiException {
        ApiResponse<Object> resp = deleteArtifactsStoreWithHttpInfo(owner, uuid);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> deleteArtifactsStoreWithHttpInfo(String owner, String uuid) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteArtifactsStoreAsync(String owner, String uuid, final ApiCallback<Object> callback) throws ApiException {
