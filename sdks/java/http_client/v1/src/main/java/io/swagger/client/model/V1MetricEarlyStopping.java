...
public class V1MetricEarlyStopping {
  ...
  **/
   ...
   * @return optimization
  **/
  @ApiModelProperty(value = "Optimization to do: maximize or minimize.")
  ...
  public V1MetricEarlyStopping policy(List<Object> policy) {
    this.policy = policy;
    return this;
  }

  public V1MetricEarlyStopping addPolicyItem(Object policyItem) {
    if (this.policy == null) {
      this.policy = new ArrayList<Object>();
    }
