...
/**
 * API tests for SearchV1Api
 */
@Ignore
public class SearchV1ApiTest {

    private final SearchV1Api api = new SearchV1Api();
    ...
    public void createSearchTest() throws ApiException {
        ...
        String project = null;
        V1Search body = null;
        V1Search response = api.createSearch(owner, project, body);
    ...
    public void getSearchTest() throws ApiException {
        ...
        String project = null;
        String uuid = null;
        V1Search response = api.getSearch(owner, project, uuid);
    ...
    public void listSearchesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListSearchesResponse response = api.listSearches(owner, project, offset, limit, sort, query);
    ...
    public void patchSearchTest() throws ApiException {
        ...
        V1Search body = null;
        V1Search response = api.patchSearch(owner, project, searchUuid, body);
    ...
    public void updateSearchTest() throws ApiException {
        ...
        String searchUuid = null;
        V1Search body = null;
        V1Search response = api.updateSearch(owner, project, searchUuid, body);
