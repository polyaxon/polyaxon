...
public class ModelRegistryV1ApiTest {
    ...
    public void getModelRegistryActivitiesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListActivitiesResponse response = api.getModelRegistryActivities(owner, name, offset, limit, sort, query);
    ...
    public void listModelVersionNamesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListModelVersionsResponse response = api.listModelVersionNames(owner, name, offset, limit, sort, query);
    ...
    public void listModelVersionsTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListModelVersionsResponse response = api.listModelVersions(owner, name, offset, limit, sort, query);
