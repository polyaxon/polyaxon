...
public class ConnectionsV1ApiTest {
    ...
    public void listConnectionNamesTest() throws ApiException {
        ...
        String mode = null;
        Boolean noPage = null;
        V1ListConnectionsResponse response = api.listConnectionNames(owner, offset, limit, sort, query, bookmarks, pins, mode, noPage);
    ...
    public void listConnectionsTest() throws ApiException {
        ...
        String mode = null;
        Boolean noPage = null;
        V1ListConnectionsResponse response = api.listConnections(owner, offset, limit, sort, query, bookmarks, pins, mode, noPage);
