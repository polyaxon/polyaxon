...
public class QueuesV1ApiTest {
    ...
    public void listQueueNamesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListQueuesResponse response = api.listQueueNames(owner, name, offset, limit, sort, query);
    ...
    public void listQueuesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListQueuesResponse response = api.listQueues(owner, name, offset, limit, sort, query);
