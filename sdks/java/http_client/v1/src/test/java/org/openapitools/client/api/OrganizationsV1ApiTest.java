...
public class OrganizationsV1ApiTest {
    ...
    public void deleteOrganizationTest() throws ApiException {
        String owner = null;
        String usage = null;
        Object response = api.deleteOrganization(owner, usage);
    ...
    public void deleteOrganizationInvitationTest() throws ApiException {
        ...
        String email = null;
        Object response = api.deleteOrganizationInvitation(owner, memberUser, memberUserEmail, memberRole, memberCreatedAt, memberUpdatedAt, email);
