...
public class ProjectDashboardsV1ApiTest {
    ...
    public void listProjectDashboardNamesTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListDashboardsResponse response = api.listProjectDashboardNames(owner, name, offset, limit, sort, query);
    ...
    public void listProjectDashboardsTest() throws ApiException {
        ...
        String sort = null;
        String query = null;
        V1ListDashboardsResponse response = api.listProjectDashboards(owner, name, offset, limit, sort, query);
