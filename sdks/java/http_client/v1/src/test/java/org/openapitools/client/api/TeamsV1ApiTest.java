...
public class TeamsV1ApiTest {
    ...
    public void listTeamMembersTest() throws ApiException {
        ...
        String mode = null;
        Boolean noPage = null;
        V1ListTeamMembersResponse response = api.listTeamMembers(owner, name, offset, limit, sort, query, bookmarks, pins, mode, noPage);
    ...
    public void listTeamNamesTest() throws ApiException {
        ...
        String mode = null;
        Boolean noPage = null;
        V1ListTeamsResponse response = api.listTeamNames(owner, offset, limit, sort, query, bookmarks, pins, mode, noPage);
    ...
    public void listTeamsTest() throws ApiException {
        ...
        String mode = null;
        Boolean noPage = null;
        V1ListTeamsResponse response = api.listTeams(owner, offset, limit, sort, query, bookmarks, pins, mode, noPage);
