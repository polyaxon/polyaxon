...
_RUNSV1 = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=v1_dot_status__pb2._STATUS,
    serialized_options=_b('\202\323\344\223\0028\"./api/v1/{owner}/{project}/runs/{uuid}/statuses:\006status'),
  ),
  _descriptor.MethodDescriptor(
    name='GetRunCodeRefs',
