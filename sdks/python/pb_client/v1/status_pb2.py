...
_ENTITYSTATUSBODYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status_condition', full_name='v1.EntityStatusBodyRequest.status_condition', index=3,
...
_ENTITYSTATUSBODYREQUEST.fields_by_name['status_condition'].message_type = _STATUSCONDITION
