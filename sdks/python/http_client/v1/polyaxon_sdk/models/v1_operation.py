...
class V1Operation(object):
    ...
    def __init__(self, version=None, kind=None, name=None, description=None, tags=None, presets=None, queue=None, cache=None, termination=None, plugins=None, schedule=None, events=None, actions=None, hooks=None, matrix=None, dependencies=None, trigger=None, conditions=None, skip_on_upstream_skip=None, params=None, run_patch=None, patch_strategy=None, is_preset=None, template=None, dag_ref=None, url_ref=None, path_ref=None, hub_ref=None, component=None, local_vars_configuration=None):  # noqa: E501
