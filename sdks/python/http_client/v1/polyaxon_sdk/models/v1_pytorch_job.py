...
class V1PytorchJob(object):
    ...
    """
    swagger_types = {"kind": "str", "master": "V1Replica", "worker": "V1Replica"}

    attribute_map = {"kind": "kind", "master": "master", "worker": "worker"}

    def __init__(self, kind=None, master=None, worker=None):  # noqa: E501
