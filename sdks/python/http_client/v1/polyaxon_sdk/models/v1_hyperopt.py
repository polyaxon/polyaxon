...
class V1Hyperopt(object):
    ...
    def __init__(self, kind='hyperopt', algorithm=None, params=None, num_runs=None, max_iterations=None, seed=None, concurrency=None, early_stopping=None, local_vars_configuration=None):  # noqa: E501
