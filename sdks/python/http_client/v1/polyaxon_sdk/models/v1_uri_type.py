...
class V1UriType(object):
    ...
    """
    swagger_types = {"user": "str", "password": "str", "host": "bool"}

    attribute_map = {"user": "user", "password": "password", "host": "host"}

    def __init__(self, user=None, password=None, host=None):  # noqa: E501
        """V1UriType - a model defined in Swagger"""  # noqa: E501
