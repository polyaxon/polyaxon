...
class V1HostConnection(object):
    ...
    """
    swagger_types = {"url": "str", "insecure": "bool"}

    attribute_map = {"url": "url", "insecure": "insecure"}

    def __init__(self, url=None, insecure=None):  # noqa: E501
        """V1HostConnection - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1HostConnection, dict):
