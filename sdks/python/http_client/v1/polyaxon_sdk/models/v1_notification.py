...
class V1Notification(object):
    ...
    """
    swagger_types = {"connection": "str", "trigger": "NotificationTrigger"}

    attribute_map = {"connection": "connection", "trigger": "trigger"}

    def __init__(self, connection=None, trigger=None):  # noqa: E501
        """V1Notification - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1Notification, dict):
