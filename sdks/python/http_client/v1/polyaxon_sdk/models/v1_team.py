...
class V1Team(object):
    ...
    def __init__(self, uuid=None, name=None, projects=None, created_at=None, updated_at=None):  # noqa: E501
        """V1Team - a model defined in Swagger"""  # noqa: E501
