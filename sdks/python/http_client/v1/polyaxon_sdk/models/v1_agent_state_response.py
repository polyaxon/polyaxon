...
class V1AgentStateResponse(object):
    ...
    """
    swagger_types = {"status": "V1Statuses", "state": "AgentStateResponseAgentState"}

    attribute_map = {"status": "status", "state": "state"}

    def __init__(self, status=None, state=None):  # noqa: E501
        """V1AgentStateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1AgentStateResponse, dict):
