...
class V1RunArtifacts(object):
    ...
    """
    swagger_types = {"artifacts": "list[V1RunArtifact]"}

    attribute_map = {"artifacts": "artifacts"}

    def __init__(self, artifacts=None):  # noqa: E501
        """V1RunArtifacts - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1RunArtifacts, dict):
