...
class V1Bayes(object):
    ...
    def __init__(self, kind='bayes', params=None, num_initial_runs=None, max_iterations=None, utility_function=None, metric=None, seed=None, concurrency=None, early_stopping=None, local_vars_configuration=None):  # noqa: E501
