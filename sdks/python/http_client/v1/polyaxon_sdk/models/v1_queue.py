...
class V1Queue(object):
    ...
    def __init__(self, uuid=None, agent=None, name=None, priority=None, concurrency=None, created_at=None, updated_at=None):  # noqa: E501
        """V1Queue - a model defined in Swagger"""  # noqa: E501
