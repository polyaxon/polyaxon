...
class V1ClaimConnection(object):
    ...
    """
    swagger_types = {"volume_claim": "str", "mount_path": "str", "read_only": "bool"}
    ...
    def __init__(
        self, volume_claim=None, mount_path=None, read_only=None
    ):  # noqa: E501
        """V1ClaimConnection - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ClaimConnection, dict):
