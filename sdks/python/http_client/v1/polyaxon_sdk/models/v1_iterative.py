...
class V1Iterative(object):
    ...
    def __init__(self, kind='iterative', params=None, max_iterations=None, container=None, seed=None, concurrency=None, early_stopping=None, local_vars_configuration=None):  # noqa: E501
