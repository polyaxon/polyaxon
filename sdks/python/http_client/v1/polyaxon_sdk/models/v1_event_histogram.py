...
class V1EventHistogram(object):
    ...
    """
    swagger_types = {"values": "list[float]", "counts": "list[float]"}

    attribute_map = {"values": "values", "counts": "counts"}

    def __init__(self, values=None, counts=None):  # noqa: E501
        """V1EventHistogram - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1EventHistogram, dict):
