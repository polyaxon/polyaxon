...
class V1CompiledOperation(object):
    ...
    def __init__(self, version=None, kind=None, name=None, description=None, tags=None, presets=None, queue=None, cache=None, termination=None, plugins=None, schedule=None, events=None, actions=None, hooks=None, matrix=None, dependencies=None, trigger=None, conditions=None, skip_on_upstream_skip=None, inputs=None, outputs=None, contexts=None, run=None, local_vars_configuration=None):  # noqa: E501
