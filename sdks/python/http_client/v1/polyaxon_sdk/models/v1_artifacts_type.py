...
class V1ArtifactsType(object):
    ...
    """
    openapi_types = {"files": "list[str]", "dirs": "list[str]", "workers": "int"}

    attribute_map = {"files": "files", "dirs": "dirs", "workers": "workers"}

    def __init__(
        self, files=None, dirs=None, workers=None, local_vars_configuration=None
    ):  # noqa: E501
