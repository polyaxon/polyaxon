...
class V1EventModel(object):
    ...
    """
    swagger_types = {"framework": "str", "path": "str", "spec": "object"}

    attribute_map = {"framework": "framework", "path": "path", "spec": "spec"}

    def __init__(self, framework=None, path=None, spec=None):  # noqa: E501
        """V1EventModel - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1EventModel, dict):
