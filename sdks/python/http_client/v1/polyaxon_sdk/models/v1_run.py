...
class V1Run(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, tags=None, user=None, owner=None, project=None, created_at=None, updated_at=None, started_at=None, finished_at=None, duration=None, is_managed=None, content=None, raw_content=None, status=None, bookmarked=None, meta_info=None, is_helper=None, kind=None, runtime=None, hub=None, inputs=None, outputs=None, original=None, pipeline=None, status_conditions=None, settings=None, role=None, local_vars_configuration=None):  # noqa: E501
