...
class V1LogHandler(object):
    ...
    """
    swagger_types = {"dsn": "str", "environment": "str"}

    attribute_map = {"dsn": "dsn", "environment": "environment"}

    def __init__(self, dsn=None, environment=None):  # noqa: E501
        """V1LogHandler - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1LogHandler, dict):
