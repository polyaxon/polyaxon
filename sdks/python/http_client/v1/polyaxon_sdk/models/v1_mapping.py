...
class V1Mapping(object):
    ...
    def __init__(self, kind=None, values=None, concurrency=None, early_stopping=None):  # noqa: E501
        """V1Mapping - a model defined in Swagger"""  # noqa: E501
