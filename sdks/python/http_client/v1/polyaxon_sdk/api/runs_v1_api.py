...
class RunsV1Api(object):
    ...
    def get_run_artifact_with_http_info(
        ...
        all_params = ["namespace", "owner", "project", "uuid", "path", "stream"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_run_logs_with_http_info(
        ...
        all_params = ["namespace", "owner", "project", "uuid", "last_time", "last_file"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_run_resources_with_http_info(
        ...
        all_params = ["namespace", "owner", "project", "uuid", "names", "tail"]
        all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
