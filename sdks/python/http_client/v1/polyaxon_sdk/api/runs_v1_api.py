...
class RunsV1Api(object):
    ...
    def create_run_dashboard(self, owner, project, run, body, **kwargs):  # noqa: E501
        """Create run dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_run_dashboard(owner, project, run, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: Owner of the namespace (required)
        :param str project: Project under namesapce (required)
        :param str run: Run under namesapce (required)
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.create_run_dashboard_with_http_info(
                owner, project, run, body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.create_run_dashboard_with_http_info(
                owner, project, run, body, **kwargs
            )  # noqa: E501
            return data

    def create_run_dashboard_with_http_info(
        self, owner, project, run, body, **kwargs
    ):  # noqa: E501
        """Create run dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_run_dashboard_with_http_info(owner, project, run, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["owner", "project", "run", "body"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `create_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `create_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `create_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `create_run_dashboard`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/v1/{owner}/{project}/runs/{run}/dashboards",
            "POST",
            path_params,
            query_params,
            header_params,
    ...
    def delete_run_dashboard(self, owner, project, run, uuid, **kwargs):  # noqa: E501
        """Delete project dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_run_dashboard(owner, project, run, uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str owner: Owner of the namespace (required)
        :param str project: Project (required)
        :param str run: Run (required)
        :param str uuid: Uuid identifier of the entity (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.delete_run_dashboard_with_http_info(
                owner, project, run, uuid, **kwargs
            )  # noqa: E501
        else:
            (data) = self.delete_run_dashboard_with_http_info(
                owner, project, run, uuid, **kwargs
            )  # noqa: E501
            return data

    def delete_run_dashboard_with_http_info(
        self, owner, project, run, uuid, **kwargs
    ):  # noqa: E501
        """Delete project dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_run_dashboard_with_http_info(owner, project, run, uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["owner", "project", "run", "uuid"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `delete_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `delete_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `delete_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'uuid' is set
        if "uuid" not in params or params["uuid"] is None:
            raise ValueError(
                "Missing the required parameter `uuid` when calling `delete_run_dashboard`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/v1/{owner}/{project}/runs/{run}/dashboards/{uuid}",
            "DELETE",
            path_params,
            query_params,
            header_params,
    ...
    def get_run_dashboard(self, owner, project, run, uuid, **kwargs):  # noqa: E501
        """Get project dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_run_dashboard(owner, project, run, uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.get_run_dashboard_with_http_info(
                owner, project, run, uuid, **kwargs
            )  # noqa: E501
        else:
            (data) = self.get_run_dashboard_with_http_info(
                owner, project, run, uuid, **kwargs
            )  # noqa: E501
            return data

    def get_run_dashboard_with_http_info(
        self, owner, project, run, uuid, **kwargs
    ):  # noqa: E501
        """Get project dashboard  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_run_dashboard_with_http_info(owner, project, run, uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `get_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `get_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `get_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'uuid' is set
        if "uuid" not in params or params["uuid"] is None:
            raise ValueError(
                "Missing the required parameter `uuid` when calling `get_run_dashboard`"
            )  # noqa: E501
    ...
    def list_run_dashboard_names(self, owner, project, run, **kwargs):  # noqa: E501
        """List run dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_run_dashboard_names(owner, project, run, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.list_run_dashboard_names_with_http_info(
                owner, project, run, **kwargs
            )  # noqa: E501
        else:
            (data) = self.list_run_dashboard_names_with_http_info(
                owner, project, run, **kwargs
            )  # noqa: E501
            return data

    def list_run_dashboard_names_with_http_info(
        self, owner, project, run, **kwargs
    ):  # noqa: E501
        """List run dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_run_dashboard_names_with_http_info(owner, project, run, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_run_dashboard_names" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `list_run_dashboard_names`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `list_run_dashboard_names`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `list_run_dashboard_names`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/v1/{owner}/{project}/runs/{run}/dashboards/names",
            "GET",
            path_params,
            query_params,
            header_params,
    ...
    def list_run_dashboards(self, owner, project, run, **kwargs):  # noqa: E501
        """List run dashboards  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_run_dashboards(owner, project, run, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.list_run_dashboards_with_http_info(
                owner, project, run, **kwargs
            )  # noqa: E501
        else:
            (data) = self.list_run_dashboards_with_http_info(
                owner, project, run, **kwargs
            )  # noqa: E501
            return data

    def list_run_dashboards_with_http_info(
        self, owner, project, run, **kwargs
    ):  # noqa: E501
        """List run dashboards  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_run_dashboards_with_http_info(owner, project, run, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_run_dashboards" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `list_run_dashboards`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `list_run_dashboards`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `list_run_dashboards`"
            )  # noqa: E501
    ...
    def patch_run_dashboard(
        self, owner, project, run, dashboard_uuid, body, **kwargs
    ):  # noqa: E501
        """Patch project dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_run_dashboard(owner, project, run, dashboard_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.patch_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.patch_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, body, **kwargs
            )  # noqa: E501
            return data

    def patch_run_dashboard_with_http_info(
        self, owner, project, run, dashboard_uuid, body, **kwargs
    ):  # noqa: E501
        """Patch project dashboard  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_run_dashboard_with_http_info(owner, project, run, dashboard_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["owner", "project", "run", "dashboard_uuid", "body"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `patch_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `patch_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `patch_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'dashboard_uuid' is set
        if "dashboard_uuid" not in params or params["dashboard_uuid"] is None:
            raise ValueError(
                "Missing the required parameter `dashboard_uuid` when calling `patch_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `patch_run_dashboard`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}",
            "PATCH",
            path_params,
            query_params,
            header_params,
    ...
    def promote_run_dashboard(
        self, owner, project, run, dashboard_uuid, **kwargs
    ):  # noqa: E501
        """Promote project dashboard  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.promote_run_dashboard(owner, project, run, dashboard_uuid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.promote_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, **kwargs
            )  # noqa: E501
        else:
            (data) = self.promote_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, **kwargs
            )  # noqa: E501
            return data

    def promote_run_dashboard_with_http_info(
        self, owner, project, run, dashboard_uuid, **kwargs
    ):  # noqa: E501
        """Promote project dashboard  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.promote_run_dashboard_with_http_info(owner, project, run, dashboard_uuid, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ["owner", "project", "run", "dashboard_uuid"]  # noqa: E501
        all_params.append("async_req")
        all_params.append("_return_http_data_only")
        all_params.append("_preload_content")
        all_params.append("_request_timeout")
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method promote_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `promote_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `promote_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `promote_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'dashboard_uuid' is set
        if "dashboard_uuid" not in params or params["dashboard_uuid"] is None:
            raise ValueError(
                "Missing the required parameter `dashboard_uuid` when calling `promote_run_dashboard`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            "/api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}/promote",
            "POST",
            path_params,
            query_params,
            header_params,
    ...
    def update_run_dashboard(
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_run_dashboard(owner, project, run, dashboard_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, body, **kwargs
            )  # noqa: E501
        else:
            (data) = self.update_run_dashboard_with_http_info(
                owner, project, run, dashboard_uuid, body, **kwargs
            )  # noqa: E501
            return data

    def update_run_dashboard_with_http_info(
        self, owner, project, run, dashboard_uuid, body, **kwargs
    ):  # noqa: E501
        """Update project dashboard  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_run_dashboard_with_http_info(owner, project, run, dashboard_uuid, body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_run_dashboard" % key
                )
            params[key] = val
        del params["kwargs"]
        # verify the required parameter 'owner' is set
        if "owner" not in params or params["owner"] is None:
            raise ValueError(
                "Missing the required parameter `owner` when calling `update_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'project' is set
        if "project" not in params or params["project"] is None:
            raise ValueError(
                "Missing the required parameter `project` when calling `update_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'run' is set
        if "run" not in params or params["run"] is None:
            raise ValueError(
                "Missing the required parameter `run` when calling `update_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'dashboard_uuid' is set
        if "dashboard_uuid" not in params or params["dashboard_uuid"] is None:
            raise ValueError(
                "Missing the required parameter `dashboard_uuid` when calling `update_run_dashboard`"
            )  # noqa: E501
        # verify the required parameter 'body' is set
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `update_run_dashboard`"
            )  # noqa: E501
