...
# **list_search_names**
> V1ListSearchesResponse list_search_names(owner, offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
...
no_page = True # bool | No pagination. (optional)
    ...
    try:
        # List search names
        api_response = api_instance.list_search_names(owner, offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
        pprint(api_response)
    except ApiException as e:
...
# **list_searches**
> V1ListSearchesResponse list_searches(owner, offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
...
no_page = True # bool | No pagination. (optional)
    ...
    try:
        # List searches
        api_response = api_instance.list_searches(owner, offset=offset, limit=limit, sort=sort, query=query, no_page=no_page)
        pprint(api_response)
    except ApiException as e:
