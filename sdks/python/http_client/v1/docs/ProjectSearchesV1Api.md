...
> V1ListSearchesResponse list_project_search_names(owner, name, offset=offset, limit=limit, sort=sort, query=query, mode=mode, no_page=no_page)
...
no_page = True # bool | No pagination. (optional)
    ...
    try:
        # List project search names
        api_response = api_instance.list_project_search_names(owner, name, offset=offset, limit=limit, sort=sort, query=query, mode=mode, no_page=no_page)
        pprint(api_response)
    except ApiException as e:
...
> V1ListSearchesResponse list_project_searches(owner, name, offset=offset, limit=limit, sort=sort, query=query, mode=mode, no_page=no_page)
...
no_page = True # bool | No pagination. (optional)
    ...
    try:
        # List project searches
        api_response = api_instance.list_project_searches(owner, name, offset=offset, limit=limit, sort=sort, query=query, mode=mode, no_page=no_page)
        pprint(api_response)
    except ApiException as e:
