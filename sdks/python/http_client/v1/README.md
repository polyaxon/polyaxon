...
*RunsV1Api* | [**create_run_dashboard**](docs/RunsV1Api.md#create_run_dashboard) | **POST** /api/v1/{owner}/{project}/runs/{run}/dashboards | Create run dashboard
...
*RunsV1Api* | [**delete_run_dashboard**](docs/RunsV1Api.md#delete_run_dashboard) | **DELETE** /api/v1/{owner}/{project}/runs/{run}/dashboards/{uuid} | Delete project dashboard
...
*RunsV1Api* | [**get_run_dashboard**](docs/RunsV1Api.md#get_run_dashboard) | **GET** /api/v1/{owner}/{project}/runs/{run}/dashboards/{uuid} | Get project dashboard
...
*RunsV1Api* | [**list_run_dashboard_names**](docs/RunsV1Api.md#list_run_dashboard_names) | **GET** /api/v1/{owner}/{project}/runs/{run}/dashboards/names | List run dashboard
*RunsV1Api* | [**list_run_dashboards**](docs/RunsV1Api.md#list_run_dashboards) | **GET** /api/v1/{owner}/{project}/runs/{run}/dashboards | List run dashboards
...
*RunsV1Api* | [**patch_run_dashboard**](docs/RunsV1Api.md#patch_run_dashboard) | **PATCH** /api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid} | Patch project dashboard
*RunsV1Api* | [**promote_run_dashboard**](docs/RunsV1Api.md#promote_run_dashboard) | **POST** /api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid}/promote | Promote project dashboard
...
*RunsV1Api* | [**update_run_dashboard**](docs/RunsV1Api.md#update_run_dashboard) | **PUT** /api/v1/{owner}/{project}/runs/{run}/dashboards/{dashboard.uuid} | Update project dashboard
