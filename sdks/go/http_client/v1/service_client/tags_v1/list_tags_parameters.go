...
// WithPins adds the pins to the list tags params
func (o *ListTagsParams) WithPins(pins *string) *ListTagsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list tags params
func (o *ListTagsParams) SetPins(pins *string) {
	o.Pins = pins
}
