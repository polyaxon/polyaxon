...
// NewListComponentHubNamesParams creates a new ListComponentHubNamesParams object,
...
func NewListComponentHubNamesParams() *ListComponentHubNamesParams {
	return &ListComponentHubNamesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListComponentHubNamesParamsWithTimeout creates a new ListComponentHubNamesParams object
...
// NewListComponentHubNamesParamsWithContext creates a new ListComponentHubNamesParams object
...
// NewListComponentHubNamesParamsWithHTTPClient creates a new ListComponentHubNamesParams object
...
func (o *ListComponentHubNamesParams) WithDefaults() *ListComponentHubNamesParams {
	o.SetDefaults()
	return o
}
...
func (o *ListComponentHubNamesParams) WithTimeout(timeout time.Duration) *ListComponentHubNamesParams {
...
func (o *ListComponentHubNamesParams) WithContext(ctx context.Context) *ListComponentHubNamesParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ListComponentHubNamesParams) WithHTTPClient(client *http.Client) *ListComponentHubNamesParams {
...
// WithBookmarks adds the bookmarks to the list component hub names params
func (o *ListComponentHubNamesParams) WithBookmarks(bookmarks *bool) *ListComponentHubNamesParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list component hub names params
func (o *ListComponentHubNamesParams) SetBookmarks(bookmarks *bool) {
	o.Bookmarks = bookmarks
}

// WithLimit adds the limit to the list component hub names params
func (o *ListComponentHubNamesParams) WithLimit(limit *int32) *ListComponentHubNamesParams {
	o.SetLimit(limit)
	return o
}
...
// WithMode adds the mode to the list component hub names params
func (o *ListComponentHubNamesParams) WithMode(mode *string) *ListComponentHubNamesParams {
	o.SetMode(mode)
	return o
}

// SetMode adds the mode to the list component hub names params
func (o *ListComponentHubNamesParams) SetMode(mode *string) {
	o.Mode = mode
}

// WithNoPage adds the noPage to the list component hub names params
func (o *ListComponentHubNamesParams) WithNoPage(noPage *bool) *ListComponentHubNamesParams {
	o.SetNoPage(noPage)
	return o
}
...
func (o *ListComponentHubNamesParams) WithOffset(offset *int32) *ListComponentHubNamesParams {
	o.SetOffset(offset)
	return o
}
...
func (o *ListComponentHubNamesParams) WithOwner(owner string) *ListComponentHubNamesParams {
	o.SetOwner(owner)
	return o
}
...
// WithPins adds the pins to the list component hub names params
func (o *ListComponentHubNamesParams) WithPins(pins *string) *ListComponentHubNamesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list component hub names params
func (o *ListComponentHubNamesParams) SetPins(pins *string) {
	o.Pins = pins
}

// WithQuery adds the query to the list component hub names params
func (o *ListComponentHubNamesParams) WithQuery(query *string) *ListComponentHubNamesParams {
	o.SetQuery(query)
	return o
}
...
func (o *ListComponentHubNamesParams) WithSort(sort *string) *ListComponentHubNamesParams {
	o.SetSort(sort)
	return o
}
...
func (o *ListComponentHubNamesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
