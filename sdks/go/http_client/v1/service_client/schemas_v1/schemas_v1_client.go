...
/*
NoOp lists bookmarked runs for user
*/
func (a *Client) NoOp(params *NoOpParams, authInfo runtime.ClientAuthInfoWriter) (*NoOpOK, *NoOpNoContent, error) {
	...
	msg := fmt.Sprintf("unexpected success response for schemas_v1: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
