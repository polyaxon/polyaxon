...
// WithBookmarks adds the bookmarks to the list model version names params
func (o *ListModelVersionNamesParams) WithBookmarks(bookmarks *bool) *ListModelVersionNamesParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list model version names params
func (o *ListModelVersionNamesParams) SetBookmarks(bookmarks *bool) {
...
// WithPins adds the pins to the list model version names params
func (o *ListModelVersionNamesParams) WithPins(pins *string) *ListModelVersionNamesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list model version names params
func (o *ListModelVersionNamesParams) SetPins(pins *string) {
	o.Pins = pins
}
