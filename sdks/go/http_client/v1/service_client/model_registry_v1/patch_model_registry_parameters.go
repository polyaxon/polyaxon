...
// WithModelUUID adds the modelUUID to the patch model registry params
func (o *PatchModelRegistryParams) WithModelUUID(modelUUID string) *PatchModelRegistryParams {
	o.SetModelUUID(modelUUID)
	return o
}

// SetModelUUID adds the modelUuid to the patch model registry params
func (o *PatchModelRegistryParams) SetModelUUID(modelUUID string) {
