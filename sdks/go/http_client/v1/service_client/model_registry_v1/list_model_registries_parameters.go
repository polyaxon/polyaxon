...
// WithBookmarks adds the bookmarks to the list model registries params
func (o *ListModelRegistriesParams) WithBookmarks(bookmarks *bool) *ListModelRegistriesParams {
	o.SetBookmarks(bookmarks)
	return o
}

// SetBookmarks adds the bookmarks to the list model registries params
func (o *ListModelRegistriesParams) SetBookmarks(bookmarks *bool) {
...
// WithMode adds the mode to the list model registries params
func (o *ListModelRegistriesParams) WithMode(mode *string) *ListModelRegistriesParams {
	o.SetMode(mode)
	return o
}

// SetMode adds the mode to the list model registries params
func (o *ListModelRegistriesParams) SetMode(mode *string) {
	o.Mode = mode
}
...
// WithPins adds the pins to the list model registries params
func (o *ListModelRegistriesParams) WithPins(pins *string) *ListModelRegistriesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list model registries params
func (o *ListModelRegistriesParams) SetPins(pins *string) {
	o.Pins = pins
}
