...
// WithPins adds the pins to the list project dashboards params
func (o *ListProjectDashboardsParams) WithPins(pins *string) *ListProjectDashboardsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list project dashboards params
func (o *ListProjectDashboardsParams) SetPins(pins *string) {
	o.Pins = pins
}
