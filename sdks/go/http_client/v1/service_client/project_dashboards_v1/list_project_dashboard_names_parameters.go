...
// WithProject adds the project to the list project dashboard names params
func (o *ListProjectDashboardNamesParams) WithProject(project string) *ListProjectDashboardNamesParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the list project dashboard names params
func (o *ListProjectDashboardNamesParams) SetProject(project string) {
	o.Project = project
}
