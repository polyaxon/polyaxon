...
func (o *UpdateSearchOK) Error() string {
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateSearchOK  %+v", 200, o.Payload)
}
...
func (o *UpdateSearchForbidden) Error() string {
	return fmt.Sprintf("[PUT /api/v1/{owner}/{project}/searches/{search.uuid}][%d] updateSearchForbidden  %+v", 403, o.Payload)
}
