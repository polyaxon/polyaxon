...
// WithProject adds the project to the list searches params
func (o *ListSearchesParams) WithProject(project string) *ListSearchesParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the list searches params
func (o *ListSearchesParams) SetProject(project string) {
	o.Project = project
}
