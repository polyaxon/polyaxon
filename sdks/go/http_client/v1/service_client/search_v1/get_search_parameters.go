...
// WithProject adds the project to the get search params
func (o *GetSearchParams) WithProject(project string) *GetSearchParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the get search params
func (o *GetSearchParams) SetProject(project string) {
	o.Project = project
}
