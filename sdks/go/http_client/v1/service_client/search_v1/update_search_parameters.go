...
// WithProject adds the project to the update search params
func (o *UpdateSearchParams) WithProject(project string) *UpdateSearchParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the update search params
func (o *UpdateSearchParams) SetProject(project string) {
	o.Project = project
}
