...
// WithPins adds the pins to the list projects params
func (o *ListProjectsParams) WithPins(pins *string) *ListProjectsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list projects params
func (o *ListProjectsParams) SetPins(pins *string) {
	o.Pins = pins
}
