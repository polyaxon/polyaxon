...
func (o *PatchRunProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		result := NewPatchRunProfileDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewPatchRunProfileDefault creates a PatchRunProfileDefault with default headers values
func NewPatchRunProfileDefault(code int) *PatchRunProfileDefault {
	return &PatchRunProfileDefault{
		_statusCode: code,
	}
}

/*PatchRunProfileDefault handles this case with default header values.

An unexpected error response
*/
type PatchRunProfileDefault struct {
	_statusCode int

	Payload *service_model.RuntimeError
}

// Code gets the status code for the patch run profile default response
func (o *PatchRunProfileDefault) Code() int {
	return o._statusCode
}

func (o *PatchRunProfileDefault) Error() string {
	return fmt.Sprintf("[PATCH /api/v1/orgs/{owner}/run_profiles/{run_profile.uuid}][%d] PatchRunProfile default  %+v", o._statusCode, o.Payload)
}

func (o *PatchRunProfileDefault) GetPayload() *service_model.RuntimeError {
	return o.Payload
}

func (o *PatchRunProfileDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
