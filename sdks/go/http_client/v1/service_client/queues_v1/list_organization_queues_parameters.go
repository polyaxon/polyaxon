...
// WithPins adds the pins to the list organization queues params
func (o *ListOrganizationQueuesParams) WithPins(pins *string) *ListOrganizationQueuesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list organization queues params
func (o *ListOrganizationQueuesParams) SetPins(pins *string) {
	o.Pins = pins
}
