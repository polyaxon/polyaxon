...
// WithPins adds the pins to the list queues params
func (o *ListQueuesParams) WithPins(pins *string) *ListQueuesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list queues params
func (o *ListQueuesParams) SetPins(pins *string) {
	o.Pins = pins
}
