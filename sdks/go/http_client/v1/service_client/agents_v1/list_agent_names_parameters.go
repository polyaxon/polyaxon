...
// WithPins adds the pins to the list agent names params
func (o *ListAgentNamesParams) WithPins(pins *string) *ListAgentNamesParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list agent names params
func (o *ListAgentNamesParams) SetPins(pins *string) {
	o.Pins = pins
}
