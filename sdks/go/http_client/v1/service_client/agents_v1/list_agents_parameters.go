...
// WithPins adds the pins to the list agents params
func (o *ListAgentsParams) WithPins(pins *string) *ListAgentsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list agents params
func (o *ListAgentsParams) SetPins(pins *string) {
	o.Pins = pins
}
