...
// WithProject adds the project to the update dashboard params
func (o *UpdateDashboardParams) WithProject(project string) *UpdateDashboardParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the update dashboard params
func (o *UpdateDashboardParams) SetProject(project string) {
	o.Project = project
}
