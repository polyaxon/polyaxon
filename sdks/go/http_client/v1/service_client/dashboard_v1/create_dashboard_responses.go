...
func (o *CreateDashboardOK) Error() string {
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createDashboardOK  %+v", 200, o.Payload)
}
...
func (o *CreateDashboardNoContent) Error() string {
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createDashboardNoContent  %+v", 204, o.Payload)
}
...
func (o *CreateDashboardForbidden) Error() string {
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createDashboardForbidden  %+v", 403, o.Payload)
}
...
func (o *CreateDashboardNotFound) Error() string {
	return fmt.Sprintf("[POST /api/v1/{owner}/{project}/dashboards][%d] createDashboardNotFound  %+v", 404, o.Payload)
}
