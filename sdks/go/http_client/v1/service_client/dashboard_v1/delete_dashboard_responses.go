...
func (o *DeleteDashboardOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/{owner}/{project}/dashboards/{uuid}][%d] deleteDashboardOK ", 200)
}
...
func (o *DeleteDashboardNoContent) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/{owner}/{project}/dashboards/{uuid}][%d] deleteDashboardNoContent  %+v", 204, o.Payload)
}
...
func (o *DeleteDashboardForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/{owner}/{project}/dashboards/{uuid}][%d] deleteDashboardForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteDashboardNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/v1/{owner}/{project}/dashboards/{uuid}][%d] deleteDashboardNotFound  %+v", 404, o.Payload)
}
