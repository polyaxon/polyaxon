...
/*GetRunArtifactsLineageOK handles this case with default header values.
...
func (o *GetRunArtifactsLineageOK) Error() string {
	return fmt.Sprintf("[GET /api/v1/{owner}/{project}/runs/{uuid}/artifacts_lineage][%d] getRunArtifactsLineageOK  %+v", 200, o.Payload)
}
...
/*GetRunArtifactsLineageNoContent handles this case with default header values.
...
func (o *GetRunArtifactsLineageNoContent) Error() string {
	return fmt.Sprintf("[GET /api/v1/{owner}/{project}/runs/{uuid}/artifacts_lineage][%d] getRunArtifactsLineageNoContent  %+v", 204, o.Payload)
}
...
/*GetRunArtifactsLineageForbidden handles this case with default header values.
...
func (o *GetRunArtifactsLineageForbidden) Error() string {
	return fmt.Sprintf("[GET /api/v1/{owner}/{project}/runs/{uuid}/artifacts_lineage][%d] getRunArtifactsLineageForbidden  %+v", 403, o.Payload)
}
...
/*GetRunArtifactsLineageNotFound handles this case with default header values.
...
func (o *GetRunArtifactsLineageNotFound) Error() string {
	return fmt.Sprintf("[GET /api/v1/{owner}/{project}/runs/{uuid}/artifacts_lineage][%d] getRunArtifactsLineageNotFound  %+v", 404, o.Payload)
}
...
/*GetRunArtifactsLineageDefault handles this case with default header values.
...
func (o *GetRunArtifactsLineageDefault) Error() string {
	return fmt.Sprintf("[GET /api/v1/{owner}/{project}/runs/{uuid}/artifacts_lineage][%d] GetRunArtifactsLineage default  %+v", o._statusCode, o.Payload)
}
