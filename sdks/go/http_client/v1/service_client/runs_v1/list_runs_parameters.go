...
// WithPins adds the pins to the list runs params
func (o *ListRunsParams) WithPins(pins *string) *ListRunsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list runs params
func (o *ListRunsParams) SetPins(pins *string) {
	o.Pins = pins
}
