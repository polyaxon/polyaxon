...
for the patch k8 s secret operation typically these are written to a http.Request
*/
...
// SetK8sResourceUUID adds the k8sResourceUuid to the patch k8 s secret params
func (o *PatchK8SSecretParams) SetK8sResourceUUID(k8sResourceUUID string) {
	o.K8sResourceUUID = k8sResourceUUID
}

// WithOwner adds the owner to the patch k8 s secret params
func (o *PatchK8SSecretParams) WithOwner(owner string) *PatchK8SSecretParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the patch k8 s secret params
