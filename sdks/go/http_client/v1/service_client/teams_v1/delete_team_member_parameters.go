...
// WithMemberCreatedAt adds the memberCreatedAt to the delete team member params
func (o *DeleteTeamMemberParams) WithMemberCreatedAt(memberCreatedAt *strfmt.DateTime) *DeleteTeamMemberParams {
	o.SetMemberCreatedAt(memberCreatedAt)
	return o
}

// SetMemberCreatedAt adds the memberCreatedAt to the delete team member params
func (o *DeleteTeamMemberParams) SetMemberCreatedAt(memberCreatedAt *strfmt.DateTime) {
	o.MemberCreatedAt = memberCreatedAt
}

// WithMemberOrgRole adds the memberOrgRole to the delete team member params
func (o *DeleteTeamMemberParams) WithMemberOrgRole(memberOrgRole *string) *DeleteTeamMemberParams {
	o.SetMemberOrgRole(memberOrgRole)
	return o
}

// SetMemberOrgRole adds the memberOrgRole to the delete team member params
func (o *DeleteTeamMemberParams) SetMemberOrgRole(memberOrgRole *string) {
	o.MemberOrgRole = memberOrgRole
}

// WithMemberRole adds the memberRole to the delete team member params
func (o *DeleteTeamMemberParams) WithMemberRole(memberRole *string) *DeleteTeamMemberParams {
	o.SetMemberRole(memberRole)
	return o
}

// SetMemberRole adds the memberRole to the delete team member params
func (o *DeleteTeamMemberParams) SetMemberRole(memberRole *string) {
	o.MemberRole = memberRole
}

// WithMemberUpdatedAt adds the memberUpdatedAt to the delete team member params
func (o *DeleteTeamMemberParams) WithMemberUpdatedAt(memberUpdatedAt *strfmt.DateTime) *DeleteTeamMemberParams {
	o.SetMemberUpdatedAt(memberUpdatedAt)
	return o
}

// SetMemberUpdatedAt adds the memberUpdatedAt to the delete team member params
func (o *DeleteTeamMemberParams) SetMemberUpdatedAt(memberUpdatedAt *strfmt.DateTime) {
	o.MemberUpdatedAt = memberUpdatedAt
}

// WithMemberUser adds the memberUser to the delete team member params
func (o *DeleteTeamMemberParams) WithMemberUser(memberUser string) *DeleteTeamMemberParams {
	o.SetMemberUser(memberUser)
	return o
}

// SetMemberUser adds the memberUser to the delete team member params
func (o *DeleteTeamMemberParams) SetMemberUser(memberUser string) {
