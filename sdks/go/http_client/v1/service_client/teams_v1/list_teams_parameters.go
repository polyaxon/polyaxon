...
// WithPins adds the pins to the list teams params
func (o *ListTeamsParams) WithPins(pins *string) *ListTeamsParams {
	o.SetPins(pins)
	return o
}

// SetPins adds the pins to the list teams params
func (o *ListTeamsParams) SetPins(pins *string) {
	o.Pins = pins
}
