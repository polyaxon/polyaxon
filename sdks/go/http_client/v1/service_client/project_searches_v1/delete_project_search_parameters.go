...
// WithProject adds the project to the delete project search params
func (o *DeleteProjectSearchParams) WithProject(project string) *DeleteProjectSearchParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the delete project search params
func (o *DeleteProjectSearchParams) SetProject(project string) {
	o.Project = project
}
