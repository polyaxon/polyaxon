...
// V1Parallel All Schemas message
// swagger:model v1Parallel
type V1Parallel struct {
...
// Validate validates this v1 parallel
func (m *V1Parallel) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1Parallel) validateBo(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateGrid(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateHyperband(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateHyperopt(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateIterative(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateMapping(formats strfmt.Registry) error {
...
func (m *V1Parallel) validateRandom(formats strfmt.Registry) error {
...
func (m *V1Parallel) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1Parallel) UnmarshalBinary(b []byte) error {
	var res V1Parallel
