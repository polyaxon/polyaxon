...
// ContextValidate validates this v1 io cond based on context it is used
func (m *V1IoCond) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
