...
func (m *V1ModelRegistry) validateSettings(formats strfmt.Registry) error {
...
func (m *V1ModelRegistry) contextValidateSettings(ctx context.Context, formats strfmt.Registry) error {
