...
func (m *V1ModelVersion) contextValidateStage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ModelVersion) contextValidateStageConditions(ctx context.Context, formats strfmt.Registry) error {
