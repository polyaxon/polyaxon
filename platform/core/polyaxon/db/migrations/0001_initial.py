    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', django.contrib.postgres.fields.jsonb.JSONField(help_text='The compiled polyaxonfile for the build job.')),
                ('dockerfile', models.TextField(blank=True, help_text='The dockerfile used to create the image with this job.', null=True)),
            ],
            bases=(models.Model, db.models.statuses.LastStatusMixin, db.models.abstract.job.JobMixin),
        ),
        migrations.CreateModel(
            name='BuildJobStatus',
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('created', 'created'), ('building', 'building'), ('unschedulable', 'unschedulable'), ('warning', 'warning'), ('scheduled', 'scheduled'), ('resuming', 'resuming'), ('running', 'running'), ('succeeded', 'succeeded'), ('failed', 'failed'), ('upstream_failed', 'upstream_failed'), ('stopped', 'stopped'), ('skipped', 'skipped'), ('unknown', 'unknown')], default='created', max_length=64, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='The compiled polyaxon with specific values for this experiment.', null=True)),
            ...
            bases=(models.Model, db.models.statuses.LastStatusMixin, db.models.abstract.job.TensorboardJobMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('definition', django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='The specific values/manifest for this job.')),
                ('config', django.contrib.postgres.fields.jsonb.JSONField(help_text='The compiled polyaxonfile for the run job.')),
                ('cloning_strategy', models.CharField(blank=True, choices=[('copy', 'copy'), ('restart', 'restart'), ('resume', 'resume')], max_length=16, null=True)),
                ('build_job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.BuildJob')),
                ('code_reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.CodeReference')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('definition', django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='The specific values/manifest for this job.')),
                ('config', django.contrib.postgres.fields.jsonb.JSONField(help_text='The compiled polyaxonfile for the notebook job.')),
                ('build_job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.BuildJob')),
                ('code_reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.CodeReference')),
            ],
            bases=(models.Model, db.models.statuses.LastStatusMixin, db.models.abstract.job.JobMixin),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('celery_queue', models.CharField(blank=True, help_text='The queue name to use for the executing this task. If provided, it will override the queue provided in CELERY_TASK_ROUTES.', max_length=128, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='OperationRun',
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, db.models.abstract.job.TensorboardJobMixin),
        ),
        migrations.CreateModel(
            name='Repo',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('definition', django.contrib.postgres.fields.jsonb.JSONField(default=dict, help_text='The specific values/manifest for this job.')),
                ('config', django.contrib.postgres.fields.jsonb.JSONField(help_text='The compiled polyaxonfile for the tensorboard job.')),
                ('build_job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.BuildJob')),
                ('code_reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='db.CodeReference')),
