 ...
 * **Fix**: An issue wrong padding that introduces a horizontal scroll in the run overview.
 * **Fix**: Regression hiding settings and the edit buttons on projects in Polyaxon CE.   
