 ...
 * **Enhancement**: Add search and filters to the artifacts lineage table.
...
### Core
  ...
  * **Enhancement**: Improve resolution logic of tagged entities.
  * **Enhancement**: Enforce sampling after 50k entries.
