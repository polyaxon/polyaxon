...
### Client
  ...
  * **Enhancement**: Add artifacts lineage `list` method to the `RunClient`.
...
### UI
  ...
  * **Enhancement**: Improve download buttons and download filename on the artifacts lineage tables.
