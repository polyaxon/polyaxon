 ...
 * **Feature**: Add copy mode to restart behavior.
 ...
 * **Fix**: Issues in sidecar logging causing an error.
 ...
 * **Enhancement**: Add possibility to delete files and subpaths in the artifacts tab.
 ...
 * **Enhancement**: Add possibility to restrict organizations for Github auth.
 * **Enhancement**: Add possibility to restrict domains for Google auth. 
