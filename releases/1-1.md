 ...
 * **Enhancement**: Add possibility to provide all secrets environment variables using a secret.
 ...
 * **Fix**: Issue in Dark theme editors, the editor is now using the `dracula` theme.
