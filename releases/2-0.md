 ...
 * **New**: New `plx --context/-c path/to/.polyaxon COMMAND [OPTIONS]` argument or `polyaxon config context path/to/.polyaxon/` to allow managing multiple context for managing global configurations.
