 ...
 * **New**: Implement logic for internal `events`. Users can now run full event based workflows, and in following iterations it will be possible to start operations based on external events and internal alerts.
 ...
 * **Enhancement**: Add several heartbeat process to clean distressed pipelines and runs.
