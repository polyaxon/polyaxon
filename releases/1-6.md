...
### Core
  ...
  * **Enhancement**: Allow to save extra summary information in lineage table.
...
### UI
  ...
  * **Enhancement**: Improve scrollbars in run pages and remove the jumpy behavior in some browser.
