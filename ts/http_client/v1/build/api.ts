...
export const BuildServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        greateBuildCodeRef(owner: string, project: string, id: string, body: V1OwnedEntityIdRequest, options: any = {}): FetchArgs {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
                throw new RequiredError('owner','Required parameter owner was null or undefined when calling greateBuildCodeRef.');
            }
            // verify required parameter 'project' is not null or undefined
            if (project === null || project === undefined) {
                throw new RequiredError('project','Required parameter project was null or undefined when calling greateBuildCodeRef.');
            }
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling greateBuildCodeRef.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
...
export const BuildServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBuildCodeRef(owner: string, project: string, id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
         ...
         * @throws {RequiredError}
         */
        greateBuildCodeRef(owner: string, project: string, id: string, body: V1OwnedEntityIdRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<any> {
            const localVarFetchArgs = BuildServiceApiFetchParamCreator(configuration).greateBuildCodeRef(owner, project, id, body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const BuildServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        greateBuildCodeRef(owner: string, project: string, id: string, body: V1OwnedEntityIdRequest, options?: any) {
            return BuildServiceApiFp(configuration).greateBuildCodeRef(owner, project, id, body, options)(fetch, basePath);
        },
        /**
         * 
         * @summary List archived builds
...
export class BuildServiceApi extends BaseAPI {
     ...
     * @memberof BuildServiceApi
     */
    public greateBuildCodeRef(owner: string, project: string, id: string, body: V1OwnedEntityIdRequest, options?: any) {
        return BuildServiceApiFp(this.configuration).greateBuildCodeRef(owner, project, id, body, options)(this.fetch, this.basePath);
    }
