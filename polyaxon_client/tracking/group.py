...
class Group(BaseTracker):
    ...
    def create(
        ...
        if content:
            group_config["content"] = self.client.project.validate_content(
                content=content
            )
    ...
    def create_experiment(
        self, name=None, framework=None, tags=None, description=None, content=None
    ):
    ...
    def log_status(self, status, message=None, traceback=None):
        self.client.experiment_group.create_status(
            username=self.username,
            project_name=self.project_name,
            group_id=self.group_id,
            status=status,
