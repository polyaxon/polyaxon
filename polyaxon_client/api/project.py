...
class ProjectApi(BaseApiHandler):
    ...
    def get_project(self, username, project_name):
        ...
        try:
            ...
            return self.prepare_results(
                response_json=response.json(), config=ProjectConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
                e=e, log_message="Error while retrieving project."
            )
            return None

    def create_project(self, project_config):
        project_config = self.validate_config(
            config=project_config, config_schema=ProjectConfig
        )
        try:
            response = self.transport.post(
                self._get_http_url("/projects"), json_data=project_config.to_dict()
            )
            return self.prepare_results(
                response_json=response.json(), config=ProjectConfig
            )
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while creating project."
            )
            return None
    ...
    def update_project(self, username, project_name, patch_dict, background=False):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while updating project."
            )
            return None
    ...
    def delete_project(self, username, project_name, background=False):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while deleting project."
            )
            return None

    def enable_ci(self, username, project_name, config=None, background=False):
        """Enable ci on the project"""
        request_url = self.build_url(self._get_http_url(), username, project_name, "ci")
        json_data = {}
        if config:
    ...
    def set_repo(
        self, username, project_name, git_url, is_public=True, background=False
    ):
        ...
        json_data = {"git_url": git_url, "is_public": is_public}
        if background:
            self.transport.async_post(request_url, json_data=json_data)
            return None
    ...
    def upload_repo(
        ...
        if background:
            self.transport.async_upload(
                request_url, files=files, files_size=files_size, json_data=json_data
            )
            return None
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while updating project repo."
            )
            return None
    ...
    def list_experiment_groups(
        self, username, project_name, query=None, sort=None, page=1
    ):
    ...
    def create_experiment_group(
        self, username, project_name, experiment_group_config, background=False
    ):
        experiment_group_config = self.validate_config(
            config=experiment_group_config, config_schema=GroupConfig
        )
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "groups"
        )
        ...
        if background:
            self.transport.async_post(
                request_url, json_data=experiment_group_config.to_dict()
            )
            return None
        ...
        try:
            ...
            return self.prepare_results(
                response_json=response.json(), config=GroupConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
    ...
    def create_experiment(
        self, username, project_name, experiment_config, group=None, background=False
    ):
        experiment_config = self.validate_config(
            config=experiment_config, config_schema=ExperimentConfig
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while creating experiment."
            )
            return None
    ...
    def create_job(self, username, project_name, job_config, background=False):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while creating job."
            )
            return None
    ...
    def list_builds(self, username, project_name, query=None, sort=None, page=1):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while retrieving build jobs."
            )
            return []
    ...
    def create_build(self, username, project_name, build_config, background=False):
        build_config = self.validate_config(
            config=build_config, config_schema=BuildJobConfig
        )
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "builds"
        )
        ...
        try:
            response = self.transport.post(
                request_url, json_data=build_config.to_dict()
            )
            return self.prepare_results(
                response_json=response.json(), config=BuildJobConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
                e=e, log_message="Error while creating build job."
            )
            return None
    ...
    def list_tensorboards(self, username, project_name, query=None, sort=None, page=1):
        ...
        try:
            ...
            return self.prepare_list_results(
                response.json(), page, TensorboardJobConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
    ...
    def start_tensorboard(
        self, username, project_name, content=None, is_managed=True, background=False
    ):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "tensorboard", "start"
        )
    ...
    def stop_tensorboard(self, username, project_name, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "tensorboard", "stop"
        )
    ...
    def start_notebook(
        ...
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "notebook", "start"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while starting notebook."
            )
            return None

    def stop_notebook(self, username, project_name, commit=True, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "notebook", "stop"
        )
        json_data = None
        if commit is False:
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while stopping notebook."
            )
            return None

    def bookmark(self, username, project_name, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "bookmark"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while bookmarking project."
            )
            return None

    def unbookmark(self, username, project_name, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "unbookmark"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while unbookmarking project."
            )
            return None
