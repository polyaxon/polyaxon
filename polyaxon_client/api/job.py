...
class JobApi(BaseApiHandler):
    ...
    def get_job(self, username, project_name, job_id):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id
        )
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while retrieving job."
            )
            return None
    ...
    def update_job(self, username, project_name, job_id, patch_dict, background=False):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while updating job."
            )
            return None
    ...
    def delete_job(self, username, project_name, job_id, background=False):
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while deleting job."
            )
            return None

    def get_statuses(self, username, project_name, job_id, page=1):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "statuses"
        )
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while retrieving job statuses."
            )
            return None
    ...
    def create_status(
        ...
        try:
            ...
            return self.prepare_results(
                response_json=response.json(), config=JobStatusConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
    ...
    def get_code_reference(self, username, project_name, job_id):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "coderef"
        )
        try:
            response = self.transport.get(request_url)
    ...
    def create_code_reference(
        self, username, project_name, job_id, coderef, background=False
    ):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "coderef"
        )
    ...
    def send_logs(
        ...
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "logs"
        )
    ...
    def restart(
        ...
        """Restart an job."""
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "restart"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while restarting the job."
            )
            return None
    ...
    def resume(
        ...
        """Resume a job."""
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "resume"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while resuming the job."
            )
            return None
    ...
    def copy(
        ...
        """Copy an job."""
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "copy"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while copying the job."
            )
            return None

    def stop(self, username, project_name, job_id, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "stop"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while stopping job."
            )
            return None

    def bookmark(self, username, project_name, job_id, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "bookmark"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while bookmarking job."
            )
            return None

    def unbookmark(self, username, project_name, job_id, background=False):
        request_url = self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, "unbookmark"
        )
        ...
        try:
            ...
            self.transport.handle_exception(
                e=e, log_message="Error while unbookmarking job."
            )
            return None
    ...
    def resources(self, username, project_name, job_id, message_handler=None):
        ...
        """
        request_url = self.build_url(
            self._get_ws_url(), username, project_name, "jobs", job_id, "resources"
        )
    ...
    def logs(self, username, project_name, job_id, stream=True, message_handler=None):
        ...
        request_url = self.build_url(
            self._get_ws_url(), username, project_name, "jobs", job_id, "logs", "stream"
        )
        self.transport.stream(request_url, message_handler=message_handler)
    ...
    def download_outputs(self, username, project_name, job_id):
        ...
        try:
            response = self.transport.download(
                request_url, "{}.{}.{}.tar.gz".format(username, project_name, job_id)
            )
            return response
        except PolyaxonClientException as e:
            self.transport.handle_exception(
                e=e, log_message="Error while downloading job outputs."
            )
            return None

    def get_heartbeat_url(self, username, project_name, job_id):
        return self.build_url(
            self._get_http_url(), username, project_name, "jobs", job_id, self.HEARTBEAT
        )
