...
class ExperimentJobApi(BaseApiHandler):
    ...
    def get_job(self, username, project_name, experiment_id, job_id):
        ...
        try:
            ...
            return self.prepare_results(
                response_json=response.json(), config=ExperimentJobConfig
            )
    ...
    def get_statuses(self, username, project_name, experiment_id, job_id, page=1):
        ...
        try:
            ...
            return self.prepare_list_results(
                response.json(), page, ExperimentJobStatusConfig
            )
        except PolyaxonClientException as e:
            self.transport.handle_exception(
    ...
    def resources(
        self, username, project_name, experiment_id, job_id, message_handler=None
    ):
