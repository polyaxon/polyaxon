...
// WithOwner adds the owner to the get experiment params
func (o *GetExperimentParams) WithOwner(owner string) *GetExperimentParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the get experiment params
func (o *GetExperimentParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the get experiment params
func (o *GetExperimentParams) WithProject(project string) *GetExperimentParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the get experiment params
func (o *GetExperimentParams) SetProject(project string) {
	o.Project = project
}
