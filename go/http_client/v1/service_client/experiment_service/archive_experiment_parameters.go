...
// WithOwner adds the owner to the archive experiment params
func (o *ArchiveExperimentParams) WithOwner(owner string) *ArchiveExperimentParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the archive experiment params
func (o *ArchiveExperimentParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the archive experiment params
func (o *ArchiveExperimentParams) WithProject(project string) *ArchiveExperimentParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the archive experiment params
func (o *ArchiveExperimentParams) SetProject(project string) {
	o.Project = project
}
