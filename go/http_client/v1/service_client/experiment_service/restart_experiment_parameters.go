...
func (o *RestartExperimentParams) WithBody(body *service_model.V1OwnedEntityIDRequest) *RestartExperimentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the restart experiment params
func (o *RestartExperimentParams) SetBody(body *service_model.V1OwnedEntityIDRequest) {
	o.Body = body
}
