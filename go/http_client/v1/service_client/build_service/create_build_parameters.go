...
func (o *CreateBuildParams) WithBody(body *service_model.V1BuildBodyRequest) *CreateBuildParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create build params
func (o *CreateBuildParams) SetBody(body *service_model.V1BuildBodyRequest) {
	o.Body = body
}
