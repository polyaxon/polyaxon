...
func (o *DeleteBuildsParams) WithBody(body *service_model.V1OwnedEntityIDRequest) *DeleteBuildsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete builds params
func (o *DeleteBuildsParams) SetBody(body *service_model.V1OwnedEntityIDRequest) {
	o.Body = body
}
