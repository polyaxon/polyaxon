...
func (o *StartRunTensorboardParams) WithBody(body *service_model.V1OwnedEntityUUIDRequest) *StartRunTensorboardParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the start run tensorboard params
func (o *StartRunTensorboardParams) SetBody(body *service_model.V1OwnedEntityUUIDRequest) {
	o.Body = body
}
