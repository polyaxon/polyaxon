...
// WithOwner adds the owner to the delete experiment params
func (o *DeleteExperimentParams) WithOwner(owner string) *DeleteExperimentParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the delete experiment params
func (o *DeleteExperimentParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the delete experiment params
func (o *DeleteExperimentParams) WithProject(project string) *DeleteExperimentParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the delete experiment params
func (o *DeleteExperimentParams) SetProject(project string) {
	o.Project = project
}
