...
type CreateBuildParams struct {
	...
	/*Body*/
	Body *build_model.V1BuildBodyRequest
	/*Owner
...
func (o *CreateBuildParams) WithBody(body *build_model.V1BuildBodyRequest) *CreateBuildParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create build params
func (o *CreateBuildParams) SetBody(body *build_model.V1BuildBodyRequest) {
	o.Body = body
}

// WithOwner adds the owner to the create build params
func (o *CreateBuildParams) WithOwner(owner string) *CreateBuildParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the create build params
func (o *CreateBuildParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the create build params
func (o *CreateBuildParams) WithProject(project string) *CreateBuildParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the create build params
func (o *CreateBuildParams) SetProject(project string) {
	o.Project = project
}
