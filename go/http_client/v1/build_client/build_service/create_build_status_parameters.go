...
func (o *CreateBuildStatusParams) WithBody(body *build_model.V1OwnedEntityIDRequest) *CreateBuildStatusParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create build status params
func (o *CreateBuildStatusParams) SetBody(body *build_model.V1OwnedEntityIDRequest) {
	o.Body = body
}
