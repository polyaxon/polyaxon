...
type StopBuildsParams struct {
	...
	/*Body*/
	Body *build_model.V1ProjectBodyRequest
	/*Owner
...
func (o *StopBuildsParams) WithBody(body *build_model.V1ProjectBodyRequest) *StopBuildsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the stop builds params
func (o *StopBuildsParams) SetBody(body *build_model.V1ProjectBodyRequest) {
	o.Body = body
}
