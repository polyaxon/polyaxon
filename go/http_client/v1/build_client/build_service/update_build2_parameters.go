...
func (o *UpdateBuild2Params) WithBody(body *build_model.V1BuildBodyRequest) *UpdateBuild2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update build2 params
func (o *UpdateBuild2Params) SetBody(body *build_model.V1BuildBodyRequest) {
	o.Body = body
}
