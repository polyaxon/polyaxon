...
func (o *CreateJobParams) WithBody(body *job_model.V1JobBodyRequest) *CreateJobParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create job params
func (o *CreateJobParams) SetBody(body *job_model.V1JobBodyRequest) {
	o.Body = body
}

// WithOwner adds the owner to the create job params
func (o *CreateJobParams) WithOwner(owner string) *CreateJobParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the create job params
func (o *CreateJobParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the create job params
func (o *CreateJobParams) WithProject(project string) *CreateJobParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the create job params
func (o *CreateJobParams) SetProject(project string) {
	o.Project = project
}
