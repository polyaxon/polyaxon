...
func (o *RestartJobParams) WithBody(body *job_model.V1OwnedEntityIDRequest) *RestartJobParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the restart job params
func (o *RestartJobParams) SetBody(body *job_model.V1OwnedEntityIDRequest) {
	o.Body = body
}
