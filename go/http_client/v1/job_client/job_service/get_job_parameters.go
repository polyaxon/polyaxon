...
// WithOwner adds the owner to the get job params
func (o *GetJobParams) WithOwner(owner string) *GetJobParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the get job params
func (o *GetJobParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the get job params
func (o *GetJobParams) WithProject(project string) *GetJobParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the get job params
func (o *GetJobParams) SetProject(project string) {
	o.Project = project
}
