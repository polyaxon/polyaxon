...
func (o *DeleteJobsParams) WithBody(body *job_model.V1OwnedEntityIDRequest) *DeleteJobsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the delete jobs params
func (o *DeleteJobsParams) SetBody(body *job_model.V1OwnedEntityIDRequest) {
	o.Body = body
}
