...
// WithOwner adds the owner to the delete job params
func (o *DeleteJobParams) WithOwner(owner string) *DeleteJobParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the delete job params
func (o *DeleteJobParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the delete job params
func (o *DeleteJobParams) WithProject(project string) *DeleteJobParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the delete job params
func (o *DeleteJobParams) SetProject(project string) {
	o.Project = project
}
