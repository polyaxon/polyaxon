...
// swagger:model v1CodeReference
type V1CodeReference struct {
...
func (m *V1CodeReference) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CodeReference) UnmarshalBinary(b []byte) error {
	var res V1CodeReference
