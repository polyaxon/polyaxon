...
type CreateExperimentParams struct {
	...
	/*Body*/
	Body *experiment_model.V1ExperimentBodyRequest
	/*Owner
...
func (o *CreateExperimentParams) WithBody(body *experiment_model.V1ExperimentBodyRequest) *CreateExperimentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create experiment params
func (o *CreateExperimentParams) SetBody(body *experiment_model.V1ExperimentBodyRequest) {
	o.Body = body
}

// WithOwner adds the owner to the create experiment params
func (o *CreateExperimentParams) WithOwner(owner string) *CreateExperimentParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the create experiment params
func (o *CreateExperimentParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the create experiment params
func (o *CreateExperimentParams) WithProject(project string) *CreateExperimentParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the create experiment params
func (o *CreateExperimentParams) SetProject(project string) {
	o.Project = project
}
