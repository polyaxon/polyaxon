...
func (o *UpdateExperiment2Params) WithBody(body *experiment_model.V1ExperimentBodyRequest) *UpdateExperiment2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update experiment2 params
func (o *UpdateExperiment2Params) SetBody(body *experiment_model.V1ExperimentBodyRequest) {
	o.Body = body
}
