...
// WithOwner adds the owner to the list experiments params
func (o *ListExperimentsParams) WithOwner(owner string) *ListExperimentsParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the list experiments params
func (o *ListExperimentsParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithProject adds the project to the list experiments params
func (o *ListExperimentsParams) WithProject(project string) *ListExperimentsParams {
	o.SetProject(project)
	return o
}

// SetProject adds the project to the list experiments params
func (o *ListExperimentsParams) SetProject(project string) {
	o.Project = project
}
