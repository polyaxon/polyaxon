...
// NewRestoreExperimentParams creates a new RestoreExperimentParams object
// with the default values initialized.
func NewRestoreExperimentParams() *RestoreExperimentParams {
	var ()
	return &RestoreExperimentParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewRestoreExperimentParamsWithTimeout creates a new RestoreExperimentParams object
...
// NewRestoreExperimentParamsWithContext creates a new RestoreExperimentParams object
...
// NewRestoreExperimentParamsWithHTTPClient creates a new RestoreExperimentParams object
...
/*RestoreExperimentParams contains all the parameters to send to the API endpoint
for the restore experiment operation typically these are written to a http.Request
*/
...
// WithID adds the id to the restore experiment params
func (o *RestoreExperimentParams) WithID(id string) *RestoreExperimentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the restore experiment params
func (o *RestoreExperimentParams) SetID(id string) {
	o.ID = id
}
