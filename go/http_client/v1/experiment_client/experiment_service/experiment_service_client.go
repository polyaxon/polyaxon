...
/*
ArchiveExperiment archives experiment
*/
...
/*
BookmarkExperiment bookmarks experiment
*/
...
/*
CreateExperimentStatus creates new experiment status
*/
...
/*
DeleteExperiments deletes experiments
*/
...
/*
GreateExperimentCodeRef gets experiment code ref
*/
func (a *Client) GreateExperimentCodeRef(params *GreateExperimentCodeRefParams) (*GreateExperimentCodeRefOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGreateExperimentCodeRefParams()
	}
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GreateExperimentCodeRefReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*GreateExperimentCodeRefOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GreateExperimentCodeRef: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
ListArchivedExperiments lists archived experiments
*/
...
/*
ListBookmarkedExperiments lists bookmarked experiments
*/
...
/*
ListExperimentStatuses lists experiment statuses
*/
...
/*
RestartExperiment restarts experiment
*/
...
/*
RestoreExperiment restores experiment
*/
...
/*
ResumeExperiment resumes experiment
*/
...
/*
StartExperimentTensorboard starts experiment tensorboard
*/
...
/*
StopExperimentTensorboard stops experiment tensorboard
*/
...
/*
StopExperiments stops experiments
*/
...
/*
UnBookmarkExperiment uns bookmark experiment
*/
...
/*
UpdateExperiment2 updates experiment
*/
