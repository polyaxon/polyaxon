...
var (
	...
	pattern_ExperimentService_GreateExperimentCodeRef_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"v1", "entity.owner", "entity.project", "experiments", "entity.id", "coderef"}, "", runtime.AssumeColonVerbOpt(true)))
)
