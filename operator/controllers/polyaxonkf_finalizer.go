...
func (r *PolyaxonKFReconciler) handleFinalizer(instance *corev1alpha1.PolyaxonKF) error {
...
func (r *PolyaxonKFReconciler) setStatus(instance *corev1alpha1.PolyaxonKF) error {
	log := r.Log

	log.Info("KF Job end", "Reconciliation", instance.GetName())
