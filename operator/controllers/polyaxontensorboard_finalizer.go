...
func (r *PolyaxonTensorboardReconciler) addFinalizer(instance *corev1alpha1.PolyaxonTensorboard) error {
	instance.AddFinalizer()
	return r.Update(context.Background(), instance)
}

func (r *PolyaxonTensorboardReconciler) handleFinalizer(instance *corev1alpha1.PolyaxonTensorboard) error {
...
func (r *PolyaxonTensorboardReconciler) setStatus(instance *corev1alpha1.PolyaxonTensorboard) error {
	log := r.Log

	log.Info("Tensorboard end", "Reconciliation", instance.GetName())
