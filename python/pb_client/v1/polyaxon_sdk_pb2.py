...
_AUTHSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002\025\022\023/api/v1/users/token'),
  ),
])
...
_VERSIONSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetVersions',
    full_name='v1.VersionsService.GetVersions',
    index=0,
    containing_service=None,
    input_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    output_type=v1_dot_versions__pb2._VERSIONS,
