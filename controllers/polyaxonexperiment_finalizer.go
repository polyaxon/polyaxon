...
func (r *PolyaxonExperimentReconciler) addFinalizer(instance *corev1alpha1.PolyaxonExperiment) error {
	instance.AddFinalizer()
	return r.Update(context.Background(), instance)
}

func (r *PolyaxonExperimentReconciler) handleFinalizer(instance *corev1alpha1.PolyaxonExperiment) error {
...
func (r *PolyaxonExperimentReconciler) setStatus(instance *corev1alpha1.PolyaxonExperiment) error {
	log := r.Log

	log.Info("Experiment end", "Reconciliation", instance.GetName())
