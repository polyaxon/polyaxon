export enum actionTypes {
  ...
  RESTART_EXPERIMENT_REQUEST = 'RESTART_EXPERIMENT_REQUEST',
  RESTART_EXPERIMENT_SUCCESS = 'RESTART_EXPERIMENT_SUCCESS',
  RESTART_EXPERIMENT_ERROR = 'RESTART_EXPERIMENT_ERROR',

  RESUME_EXPERIMENT_REQUEST = 'RESUME_EXPERIMENT_REQUEST',
  RESUME_EXPERIMENT_SUCCESS = 'RESUME_EXPERIMENT_SUCCESS',
  RESUME_EXPERIMENT_ERROR = 'RESUME_EXPERIMENT_ERROR',
