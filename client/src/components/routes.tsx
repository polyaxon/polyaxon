...
function Routes() {
  ...
  return (
    <Switch>
      ...
      <Route path={newProjectJobRoute} component={JobCreate}/>
      <Route path={jobDetailRoute} component={JobDetail}/>
      <Route path={newProjectGroupRoute} component={GroupCreate}/>
      <Route path={newGroupTensorboardRoute} component={TensorboardCreate}/>
      <Route path={groupDetailRoute} component={GroupDetail}/>
      <Route path={newProjectExperimentRoute} component={ExperimentCreate}/>
