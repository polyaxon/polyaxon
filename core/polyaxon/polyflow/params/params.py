...
class V1Param(BaseConfig, polyaxon_sdk.V1Param):
    ...
    Params can be passed in several ways
        ...
        * a search, in that case the param will be a list of values based based on the results
          from executing the search.


    When a param is passed wither from the CLI or directly in the yaml/python specification,
    ...
    A reference could be to a previous run in the database or
    ...
    and it only used to resolve some information and inject it to the context.
