...
class V1ConnectionKind(polyaxon_sdk.V1ConnectionKind):
    CHOICES = (
        ...
        (
            polyaxon_sdk.V1ConnectionKind.PAGER_DUTY,
            polyaxon_sdk.V1ConnectionKind.PAGER_DUTY,
        ),
    ...
    VALUES = {
        ...
        polyaxon_sdk.V1ConnectionKind.AWS,
        polyaxon_sdk.V1ConnectionKind.GCP,
        polyaxon_sdk.V1ConnectionKind.AZURE,
        polyaxon_sdk.V1ConnectionKind.MYSQL,
        polyaxon_sdk.V1ConnectionKind.POSTGRES,
        polyaxon_sdk.V1ConnectionKind.ORACLE,
        polyaxon_sdk.V1ConnectionKind.VERTICA,
        polyaxon_sdk.V1ConnectionKind.SQLITE,
        polyaxon_sdk.V1ConnectionKind.MSSQL,
        polyaxon_sdk.V1ConnectionKind.REDIS,
        polyaxon_sdk.V1ConnectionKind.PRESTO,
        polyaxon_sdk.V1ConnectionKind.MONGO,
        polyaxon_sdk.V1ConnectionKind.CASSANDRA,
        polyaxon_sdk.V1ConnectionKind.FTP,
        polyaxon_sdk.V1ConnectionKind.GRPC,
        polyaxon_sdk.V1ConnectionKind.HDFS,
        polyaxon_sdk.V1ConnectionKind.HTTP,
        polyaxon_sdk.V1ConnectionKind.PIG_CLI,
        polyaxon_sdk.V1ConnectionKind.HIVE_CLI,
        polyaxon_sdk.V1ConnectionKind.HIVE_METASTORE,
        polyaxon_sdk.V1ConnectionKind.HIVE_SERVER2,
        polyaxon_sdk.V1ConnectionKind.JDBC,
        polyaxon_sdk.V1ConnectionKind.JENKINS,
        polyaxon_sdk.V1ConnectionKind.SAMBA,
        polyaxon_sdk.V1ConnectionKind.SNOWFLAKE,
        polyaxon_sdk.V1ConnectionKind.SSH,
        polyaxon_sdk.V1ConnectionKind.CLOUDANT,
        polyaxon_sdk.V1ConnectionKind.DATABRICKS,
        polyaxon_sdk.V1ConnectionKind.SEGMENT,
        polyaxon_sdk.V1ConnectionKind.SLACK,
        polyaxon_sdk.V1ConnectionKind.DISCORD,
        polyaxon_sdk.V1ConnectionKind.MATTERMOST,
        polyaxon_sdk.V1ConnectionKind.PAGER_DUTY,
        polyaxon_sdk.V1ConnectionKind.HIPCHAT,
        polyaxon_sdk.V1ConnectionKind.WEBHOOK,
        polyaxon_sdk.V1ConnectionKind.CUSTOM,
    }
