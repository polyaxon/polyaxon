...
public class BuildServiceApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call greateBuildCodeRefCall(String entityOwner, String entityProject, String entityId, V1CodeReferenceBodyRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;

        // create path and map variables
        String localVarPath = "/v1/{entity.owner}/{entity.project}/builds/{entity.id}/coderef"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call greateBuildCodeRefValidateBeforeCall(String entityOwner, String entityProject, String entityId, V1CodeReferenceBodyRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'entityOwner' is set
        if (entityOwner == null) {
            throw new ApiException("Missing the required parameter 'entityOwner' when calling greateBuildCodeRef(Async)");
        }
        
        // verify the required parameter 'entityProject' is set
        if (entityProject == null) {
            throw new ApiException("Missing the required parameter 'entityProject' when calling greateBuildCodeRef(Async)");
        }
        
        // verify the required parameter 'entityId' is set
        if (entityId == null) {
            throw new ApiException("Missing the required parameter 'entityId' when calling greateBuildCodeRef(Async)");
        }
        ...
        com.squareup.okhttp.Call call = greateBuildCodeRefCall(entityOwner, entityProject, entityId, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1CodeReference greateBuildCodeRef(String entityOwner, String entityProject, String entityId, V1CodeReferenceBodyRequest body) throws ApiException {
        ApiResponse<V1CodeReference> resp = greateBuildCodeRefWithHttpInfo(entityOwner, entityProject, entityId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1CodeReference> greateBuildCodeRefWithHttpInfo(String entityOwner, String entityProject, String entityId, V1CodeReferenceBodyRequest body) throws ApiException {
        com.squareup.okhttp.Call call = greateBuildCodeRefValidateBeforeCall(entityOwner, entityProject, entityId, body, null, null);
        Type localVarReturnType = new TypeToken<V1CodeReference>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call greateBuildCodeRefAsync(String entityOwner, String entityProject, String entityId, V1CodeReferenceBodyRequest body, final ApiCallback<V1CodeReference> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = greateBuildCodeRefValidateBeforeCall(entityOwner, entityProject, entityId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1CodeReference>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
