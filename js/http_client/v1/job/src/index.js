...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProtobufAny', 'model/V1Dict', 'model/V1Job', 'model/V1JobBodyRequest', 'model/V1JobStatus', 'model/V1KV', 'model/V1ListJobStatusesResponse', 'model/V1ListJobsResponse', 'model/V1OwnedEntityIdRequest', 'model/V1ProjectBodyRequest', 'model/V1StatusResponse', 'api/JobServiceApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ProtobufAny'), require('./model/V1Dict'), require('./model/V1Job'), require('./model/V1JobBodyRequest'), require('./model/V1JobStatus'), require('./model/V1KV'), require('./model/V1ListJobStatusesResponse'), require('./model/V1ListJobsResponse'), require('./model/V1OwnedEntityIdRequest'), require('./model/V1ProjectBodyRequest'), require('./model/V1StatusResponse'), require('./api/JobServiceApi'));
  }
}(function(ApiClient, ProtobufAny, V1Dict, V1Job, V1JobBodyRequest, V1JobStatus, V1KV, V1ListJobStatusesResponse, V1ListJobsResponse, V1OwnedEntityIdRequest, V1ProjectBodyRequest, V1StatusResponse, JobServiceApi) {
  'use strict';
