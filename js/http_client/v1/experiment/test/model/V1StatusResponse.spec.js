...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExperimentService.V1StatusResponse();
  });
  ...
  describe('V1StatusResponse', function() {
    it('should create an instance of V1StatusResponse', function() {
      ...
      //var instance = new ExperimentService.V1StatusResponse();
      //expect(instance).to.be.a(ExperimentService.V1StatusResponse);
    });
