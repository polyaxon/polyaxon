...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Experiment', 'model/V1ExperimentBodyRequest', 'model/V1ExperimentStatus', 'model/V1ListExperimentStatusesResponse', 'model/V1ListExperimentsResponse', 'model/V1OwnedEntityIdRequest', 'model/V1ProjectBodyRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1Experiment'), require('../model/V1ExperimentBodyRequest'), require('../model/V1ExperimentStatus'), require('../model/V1ListExperimentStatusesResponse'), require('../model/V1ListExperimentsResponse'), require('../model/V1OwnedEntityIdRequest'), require('../model/V1ProjectBodyRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.ExperimentService) {
      root.ExperimentService = {};
    }
    root.ExperimentService.ExperimentServiceApi = factory(root.ExperimentService.ApiClient, root.ExperimentService.V1Experiment, root.ExperimentService.V1ExperimentBodyRequest, root.ExperimentService.V1ExperimentStatus, root.ExperimentService.V1ListExperimentStatusesResponse, root.ExperimentService.V1ListExperimentsResponse, root.ExperimentService.V1OwnedEntityIdRequest, root.ExperimentService.V1ProjectBodyRequest);
  }
}(this, function(ApiClient, V1Experiment, V1ExperimentBodyRequest, V1ExperimentStatus, V1ListExperimentStatusesResponse, V1ListExperimentsResponse, V1OwnedEntityIdRequest, V1ProjectBodyRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * data is of type: {@link Object}
     */
    this.greateExperimentCodeRef = function(owner, project, id, body, callback) {
      var postBody = body;

      // verify the required parameter 'owner' is set
      if (owner === undefined || owner === null) {
        throw new Error("Missing the required parameter 'owner' when calling greateExperimentCodeRef");
      }

      // verify the required parameter 'project' is set
      if (project === undefined || project === null) {
        throw new Error("Missing the required parameter 'project' when calling greateExperimentCodeRef");
      }

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling greateExperimentCodeRef");
      }
