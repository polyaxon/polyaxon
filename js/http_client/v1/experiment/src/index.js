...
(function(factory) {
   ...
   * <pre>
   * var ExperimentService = require('index'); // See note below*.
   * var xxxSvc = new ExperimentService.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new ExperimentService.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new ExperimentService.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new ExperimentService.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
