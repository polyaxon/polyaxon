...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuildService.V1Build();
  });
  ...
  describe('V1Build', function() {
    it('should create an instance of V1Build', function() {
      ...
      //var instance = new BuildService.V1Build();
      //expect(instance).to.be.a(BuildService.V1Build);
    });
    ...
    it('should have the property build_build (base name: "build_build")', function() {
      // uncomment below and update the code to test the property build_build
      //var instance = new BuildService.V1Build();
      //expect(instance).to.be();
    });
