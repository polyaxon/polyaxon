...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BuildService.BuildServiceApi();
  });
  ...
  describe('BuildServiceApi', function() {
    ...
    describe('greateBuildCodeRef', function() {
      it('should call greateBuildCodeRef successfully', function(done) {
        //uncomment below and update the code to test greateBuildCodeRef
        //instance.greateBuildCodeRef(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
