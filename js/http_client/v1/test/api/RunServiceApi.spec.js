...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.RunServiceApi();
  });
  ...
  describe('RunServiceApi', function() {
    ...
    describe('createRunCodeRef', function() {
      it('should call createRunCodeRef successfully', function(done) {
        //uncomment below and update the code to test createRunCodeRef
        //instance.createRunCodeRef(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getRunCodeRefs', function() {
      it('should call getRunCodeRefs successfully', function(done) {
        //uncomment below and update the code to test getRunCodeRefs
        //instance.getRunCodeRefs(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
