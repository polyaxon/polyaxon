...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.ExperimentServiceApi();
  });
  ...
  describe('ExperimentServiceApi', function() {
    ...
    describe('createExperimentCodeRef', function() {
      it('should call createExperimentCodeRef successfully', function(done) {
        //uncomment below and update the code to test createExperimentCodeRef
        //instance.createExperimentCodeRef(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
