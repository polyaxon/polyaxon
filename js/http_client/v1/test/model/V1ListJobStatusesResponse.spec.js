...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PolyaxonSdk.V1ListJobStatusesResponse();
  });
  ...
  describe('V1ListJobStatusesResponse', function() {
    it('should create an instance of V1ListJobStatusesResponse', function() {
      ...
      //var instance = new PolyaxonSdk.V1ListJobStatusesResponse();
      //expect(instance).to.be.a(PolyaxonSdk.V1ListJobStatusesResponse);
    });
