...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/V1Build', 'model/V1BuildBodyRequest', 'model/V1BuildStatus', 'model/V1CodeReference', 'model/V1CodeReferenceBodyRequest', 'model/V1EntityStatusRequest', 'model/V1ListBuildStatusesResponse', 'model/V1ListBuildsResponse', 'model/V1OwnedEntityIdRequest', 'model/V1ProjectBodyRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/V1Build'), require('../model/V1BuildBodyRequest'), require('../model/V1BuildStatus'), require('../model/V1CodeReference'), require('../model/V1CodeReferenceBodyRequest'), require('../model/V1EntityStatusRequest'), require('../model/V1ListBuildStatusesResponse'), require('../model/V1ListBuildsResponse'), require('../model/V1OwnedEntityIdRequest'), require('../model/V1ProjectBodyRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.PolyaxonSdk) {
      root.PolyaxonSdk = {};
    }
    root.PolyaxonSdk.BuildServiceApi = factory(root.PolyaxonSdk.ApiClient, root.PolyaxonSdk.V1Build, root.PolyaxonSdk.V1BuildBodyRequest, root.PolyaxonSdk.V1BuildStatus, root.PolyaxonSdk.V1CodeReference, root.PolyaxonSdk.V1CodeReferenceBodyRequest, root.PolyaxonSdk.V1EntityStatusRequest, root.PolyaxonSdk.V1ListBuildStatusesResponse, root.PolyaxonSdk.V1ListBuildsResponse, root.PolyaxonSdk.V1OwnedEntityIdRequest, root.PolyaxonSdk.V1ProjectBodyRequest);
  }
}(this, function(ApiClient, V1Build, V1BuildBodyRequest, V1BuildStatus, V1CodeReference, V1CodeReferenceBodyRequest, V1EntityStatusRequest, V1ListBuildStatusesResponse, V1ListBuildsResponse, V1OwnedEntityIdRequest, V1ProjectBodyRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createBuildCodeRef operation.
     * @callback module:api/BuildServiceApi~createBuildCodeRefCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/BuildServiceApi~createBuildCodeRefCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1CodeReference}
     */
    this.createBuildCodeRef = function(entity_owner, entity_project, entity_id, body, callback) {
      var postBody = body;

      // verify the required parameter 'entity_owner' is set
      if (entity_owner === undefined || entity_owner === null) {
        throw new Error("Missing the required parameter 'entity_owner' when calling createBuildCodeRef");
      }

      // verify the required parameter 'entity_project' is set
      if (entity_project === undefined || entity_project === null) {
        throw new Error("Missing the required parameter 'entity_project' when calling createBuildCodeRef");
      }

      // verify the required parameter 'entity_id' is set
      if (entity_id === undefined || entity_id === null) {
        throw new Error("Missing the required parameter 'entity_id' when calling createBuildCodeRef");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createBuildCodeRef");
      }
