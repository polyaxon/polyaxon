...
(function(root, factory) {
   ...
   * @module api/VersionServiceApi
   * @version 1.14.4
   */

  /**
   * Constructs a new VersionServiceApi. 
   * @alias module:api/VersionServiceApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/VersionServiceApi~getVersionsCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * List runs
     * @param {module:api/VersionServiceApi~getVersionsCallback} callback The callback function, accepting three arguments: error, data, response
