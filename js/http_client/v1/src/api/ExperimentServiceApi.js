...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the createExperimentCodeRef operation.
     * @callback module:api/ExperimentServiceApi~createExperimentCodeRefCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/ExperimentServiceApi~createExperimentCodeRefCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/V1CodeReference}
     */
    this.createExperimentCodeRef = function(entity_owner, entity_project, entity_id, body, callback) {
      var postBody = body;

      // verify the required parameter 'entity_owner' is set
      if (entity_owner === undefined || entity_owner === null) {
        throw new Error("Missing the required parameter 'entity_owner' when calling createExperimentCodeRef");
      }

      // verify the required parameter 'entity_project' is set
      if (entity_project === undefined || entity_project === null) {
        throw new Error("Missing the required parameter 'entity_project' when calling createExperimentCodeRef");
      }

      // verify the required parameter 'entity_id' is set
      if (entity_id === undefined || entity_id === null) {
        throw new Error("Missing the required parameter 'entity_id' when calling createExperimentCodeRef");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling createExperimentCodeRef");
      }
